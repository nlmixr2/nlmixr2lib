# Shard 5 of 8 of the whole-database convention sweep.
#
...
test_that("shard 5 of the model database satisfies the naming conventions", {
  res <- .conventionShardCheck(5L)
