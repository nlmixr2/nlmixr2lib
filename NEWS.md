...
* Add Muto 2015 voriconazole ([doi:10.1128/AAC.04993-14](https://doi.org/10.1128/AAC.04993-14)) -- immunocompromised Japanese pediatric subjects (2-compartment popPK with first-order absorption and parallel linear plus time-dependent Michaelis-Menten elimination; CYP2C19 genotype effect on the maximum Vmax inhibition fraction).
