...
* Add Gupta 2006 peginterferon alfa-2b ([doi:10.1111/j.1365-2125.2006.02757.x](https://doi.org/10.1111/j.1365-2125.2006.02757.x)) -- adults with chronic myelogenous leukaemia (one-compartment SC popPK with Emax-type time-varying clearance and Cockcroft-Gault creatinine clearance covariate; ratifies new `lt50` / `t50` canonical parameter for half-decline / half-effect time).
