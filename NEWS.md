...
* Add Chen 2016 tenofovir / emtricitabine ([doi:10.1371/journal.pone.0165505](https://doi.org/10.1371/journal.pone.0165505)) -- HIV-positive and HIV-negative adults receiving daily oral TDF/FTC (linked plasma TFV/FTC + intracellular TFV-DP/FTC-TP + dATP/dGTP/dCTP/TTP indirect-response PKPD model; ratifies new `tfv`, `ftc`, `tfvdp`, `ftctp` registered metabolite suffixes and the `datp`, `dgtp`, `dctp`, `ttp` canonical dNTP compartments).
