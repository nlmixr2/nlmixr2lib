...
* Add Schipani 2012 lopinavir ([doi:10.3851/IMP2095](https://doi.org/10.3851/IMP2095)) -- HIV-infected adults from the Liverpool Therapeutic Drug Monitoring Registry on boosted lopinavir / ritonavir 400/100 mg BID with SLCO1B1 521T>C (rs4149056) and body-weight additive covariate effects on apparent clearance.
