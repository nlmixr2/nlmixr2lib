...
* Add Kloprogge 2014 quinine ([doi:10.1093/jac/dku228](https://doi.org/10.1093/jac/dku228)) -- pregnant Ugandan women in the second and third trimesters with uncomplicated *Plasmodium falciparum* malaria; ratifies new `PARA` covariate canonical for raw parasitaemia in parasites/uL (time-varying companion to `LNPC`).
