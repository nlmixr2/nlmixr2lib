...
* Add Canini 2018 setrobuvir ([doi:10.3851/IMP3216](https://doi.org/10.3851/IMP3216)) -- adults chronically infected with HCV genotype 1a or 1b (integrated 2-compartment PK / sigmoid-Emax PD / two-state reduced-Neumann viral-kinetic model with genotype-specific EC50, Hill coefficient, and viral clearance).
