...
* Add Lu 2019 tacrolimus industry meta ([doi:10.1111/bcp.13952](https://doi.org/10.1111/bcp.13952)) -- pooled 8-study Astellas Phase II analysis (n = 408) of immediate-release (Prograf) and prolonged-release (Advagraf / Astagraf XL) oral tacrolimus in adult and paediatric liver, kidney, and heart transplant recipients; promotes `FORM_TAC_IR` to general scope.
