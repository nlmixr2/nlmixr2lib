...
* Add Zufferey 2018 fondaparinux ([doi:10.1111/bcp.13663](https://doi.org/10.1111/bcp.13663)) -- adults undergoing major orthopaedic surgery on fondaparinux thromboprophylaxis (parametric time-to-event model for major bleeding with embedded CrCl_LBW-based PK clearance).
