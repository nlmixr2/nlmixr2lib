...
* Add Lane 2011 R- and S-warfarin ([doi:10.1111/j.1365-2125.2011.04051.x](https://doi.org/10.1111/j.1365-2125.2011.04051.x)) -- UK adults on long-term warfarin anticoagulant therapy (two independent 1-compartment popPK models, one per enantiomer; ratifies new `CYP2C9_MISSING`, `SNP_CYP2C19_RS3814637_VAR_COUNT`, `SNP_CYP2C19_RS3814637_MISSING`, `SNP_CYP3A4_RS2242480_VAR_COUNT`, and `SNP_CYP3A4_RS2242480_MISSING` covariate canonicals).
