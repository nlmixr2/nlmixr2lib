...
* Add de Kock 2017 sulfadoxine and pyrimethamine ([doi:10.1002/psp4.12181](https://doi.org/10.1002/psp4.12181)) -- 98 pregnant women receiving intermittent preventive treatment of malaria during pregnancy and after delivery in Mali, Mozambique, Sudan, and Zambia; ratifies new `TPP` (time postpartum), `REGION_MOZAMBIQUE`, `REGION_SUDAN`, `REGION_ZAMBIA` covariate canonicals and `pyra` co-administered-drug compartment suffix.
