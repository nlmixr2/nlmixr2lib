...
* Add Kamal 2015 oseltamivir ([doi:10.1128/AAC.00069-15](https://doi.org/10.1128/AAC.00069-15)) -- adults with experimental and naturally-acquired influenza A (H1N1) virus infection (mechanistic drug-disease viral-dynamics model; oseltamivir effect as an inhibitory Hill function on viral production).
