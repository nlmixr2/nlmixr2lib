...
* Add Hajjar 2018 DMD 6MWT latent variable disease progression ([doi:10.36255/duchenne-muscular-dystrophy-public-education](https://doi.org/10.36255/duchenne-muscular-dystrophy-public-education)) -- 16 healthy boys and 219 boys with Duchenne muscular dystrophy (pooled natural-history 6MWT cohort from six published studies; 1-cmt indirect-response ODE with MTIME change-point KIN and exponential latent disease state, gated by the `DIS_DMD` covariate).
