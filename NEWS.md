...
* Add van den Berg 2021 uprifosbuvir minimal PBPK-PD ([doi:10.1002/psp4.12644](https://doi.org/10.1002/psp4.12644)) -- adult healthy volunteers and chronic HCV patients (22-ODE mPBPK-PD for uprifosbuvir + M5 + M6 plasma metabolites with intrahepatic UXP/CXP nucleotide cycle driving a sigmoid Emax viral-inhibition link, plus tablet/capsule/IV/itraconazole DDI covariate multipliers); ratifies new `CONMED_ITRACONAZOLE` covariate canonical.
