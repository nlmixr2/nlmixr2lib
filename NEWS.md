...
* Add Kappelhoff 2005 ritonavir ([doi:10.1111/j.1365-2125.2004.02241.x](https://doi.org/10.1111/j.1365-2125.2004.02241.x)) -- HIV-1-infected adults receiving ritonavir as a booster or as an antiviral agent (ratifies new `CONMED_LPV` and `MIX_LARGE_RUV` covariate canonicals).
