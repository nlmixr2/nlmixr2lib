...
* Add Barnett 2018 coproporphyrin I ([doi:10.1002/cpt.983](https://doi.org/10.1002/cpt.983)) -- 12 healthy adult males (SLCO1B1 wildtype) in a three-occasion OATP1B drug-drug-interaction crossover study (endogenous turnover model with competitive rifampicin inhibition of biliary clearance; ratifies new `CP_RIF_UM` covariate canonical and broadens `CONMED_RIF` to cover acute single-dose use).
* Add Barnett 2018 rifampicin ([doi:10.1002/cpt.983](https://doi.org/10.1002/cpt.983)) -- 12 healthy adult males receiving a single 600 mg oral rifampicin dose (1-compartment popPK with Wilkins / Savic transit-compartment absorption; perpetrator-drug component of the OATP1B DDI model package).
* Add Barnett 2018 rosuvastatin ([doi:10.1002/cpt.983](https://doi.org/10.1002/cpt.983)) -- 12 healthy adult males receiving a single 5 mg oral rosuvastatin dose with and without 600 mg rifampicin co-administration (2-compartment popPK with simultaneous plasma + urine fitting and binary RIF-coadministration covariate on V1 / V2 / Q).
* Register `urine` as a canonical compartment name in `R/conventions.R` for simultaneous plasma + cumulative-urine popPK / popPK-PD fits (existing precedent in `Aksenov_2018_uricAcid.R`; new use in the Barnett 2018 coproporphyrin I and rosuvastatin extractions).
