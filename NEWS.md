...
* Add Bosch 2025 GLP-1RA HbA1c ([doi:10.1002/psp4.70074](https://doi.org/10.1002/psp4.70074)) -- adults with type 2 diabetes mellitus (24-state IGRH HbA1c sub-model from the 4GI-HbA1c QSP framework; ratifies new `Hba1c` canonical PD-output compartment).
