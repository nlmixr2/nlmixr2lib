...
* Add Jaworowicz 2006 levalbuterol (AAPS poster T3350; no DOI) -- pediatric (4-11 years) and adult (12-81 years) asthma patients receiving inhaled levalbuterol or racemic albuterol via HFA MDI (pooled across three Phase 3 trials; ratifies use of the `CHILD` canonical for an adult-vs-pediatric absorption-rate split).
