...
* Add Wright 2016 allopurinol ([doi:10.1111/bcp.12799](https://doi.org/10.1111/bcp.12799)) -- adults with gout (pooled 5-study cohort from New Zealand; one-compartment oxypurinol PK with sigmoidal Emax direct-effect on plasma urate); ratifies the class-restricted `CONMED_DIUR` reuse pattern for thiazide-and-loop-only diuretic indicators.
