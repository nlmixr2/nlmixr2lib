...
* Add Svensson 2014 bedaquiline ([doi:10.1093/jac/dku504](https://doi.org/10.1093/jac/dku504)) -- healthy adult volunteers in a Phase I drug-drug-interaction study with rifampicin or rifapentine; ratifies new `CONMED_RIF` and `CONMED_RPT` covariate canonicals.
