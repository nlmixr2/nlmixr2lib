...
* Add Kim 2018 tacrolimus ([doi:10.1038/s41598-018-20071-3](https://doi.org/10.1038/s41598-018-20071-3)) -- healthy Korean male volunteers (integrated tacrolimus + mycophenolate mofetil drug-drug-interaction model with mycophenolic-acid enterohepatic recirculation; registers new `mpa` and `acmpag` metabolite suffixes).
