...
* Add Thorsted 2016 somatropin / rhGH ([doi:10.1111/bph.13473](https://doi.org/10.1111/bph.13473)) -- preclinical hypophysectomized Sprague-Dawley rats with companion allometrically-scaled human projection (`Thorsted_2016_somatropin_rat` and `Thorsted_2016_somatropin_human`); two-compartment PK with parallel linear and Michaelis-Menten elimination, parallel SC absorption, and an indirect-response IGF-1 / bodyweight-gain PD layer.
