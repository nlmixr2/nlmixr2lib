...
* Add Nemoto 2017 ethanol ([doi:10.1016/j.curtheres.2017.04.001](https://doi.org/10.1016/j.curtheres.2017.04.001)) -- 34 healthy Japanese adults receiving a single 14 g oral ethanol dose (Bayesian one-compartment Michaelis-Menten model with ALDH2 and ADH1B genotype covariates; ratifies new `ALDH2_S2_CARRIER` and `ADH1B_S2_HOM` covariate canonicals).
