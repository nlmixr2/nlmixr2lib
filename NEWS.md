...
* Add Pettersen 2009 pantoprazole ([doi:10.1111/j.1365-2125.2008.03328.x](https://doi.org/10.1111/j.1365-2125.2008.03328.x)) -- paediatric intensive-care patients aged 10 days to 16.4 years; ratifies new `DIS_SIRS` and `CONMED_CYP2C19_INH` covariate canonicals and broadens the `HEPIMP` canonical to accept paper-specific cut-points.
