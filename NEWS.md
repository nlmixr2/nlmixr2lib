...
* Add Oualha 2014 norepinephrine ([doi:10.1111/bcp.12412](https://doi.org/10.1111/bcp.12412)) -- hypotensive critically ill children including 7 premature neonates (joint one-compartment popPK + Emax PD model on mean arterial pressure with a power-of-postmenstrual-age effect on basal MAP0 and an organ-dysfunction-count effect on the maximal drug-induced MAP increase).
