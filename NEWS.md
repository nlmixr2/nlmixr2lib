...
* Add Mulder 2025 ribavirin ([doi:10.1093/jac/dkaf183](https://doi.org/10.1093/jac/dkaf183)) -- adult solid organ transplant recipients with chronic hepatitis E virus infection (integrated popPK plus indirect-response haemoglobin and target-cell-limited HEV viral load model; ratifies new `HGB_BL` baseline-haemoglobin and `HEV_VLOAD` baseline-HEV-viral-load covariate canonicals).
