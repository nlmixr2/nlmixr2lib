...
* Add Ahmed 2016 Lorenzo's oil ([doi:10.1111/bcp.12897](https://doi.org/10.1111/bcp.12897)) -- asymptomatic boys with X-linked adrenoleukodystrophy (PD-only inhibitory fractional Emax of plasma C26:0 vs observed erucic acid plasma concentration; ratifies new `CP_ER_MGL` covariate canonical).
