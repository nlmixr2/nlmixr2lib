...
* Add Willmann 2021 rivaroxaban ([doi:10.1002/psp4.12688](https://doi.org/10.1002/psp4.12688)) -- pediatric (birth to <18 years) acute venous thromboembolism (EINSTEIN-Jr) and post-Fontan thromboprophylaxis (UNIVERSE); ratifies new `FORM_UNDILUTED_SUSP` and `DOSE_RIV_MGKG` covariate canonicals.
