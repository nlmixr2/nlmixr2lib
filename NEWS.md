...
* Add Schmitt 2018 vinflunine ([doi:10.1111/bcp.13518](https://doi.org/10.1111/bcp.13518)) -- adult cancer patients pooled across 18 phase I and II trials (combined four-compartment popPK + Friberg-style myelosuppression PK/PD; ratifies new `CONMED_PLDH` covariate canonical and a `peripheral3` / `lvp3` / `lq3` / `vp3` / `q3` / `k14` / `k41` 4-compartment naming extension).
