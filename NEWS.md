...
* Add Hopkins 2015 leflunomide ([doi:10.1111/bcp.12760](https://doi.org/10.1111/bcp.12760)) -- adult rheumatoid-arthritis patients on daily oral leflunomide (parametric time-to-event model for cessation due to toxicity; ratifies new `SNP_CYP1A2_RS762551_C_CARRIER` covariate canonical).
