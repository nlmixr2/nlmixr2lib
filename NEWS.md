...
* Add Drweesh 2026 adalimumab ([doi:10.1007/s44446-026-00063-5](https://doi.org/10.1007/s44446-026-00063-5)) -- adults with inflammatory bowel disease or other autoimmune disease on subcutaneous adalimumab originator (Humira) or biosimilars (Amgevita, Hyrimoz) in Saudi Arabia and Qatar; one-compartment popPK with structural backbone (V/F, IIV, residual error) inherited from `modellib('Marquez-Megias_2023_adalimumab')`.
