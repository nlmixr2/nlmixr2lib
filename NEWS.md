...
* Add Tsuji 2017 linezolid ([doi:10.1111/bcp.13262](https://doi.org/10.1111/bcp.13262)) -- hospitalized adult and pediatric patients with MRSA or gram-positive cocci infections (two-compartment popPK with renal/non-renal CL split and dual total/unbound observations, Friberg-style platelet turnover, and a two-mechanism PDI/PDS mixture exposed via the new `MIX_PDI` covariate canonical).
