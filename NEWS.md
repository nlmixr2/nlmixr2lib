...
* Add Netterberg 2018 breast-cancer febrile-neutropenia biomarker + TTE submodels ([doi:10.1111/bcp.13477](https://doi.org/10.1111/bcp.13477)) -- early breast-cancer patients on adjuvant FEC and docetaxel chemotherapy (joint IL-6 / CRP turnover model with surge functions plus three time-to-event hazard variants for FN); ratifies new `MIX_ELEV_IL6` and `MIX_ELEV_CRP` covariate canonicals.
