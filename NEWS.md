...
* Add de Winter 2009 mycophenolic acid ([doi:10.1007/s10928-009-9136-6](https://doi.org/10.1007/s10928-009-9136-6)) -- adult renal transplant recipients on twice-daily oral MMF with concomitant cyclosporine or tacrolimus (semi-mechanistic competitive protein binding + enterohepatic recirculation model for parent MPA and metabolite MPAG; ratifies new `mpag` registered metabolite suffix and new `CONMED_CSA` covariate canonical).
