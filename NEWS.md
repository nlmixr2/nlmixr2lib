...
* Add Xie 2000 morphine-3-glucuronide ([doi:10.1038/sj.bjp.0703759](https://doi.org/10.1038/sj.bjp.0703759)) -- preclinical male Sprague-Dawley rats with striatal microdialysis (one-compartment plasma PK coupled to a two-compartment brain BBB model with asymmetric unbound influx / efflux clearance and a probenecid coadministration effect on CL_u,in; ratifies new `CONMED_PROBENECID` covariate canonical).
