...
* Add Danielak 2017 clopidogrel ([doi:10.1007/s00228-017-2334-z](https://doi.org/10.1007/s00228-017-2334-z)) -- adult Caucasian patients undergoing elective coronarography or PCI on chronic clopidogrel 75 mg/day (ratifies new `CYP2C19_S2_CARRIER` covariate canonical; new `h4` metabolite suffix and `fm` paper-named parameter).
