...
* Add Desikan 2022 SARS-CoV-2 / influenza vaccine immunodynamics ([doi:10.3389/fimmu.2022.985478](https://doi.org/10.3389/fimmu.2022.985478)) -- QSP framework, species-agnostic (mouse, primate, human); 14-ODE two-antigen (WU / OM) three-epitope multi-B-cell / antibody model for humoral recall responses to two-strain vaccine sequences.
