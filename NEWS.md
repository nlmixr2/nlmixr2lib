...
* Add van der Walt 2013 dapagliflozin ([doi:10.1038/psp.2013.20](https://doi.org/10.1038/psp.2013.20)) -- healthy adults, T2DM with normal to severe renal impairment, and adults with Child-Pugh A/B/C hepatic impairment (joint parent + D3OG glucuronide metabolite popPK; ratifies new `d3og` registered metabolite suffix and new `HEPIMP_SEV` / `HEPIMP_MODSEV` covariate canonicals).
