...
* Add Mangas-Sanjuan 2016 axomadol ([doi:10.1111/bcp.12921](https://doi.org/10.1111/bcp.12921)) -- healthy adult CYP2D6 extensive metabolisers (joint RR + SS enantiomer PK with parent + O-demethyl-axomadol metabolite, hysteresis effect compartment for the active RR metabolite, and shared PD layers on pupil diameter and cold-pressor analgesic AUC).
