...
* Add Kappelhoff 2005 indinavir ([doi:10.1111/j.1365-2125.2005.02436.x](https://doi.org/10.1111/j.1365-2125.2005.02436.x)) -- HIV-1-infected adults on indinavir-containing antiretroviral regimens, with or without concomitant ritonavir or an NNRTI; ratifies new `CONMED_RTV` and `CONMED_NNRTI` covariate canonicals.
