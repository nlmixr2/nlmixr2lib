...
* Add Watson 2010 liraglutide ([doi:10.1177/0091270009354996](https://doi.org/10.1177/0091270009354996)) -- healthy volunteers and adults with type 2 diabetes (one-compartment popPK with sequential zero-order-then-first-order (dual) absorption; DIS_DIAB effect on kA and T0).
