...
* Add Garonzik 2016 daptomycin ([doi:10.1371/journal.pone.0156131](https://doi.org/10.1371/journal.pone.0156131)) -- in vitro time-kill against Staphylococcus aureus USA300 MRSA across five human-serum levels (mechanism-based PD model with three bacterial subpopulations and a serum-dependent active-fraction).
