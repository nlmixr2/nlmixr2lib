...
* Add Djerada 2014 nefopam ([doi:10.1111/bcp.12291](https://doi.org/10.1111/bcp.12291)) -- 48 elderly patients (65-99 years) with normal, moderate, or severe renal impairment after a single 30 min IV nefopam infusion (joint parent + desmethyl-nefopam popPK; ratifies new `dnef` metabolite suffix and formalises the `lcl_form_<metab>` metabolite-formation-clearance parameter pattern).
