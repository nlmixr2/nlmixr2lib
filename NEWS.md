...
* Add Denti 2010 IVGTT glucose minimal model ([doi:10.1152/ajpendo.00656.2009](https://doi.org/10.1152/ajpendo.00656.2009)) -- 204 healthy adults aged 18-87 (Bergman minimal model with NLME covariates of age, sex, visceral abdominal fat, percent total body fat, basal glucose, and basal insulin; ratifies new `VISCERAL_ABDOMINAL_FAT` and `BODYFAT_PCT` covariate canonicals and the `sg` / `si` / `p2` paper-named-param family).
