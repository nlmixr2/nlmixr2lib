...
* Add Carlsson Petri 2018 semaglutide ([doi:10.1007/s13300-018-0458-5](https://doi.org/10.1007/s13300-018-0458-5)) -- adults with type 2 diabetes on once-weekly SC semaglutide across five phase III SUSTAIN trials; ratifies new `RENALIMP_MILD`, `RENALIMP_SEV`, `INJSITE_THIGH`, and `DOSE_SEMAGLUTIDE_MG` covariate canonicals.
