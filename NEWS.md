...
* Add Ganesan 2023 tebipenem ([doi:10.1128/aac.01451-22](https://doi.org/10.1128/aac.01451-22)) -- healthy adults, adults with renal impairment, and patients with complicated urinary tract infection or acute pyelonephritis (ratifies new `STUDY_SPR994_104` and `DOSE_TBPPI_MG` covariate canonicals).
