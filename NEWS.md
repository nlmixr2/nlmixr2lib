...
* Add Dorlo 2017 miltefosine ([doi:10.1093/jac/dkx283](https://doi.org/10.1093/jac/dkx283)) -- Eastern African adults and children (>=7 years) with visceral leishmaniasis treated with oral miltefosine alone or combined with single-dose IV liposomal amphotericin B; ratifies new `MIL_REGIMEN` covariate canonical.
