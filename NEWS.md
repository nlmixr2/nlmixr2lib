...
* Add Gibiansky 2005 fospropofol ([doi:10.1016/j.clpt.2004.12.076](https://doi.org/10.1016/j.clpt.2004.12.076)) -- adults undergoing colonoscopy sedation receiving IV bolus AQUAVAN (joint two-compartment GPI 15715 prodrug + delay + two-compartment propofol active-metabolite popPK); ratifies new `ppf` (propofol) metabolite suffix.
