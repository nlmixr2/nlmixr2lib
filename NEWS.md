...
- New `checkUnits()` and `addUnits()` track the physical units of any
  ...
  per-parameter override, `checkUnits()` walks the `model({})` expressions,
  infers a unit for every symbol, validates every `+`, `-`, `*`, `/`,
  comparison and transcendental call, and returns a data frame with an `issue`
  column. `addUnits()` inserts the conversion constants the arithmetic needs as
  bare literals (`Cc <- central/vc * 1000`), explains each one in the new
  `unitConversions` metadata, and writes the unit of every resolved symbol
  into `units`. Needs the `units` package (now in Suggests) and its udunits-2
  system library.
...
- Add Moein 2025 etrolizumab ([doi:10.1002/jcph.70043](https://doi.org/10.1002/jcph.70043)) -- adults with moderately-to-severely active Crohn's disease or ulcerative colitis; one population PK model plus six landmark exposure-response models.

- Add Kata 2025 ganciclovir clearance maturation ([doi:10.1186/s40780-025-00496-5](https://doi.org/10.1186/s40780-025-00496-5)) -- an extremely low birth weight preterm neonate with congenital cytomegalovirus infection.
...
- Add Choi 2025 efpeglenatide ([doi:10.3389/fphar.2025.1715585](https://doi.org/10.3389/fphar.2025.1715585)) -- adults with type 2 diabetes or non-diabetic obesity.
...
- Add Liu 2025 meropenem ([doi:10.3390/pharmaceutics17121544](https://doi.org/10.3390/pharmaceutics17121544)) -- critically ill children in two paediatric intensive care units, most with augmented renal clearance.
...
- Add Shiau 2026 vancomycin ([doi:10.1093/ofid/ofaf695.1429](https://doi.org/10.1093/ofid/ofaf695.1429)) -- critically ill children with multiple organ dysfunction syndrome.
...
- Add Marianski 2026 ceftriaxone ([doi:10.1093/ofid/ofaf695.1445](https://doi.org/10.1093/ofid/ofaf695.1445)) -- critically ill children with multiple organ dysfunction syndrome.

- Add Kwak 2025 MG1113 anti-TFPI antibody ([doi:10.3389/fphar.2025.1745702](https://doi.org/10.3389/fphar.2025.1745702)) -- cynomolgus monkeys, plus allometric rabbit and human projections.
...
- Add Roganovic 2026 ciclosporin ([doi:10.3390/pharmaceutics18010099](https://doi.org/10.3390/pharmaceutics18010099)) -- paediatric and young-adult renal transplant recipients on therapeutic drug monitoring.

- Add 14 imipenem models transcribed from the Zhang 2025 imipenem popPK systematic review ([doi:10.3389/fphar.2025.1738055](https://doi.org/10.3389/fphar.2025.1738055)) -- Ikawa 2008, Yoshizawa 2013 (neonates and children), Dong 2019, Chen 2020, de Velde 2020, Nguyen 2021, Jaruratanasirikul 2021, Por 2021, Dao 2022, Dinh 2022, Lafaurie 2023 (neutropenia and recovery) and Truong 2025; neonates through elderly adults, including burns, ECMO, CVVH and haematological malignancy. Parameters are from the review's summary tables, not the primary publications. Registers `ABW` (adjusted body weight) as a canonical covariate column, founded by the Jaruratanasirikul 2021 model.

- Add Ding 2026 artemether, amodiaquine and lumefantrine ([doi:10.1002/bcp.70301](https://doi.org/10.1002/bcp.70301)) -- adults and children with uncomplicated *Plasmodium falciparum* malaria on triple artemisinin-based combination therapy.
...
- Add Xu 2026 caspofungin ([doi:10.1128/aac.01277-25](https://doi.org/10.1128/aac.01277-25)) -- critically ill Chinese children in the paediatric intensive care unit, with and without ECMO support.

- Add Xu 2026 caspofungin optimal-design model ([doi:10.1128/aac.01277-25](https://doi.org/10.1128/aac.01277-25)) -- the same study's intensive-sampling subset, from the supplemental control stream.
...
- Add Kashihara 2026 RSV vaccine immune correlates of protection ([doi:10.1002/psp4.70133](https://doi.org/10.1002/psp4.70133)) -- older adults across seven randomised placebo-controlled RSV vaccine efficacy trials.

- Add Yang 2026 COPD FEV1 combined aggregated + individual meta-analysis ([doi:10.1002/psp4.70059](https://doi.org/10.1002/psp4.70059)) -- 250,543 patients in 296 published COPD trials of 23 compounds, fit jointly with 2,241 individual patients.

- Add Yang 2026 COPD FEV1 individual-patient model ([doi:10.1002/psp4.70059](https://doi.org/10.1002/psp4.70059)) -- 2,241 adults in two fluticasone furoate / vilanterol trials.

- Add Serrano 2026 atopic dermatitis placebo response ([doi:10.1002/psp4.70150](https://doi.org/10.1002/psp4.70150)) -- placebo arms of 40 moderate-to-severe atopic dermatitis trials.

- Add Chen 2026 NSCLC overall-survival MBMA ([doi:10.1002/psp4.70197](https://doi.org/10.1002/psp4.70197)) -- treatment-naive advanced non-small cell lung cancer unsuitable for platinum-doublet chemotherapy.

- Add Zhao 2026 durvalumab ([doi:10.1002/bcp.70287](https://doi.org/10.1002/bcp.70287)) -- adults with solid tumours, including the phase III AEGEAN resectable non-small-cell lung cancer cohort.

- Add Juma 2026 lumefantrine ([doi:10.1111/bcp.70318](https://doi.org/10.1111/bcp.70318)) -- pregnant and non-pregnant Kenyan women with uncomplicated Plasmodium falciparum malaria.
...
- Add Tseng 2026 vancomycin ([doi:10.2147/DDDT.S574548](https://doi.org/10.2147/DDDT.S574548)) -- adults with intracranial hemorrhage and an external ventricular drain.
...
- Add Liang 2026 remimazolam ([doi:10.3390/pharmaceutics18030315](https://doi.org/10.3390/pharmaceutics18030315)) -- healthy Chinese adults, extrapolated to children and adolescents.

- Add Tobin 2026 atomoxetine ([doi:10.1002/jcph.70168](https://doi.org/10.1002/jcph.70168)) -- children and adolescents with ADHD across CYP2D6 and CYP2C19 metabolizer phenotypes.

- Add Nguyen 2026 levofloxacin ([doi:10.1007/s40262-026-01619-3](https://doi.org/10.1007/s40262-026-01619-3)) -- Vietnamese adults with multidrug-resistant tuberculosis, paired plasma and saliva.

- Add Maranchick 2026 pyrazinamide and ethambutol ([doi:10.1128/aac.00909-25](https://doi.org/10.1128/aac.00909-25)) -- Ghanaian children with tuberculosis with or without HIV coinfection.
...
- Add Pfaffendorf 2026 fosmidomycin and clindamycin ([doi:10.1186/s12936-026-05872-6](https://doi.org/10.1186/s12936-026-05872-6)) -- Gabonese children and adults with uncomplicated Plasmodium falciparum malaria.
...
- Add Wang 2026 serplulimab ([doi:10.1002/psp4.70204](https://doi.org/10.1002/psp4.70204)) -- adults with advanced solid tumours across seven histologies.

- Add Helfer 2026 pentobarbital ([doi:10.1002/jcph.70204](https://doi.org/10.1002/jcph.70204)) -- children from birth to 21 years dosed intravenously as standard of care.

- Add Sunnaker 2026 mitiperstat ([doi:10.1002/prp2.70259](https://doi.org/10.1002/prp2.70259)) -- healthy volunteers, patients with HFpEF/HFmrEF, and patients with severe renal impairment.
...
- Add Paiboonvong 2025 sitafloxacin ([doi:10.1002/prp2.70081](https://doi.org/10.1002/prp2.70081)) -- critically ill Thai adults with pneumonia, plasma and epithelial lining fluid.

- Add Yang 2025 polymyxin B ([doi:10.3389/fphar.2025.1511088](https://doi.org/10.3389/fphar.2025.1511088)) -- critically ill adults with carbapenem-resistant organism infections.

- Add Overbeek 2025 cobicistat and olaparib well-stirred liver models ([doi:10.1007/s40262-025-01480-w](https://doi.org/10.1007/s40262-025-01480-w)) -- healthy volunteers, postpartum women with HIV, patients with rheumatoid arthritis and patients with solid tumours.

- Add Ling 2025 ropivacaine ([doi:10.3389/fphar.2025.1540606](https://doi.org/10.3389/fphar.2025.1540606)) -- adults undergoing thoracoscopic lobectomy with a serratus anterior plane block.
...
- Add Chen 2025 vancomycin ([doi:10.1128/spectrum.00499-25](https://doi.org/10.1128/spectrum.00499-25)) -- adult intensive-care patients with sepsis.

- Add Tian 2025 linezolid ([doi:10.1128/aac.01299-24](https://doi.org/10.1128/aac.01299-24)) -- Chinese children aged 0-16 years with bacterial infections.
...
- Add James 2025 fepixnebart ([doi:10.1007/s40262-025-01506-3](https://doi.org/10.1007/s40262-025-01506-3)) -- adults with chronic pain (osteoarthritis, diabetic peripheral neuropathy, chronic low back pain).

- Add Yang 2025 venetoclax ([doi:10.2147/DDDT.S514173](https://doi.org/10.2147/DDDT.S514173)) -- adults with hematologic malignancies receiving concomitant voriconazole.

- Add Liu 2025 voriconazole ([doi:10.2147/DDDT.S495050](https://doi.org/10.2147/DDDT.S495050)) -- elderly Chinese inpatients aged 60 years and over.
...
- Add Liu 2025 tranexamic acid ([doi:10.2147/DDDT.S493485](https://doi.org/10.2147/DDDT.S493485)) -- Chinese adults undergoing cardiac surgery with cardiopulmonary bypass.
...
- Add Zhou 2025 teicoplanin ([doi:10.1128/aac.01568-24](https://doi.org/10.1128/aac.01568-24)) -- adult renal transplant recipients.

- Add Gotz 2025 fosfomycin ([doi:10.1128/aac.01779-24](https://doi.org/10.1128/aac.01779-24)) -- critically ill adults with and without kidney replacement therapy.
...
- Add Steffens 2025 amikacin ([doi:10.3390/antibiotics14060531](https://doi.org/10.3390/antibiotics14060531)) -- Brazilian hospitalized patients undergoing therapeutic drug monitoring.
...
- Add Tuo 2025 clobazam ([doi:10.3390/pharmaceutics17070813](https://doi.org/10.3390/pharmaceutics17070813)) -- Chinese children with refractory epilepsy.

- Add Mahomed 2025 CAP256V2LS ([doi:10.1093/jac/dkaf181](https://doi.org/10.1093/jac/dkaf181)) -- young HIV-negative South African women.
...
- Add Chen 2025 hemoporfin ([doi:10.1002/psp4.70050](https://doi.org/10.1002/psp4.70050)) -- Chinese children aged 7-14 years with port-wine stain plus adult healthy volunteers, with five companion exposure-response models.
...
- Add Berthaud 2025 cefazolin ([doi:10.1128/aac.00451-25](https://doi.org/10.1128/aac.00451-25)) -- children undergoing maintenance hemodialysis for kidney failure.
...
- Add Song 2024 tigecycline ([doi:10.2147/DDDT.S473080](https://doi.org/10.2147/DDDT.S473080)) -- critically ill adults undergoing continuous renal replacement therapy.
...
- Add Isla 2024 oral fosfomycin calcium ([doi:10.1093/jac/dkae295](https://doi.org/10.1093/jac/dkae295)) -- healthy adult women.

- Add Wang 2024 valproic acid ([doi:10.1002/psp4.13191](https://doi.org/10.1002/psp4.13191)) -- Chinese children with epilepsy on oral syrup or sustained-release tablets.
...
- Add Liu 2024 deutenzalutamide ([doi:10.1002/cpdd.1477](https://doi.org/10.1002/cpdd.1477)) -- patients with metastatic castration-resistant prostate cancer.

- Add Zhang 2024 nirmatrelvir ([doi:10.2147/DDDT.S479561](https://doi.org/10.2147/DDDT.S479561)) -- elderly Chinese inpatients with mild-to-moderate COVID-19 treated with nirmatrelvir/ritonavir.
...
- Add Chen 2025 ceftazidime and avibactam ([doi:10.2147/IDR.S495279](https://doi.org/10.2147/IDR.S495279)) -- critically and non-critically ill Chinese adults with carbapenem-resistant *Klebsiella pneumoniae* infection.
...
- Add Zhang 2024 aripiprazole ([doi:10.3389/fpsyt.2024.1377268](https://doi.org/10.3389/fpsyt.2024.1377268)) -- Chinese adults with schizophrenia.
...
- Add Benson 2010 BHMA / alpha interferon ([doi:10.1128/AAC.00551-09](https://doi.org/10.1128/AAC.00551-09)) -- male CD-1 outbred mice.

- Add Felmlee 2010 gamma-hydroxybutyric acid ([doi:10.1208/s12248-010-9197-x](https://doi.org/10.1208/s12248-010-9197-x)) -- male Sprague-Dawley rats.
...
- Add Agarwal 2011 sorafenib BCRP and P-gp transporter models ([doi:10.1124/jpet.110.175034](https://doi.org/10.1124/jpet.110.175034)) -- in vitro MDCKII monolayers transfected with murine *Bcrp1* or human *MDR1*.
...
- Add Wallender 2021 piperaquine PK, malaria-hazard and QTc models ([doi:10.1038/s41467-021-27051-8](https://doi.org/10.1038/s41467-021-27051-8)) -- Ugandan children 2 to 36 months of age receiving malaria chemoprevention.
...
- Add Kuan 2023 one-compartment flip-flop permutation models
  ([doi:10.1002/psp4.12909](https://doi.org/10.1002/psp4.12909)) -- methodology
  reference with no drug and no patients; the two permutations predict an
  identical concentration-time profile.
...
- Add Roelofsen 2023 cefotaxime ([doi:10.1111/bcp.15487](https://doi.org/10.1111/bcp.15487)) -- critically ill adult ICU patients receiving selective digestive decontamination.

- Add Hughes 2022 brepocitinib ([doi:10.1002/cpdd.1163](https://doi.org/10.1002/cpdd.1163)) -- healthy volunteers and patients with plaque psoriasis or alopecia areata.
...
- Add Tang 2023 tenecteplase ([doi:10.1002/jcph.2164](https://doi.org/10.1002/jcph.2164)) -- adults with acute myocardial infarction.
...
- Add Feng 2023 cyclosporine ([doi:10.1136/bmjpo-2023-002003](https://doi.org/10.1136/bmjpo-2023-002003)) -- Chinese paediatric allogeneic haematopoietic stem cell transplant recipients.
