...
* Add Marcantonio 2022 Early Feasibility Assessment 9-biotherapeutic panel ([doi:10.3389/fphar.2022.864768](https://doi.org/10.3389/fphar.2022.864768)) -- QSP models for adalimumab, infliximab, ustekinumab, risankizumab, belimumab, omalizumab (1-cpt anti-ligand), trastuzumab, panitumumab (2-cpt anti-receptor), and amivantamab (2-cpt bispecific anti-receptor) in their approved-indication populations; reproduces paper Table 5 effective-dose predictions from mechanistic first-principles parameters (no fitting, no IIV).
