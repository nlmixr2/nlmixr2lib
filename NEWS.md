...
* Add Hien 2017 cipargamin ([doi:10.1128/aac.01940-16](https://doi.org/10.1128/aac.01940-16)) -- Vietnamese adults with acute uncomplicated Plasmodium falciparum malaria; ratifies new `kgrow`, `kact`, `fsen` mechanistic-parameter canonicals and new `DOSE_CIPARGAMIN_MG` covariate canonical.
