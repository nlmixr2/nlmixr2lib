...
* Add Clinckers 2008 MHD ([doi:10.1038/bjp.2008.366](https://doi.org/10.1038/bjp.2008.366)) -- preclinical male Wistar rats receiving single IP MHD (oxcarbazepine active metabolite) 20-150 mg/kg, with simultaneous plasma and hippocampal microdialysis sampling under control, acute pilocarpine-induced seizure, and intrahippocampal verapamil efflux-transporter-blockade arms (ratifies new `SEIZURE_ACUTE` and `EFFLUX_INHIB` covariate canonicals for preclinical biophase-distribution studies).
