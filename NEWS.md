...
* Add Jacobs 2016 colistin ([doi:10.1128/AAC.01868-15](https://doi.org/10.1128/AAC.01868-15)) -- ICU adults with acute renal failure on intermittent hemodialysis (parent CMS + active-metabolite colistin popPK with DIAL-gated hemodialysis clearances).
