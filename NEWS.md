...
* Add Campagne 2019 cyclophosphamide ([doi:10.18433/jpps30608](https://doi.org/10.18433/jpps30608)) -- female CD-1 nude mice (non-tumor-bearing and orthotopic Group 3 medulloblastoma); ratifies new `4ohctx` and `cepm` registered metabolite suffixes, new `ecf` compartment, and new `lclin` / `lclef` (with bare `clin` / `clef`) influx / efflux clearance canonical names.
