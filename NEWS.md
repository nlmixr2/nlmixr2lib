...
* Add Aruldhas 2021 R- and S-methadone with EDDP metabolite ([doi:10.1002/psp4.12687](https://doi.org/10.1002/psp4.12687)) -- post-operative children (11-17 years) undergoing pectus excavatum or spinal fusion surgery on racemic methadone (per-enantiomer 2-cmt parent + 1-cmt EDDP; ratifies new `eddp` metabolite suffix and new `CYP2B6`, `SNP_ORM1_RS17650`, and `SNP_CYP3A4_RS2246709` covariate canonicals; promotes `FORM_TABLET` to `general` scope).
