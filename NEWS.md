...
* Add Arab-Alameddine 2012 raltegravir ([doi:10.1128/AAC.05424-11](https://doi.org/10.1128/AAC.05424-11)) -- HIV-positive adults on antiretroviral therapy and healthy adult volunteers; ratifies new `CONMED_ATAZANAVIR` covariate canonical and renames the legacy `CONMED_ATV_DOSE` to `CONMED_ATORVASTATIN_DOSE` to free the `ATV` abbreviation for the atazanavir indicator.
