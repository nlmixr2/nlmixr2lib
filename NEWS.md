...
* Add Terranova 2022 avelumab JAVELIN Gastric 100 TGD + OS disease-progression model ([doi:10.1002/psp4.12754](https://doi.org/10.1002/psp4.12754)) -- adults with advanced gastric cancer / gastroesophageal junction cancer after 12 weeks of induction chemotherapy; Gompertzian tumor growth dynamics jointly with a log-logistic parametric time-to-event overall-survival sub-model. Ratifies new `T_DIAG_CANCER`, `MET_GE3`, `RESP_SD`, `RESP_NONPDCR`, `RESP_RESPONDER`, `PERIT_CARC`, and `SBP` covariate canonicals.
