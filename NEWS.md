...
* Add Zhu 2023 omalizumab pediatric ([doi:10.1208/s12248-023-00823-4](https://doi.org/10.1208/s12248-023-00823-4)) -- children aged 6-11 with moderate-to-severe persistent inadequately controlled allergic asthma (PD-only IgE-FEV1 indirect-response model; ratifies new `IGE_FREE` canonical covariate for time-varying serum free IgE as PD-driver input).
