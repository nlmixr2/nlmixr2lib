...
* Add Sharma 2018 naltrexone+bupropion ([doi:10.1002/jcph.994](https://doi.org/10.1002/jcph.994)) -- obese / overweight adults pooled across six Contrave registration trials (DTPD population-PD body-weight model only; ratifies new `DOSE_NAL_MGD` and `DOSE_BUP_MGD` covariate canonicals).
