...
* Add Chen 2017 TB combination therapy MTP-GPDI model ([doi:10.1002/psp4.12226](https://doi.org/10.1002/psp4.12226)) -- preclinical TB-infected female BALB/c mice receiving oral rifampicin / isoniazid / ethambutol / pyrazinamide in monotherapy or combination (four parallel PK trees + Multistate Tuberculosis Pharmacometric model + General Pharmacodynamic Interaction model on the killing of slow- and non-multiplying bacteria).
