...
* Add Franzese 2026 PD-(L)1 immunotherapy MBMA in metastatic NSCLC ([doi:10.1002/psp4.70196](https://doi.org/10.1002/psp4.70196)) -- meta-analysis of 114 mNSCLC studies (46 unique PD-1 / PD-L1 monotherapies and combinations); integrated ORR mixed-effects logistic regression + OS / PFS semi-parametric proportional hazards with monthly discrete baseline hazard from Franzese 2026 Table S2; ratifies new canonical compartment `cumhaz_pfs` and new arm-level percentage covariate canonicals `TUMTP_SQUAM_PCT`, `PS_ECOG_0_PCT`, `RACE_ASIAN_PCT`.
