...
* Add Mori 2018 zoledronic acid ([doi:10.1007/s00198-018-4376-1](https://doi.org/10.1007/s00198-018-4376-1)) -- Japanese patients with primary osteoporosis on once-yearly IV ZOL plus daily oral calcium + vitamin D + magnesium supplementation (K-PD effect-site / TRACP-5b indirect-response / lumbar-spine BMD effect-compartment model; ratifies new `TRACP5B_BL` and `BMD_BL` covariate canonicals).
