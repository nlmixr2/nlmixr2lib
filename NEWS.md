...
* Add Kemal 2026 nemtabrutinib ([doi:10.1002/psp4.70257](https://doi.org/10.1002/psp4.70257)) -- adults with hematologic malignancies including CLL/SLL (BELLWAVE-001 phase 1/2 and BELLWAVE-003 phase 2; two-compartment popPK with first-order absorption + lag and full covariate model on CL, Vc, and F; ratifies new `DIS_BCELLNHL`, `DIS_WM`, `DIS_OTHER_HEME`, `CONMED_CYP3A4_IND_MOD`, `CONMED_CYP3A4_INH_STRONG`, and `CONMED_ANTACID` covariate canonicals).
