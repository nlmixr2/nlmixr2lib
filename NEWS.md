...
* Add Billard 1995 8-methoxypsoralen ([doi:10.1111/j.1365-2125.1995.tb04557.x](https://doi.org/10.1111/j.1365-2125.1995.tb04557.x)) -- 18 healthy adult volunteers receiving 60-min IV infusion (parallel plasma and whole-blood 3-compartment fits packaged as two model files sharing one validation vignette).
