...
* Add Fu 2022 atenolol CVS-CTR systems model ([doi:10.1002/psp4.12774](https://doi.org/10.1002/psp4.12774)) -- preclinical conscious beagle dogs (novel cardiovascular systems model integrating heart rate, cardiac output, mean arterial pressure, and myocardial contractility via pressure-volume-loop theory; atenolol as beta1-blocker proof-of-concept; ratifies new `STUDY_FU2022_AZ` covariate canonical).
