...
* Add Jonsson 2015 edoxaban ([doi:10.1002/jcph.541](https://doi.org/10.1002/jcph.541)) -- adults with normal kidney function through severe renal impairment in a dedicated renal impairment study (joint edoxaban + M4 metabolite popPK with a urine compartment and estimated absolute oral bioavailability; ratifies new `m4` metabolite suffix canonical).
