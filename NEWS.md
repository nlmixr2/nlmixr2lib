...
* Add Rao 2023 COVID-19 QSP model ([doi:10.1038/s41540-023-00269-6](https://doi.org/10.1038/s41540-023-00269-6)) -- outpatients with mild-to-moderate COVID-19 (54-state within-host viral dynamics + innate/adaptive immune response with log-sensing innate activation, plus neutralizing-antibody and antiviral treatment arms); ratifies new `CP_EIDD_NGML` covariate canonical.
