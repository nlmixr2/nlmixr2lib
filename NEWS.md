...
* Add Jeong 2022 torsemide ([doi:10.3390/pharmaceutics14040771](https://doi.org/10.3390/pharmaceutics14040771)) -- healthy Korean adult males receiving single 5, 10, or 20 mg oral torsemide (two-compartment popPK with absorption lag, CYP2C9 EM phenotype effect on CL/F and Q/F, SLCO1B1*15 haplotype effect on V/F; ratifies new `CYP2C9_EM` covariate canonical and promotes `SLCO1B1_HAP15_HET` / `SLCO1B1_HAP15_HOM` from specific to general scope).
