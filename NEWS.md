...
* Add Schindler 2017 imatinib ([doi:10.1002/psp4.12195](https://doi.org/10.1002/psp4.12195)) -- adults with gastrointestinal stromal tumor (GIST) and liver metastases (joint tumor-dynamics model of MTD / Vactual / Vellipsoid / density driven by daily imatinib dose; ratifies new `MIX_LARGE_BASE` mixture covariate canonical).
