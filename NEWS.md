...
* Add Patel 2017 selumetinib ([doi:10.1002/psp4.12175](https://doi.org/10.1002/psp4.12175)) -- adults with advanced solid tumors pooled with children with recurrent low-grade glioma (sequential zero- and first-order absorption + 2-compartment parent + 2-compartment N-desmethyl-selumetinib metabolite; ratifies new `ndsel` registered metabolite suffix).
