...
* Add ter Heine 2014 dextromethorphan ([doi:10.1111/bcp.12388](https://doi.org/10.1111/bcp.12388)) -- adult breast-cancer patients on chronic tamoxifen (semi-physiological eight-compartment popPK for dextromethorphan + three phase I metabolites; ratifies new `dxor`, `3mm`, `3hm` registered metabolite suffixes). Tamoxifen / endoxifen model demographics refreshed against the source publication's Table 1.
