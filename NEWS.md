...
* Add Hamuro 2017 DMD 6MWT natural-history disease-progression model ([doi:10.1002/psp4.12220](https://doi.org/10.1002/psp4.12220)) -- ambulatory boys with Duchenne muscular dystrophy on stable corticosteroids (two-line minimum age-progression model for the six-minute walk test).
