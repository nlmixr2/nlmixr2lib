...
* Add Jin 2014 simvastatin ([doi:10.1007/s11095-013-1284-0](https://doi.org/10.1007/s11095-013-1284-0)) -- 133 healthy adult Korean male volunteers (joint parent + simvastatin acid popPK with three parallel mixed zero-and-first-order absorption processes and non-equilibrium reversible interconversion; ratifies new `acid` registered metabolite suffix for the simvastatin lactone-acid pair).
