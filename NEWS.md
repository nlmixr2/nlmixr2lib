...
* Add Henin 2012 felodipine and diclofenac ([doi:10.1208/s12248-012-9324-y](https://doi.org/10.1208/s12248-012-9324-y)) -- healthy adult volunteers (6 for felodipine, 30 for diclofenac); Gastro-Intestinal Transit Time (GITT) semi-mechanistic absorption model with per-subject tablet-position inflection-point covariates IP_FA / IP_APSI / IP_PSI_DSI / IP_DSI_C.
