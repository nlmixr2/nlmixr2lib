...
* Add Delor 2013 alzheimer ([doi:10.1038/psp.2013.54](https://doi.org/10.1038/psp.2013.54)) -- 380 mild cognitive impairment plus 180 Alzheimer's disease subjects from the ADNI database (disease-progression model for CDR-SOB with individual disease-onset time, logit-domain trajectory, two-component slow/fast mixture, and study-entry placebo term; ratifies new `CDR_SOB`, `ADAS_COG`, `MMSE`, `FAQ`, `RHPNM`, and `T_ENTRY` covariate canonicals).
