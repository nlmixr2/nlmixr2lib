...
* Add Sherer 2012 abdominal aortic aneurysm ([doi:10.1038/psp.2012.13](https://doi.org/10.1038/psp.2012.13)) -- men aged 65-83 years with small (30-49 mm) screen-detected AAA (Health in Men Study, Perth, Western Australia; hierarchical Bayesian disease-progression ODE with multivariate-normal random effects on baseline size / baseline growth rate / first derivative of growth rate with size; ratifies new `AAA_DIAM` and `DDIMER` covariate canonicals).
