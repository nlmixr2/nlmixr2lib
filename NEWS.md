...
* Add Majekodunmi 2017 HIV/HCV pediatric CD4 z-score recovery ([doi:10.1097/INF.0000000000001478](https://doi.org/10.1097/INF.0000000000001478)) -- HIV-infected children on antiretroviral therapy, 355 HIV monoinfected (Ukraine) plus 46 HIV/HCV coinfected (8 European EPPICC cohorts); ratifies new `HCV_POS` covariate canonical and seven EPPICC enrollment-country indicators (`REGION_POLAND`, `REGION_RUSSIA`, `REGION_SWITZERLAND`, `REGION_UK`, `REGION_SPAIN`, `REGION_GERMANY`, `REGION_ITALY`).
