...
* Add Puisset 2007 docetaxel ([doi:10.1038/sj.bjc.6603872](https://doi.org/10.1038/sj.bjc.6603872)) -- adult cancer patients receiving single-agent docetaxel monochemotherapy (PD-only Friberg myelosuppression model with AAG, prior-chemotherapy-lines, and treatment-centre covariates on the drug-effect slope; ratifies new `PRIOR_CHEMO_LINES_GE2` and `STUDY_TOULOUSE` covariate canonicals).
