...
* Add Shin 2014 sevoflurane ([doi:10.3349/ymj.2014.55.6.1624](https://doi.org/10.3349/ymj.2014.55.6.1624)) -- pediatric dental-surgery patients (mentally intact and mentally disabled) during emergence from sevoflurane general anesthesia (ratifies new `MENT_DISABLED` and `ETSEVO` covariate canonicals).
