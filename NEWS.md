...
* Add Lu 2014 SGLT systems-pharmacology model ([doi:10.3389/fphar.2014.00274](https://doi.org/10.3389/fphar.2014.00274)) -- pooled human cohorts (healthy + T2DM across four published studies) under stepped hyperglycemic clamp, with optional SGLT2 inhibition by dapagliflozin or canagliflozin; ratifies new `CINH` covariate canonical for the time-varying plasma SGLT-inhibitor regressor.
