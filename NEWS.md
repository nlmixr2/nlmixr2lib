...
* Add Zuo 2016 ursodeoxycholic acid ([doi:10.1002/psp4.12100](https://doi.org/10.1002/psp4.12100)) -- healthy adults and patients with primary biliary cirrhosis (19-ODE enterohepatic-recirculation systems model of UDCA + GUDCA + TUDCA, with meal/snack-modulated biliary-to-intestine fluxes and a `DIS_PBC` disease-state switch; ratifies new `DIS_PBC`, `MEAL_FLAG`, `SNACK_FLAG`, and `FRACABS` covariate canonicals).
