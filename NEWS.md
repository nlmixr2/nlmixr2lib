...
* Add Landersdorfer 2018 meropenem + tobramycin ([doi:10.1128/AAC.02055-17](https://doi.org/10.1128/AAC.02055-17)) -- in vitro static-concentration time-kill mechanism-based PD model of bacterial killing and resistance for *Pseudomonas aeruginosa* PAO1 wild-type and its isogenic hypermutable PAOdelta-mutS sibling (two model files sharing one validation vignette); ratifies new canonical `ctob` antibiotic bath-concentration state.
