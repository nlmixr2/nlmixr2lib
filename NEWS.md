...
* Add Thuo 2011 ciprofloxacin ([doi:10.1093/jac/dkr314](https://doi.org/10.1093/jac/dkr314)) -- Kenyan children with severe malnutrition aged 8-102 months; ratifies new `SOD` (serum sodium) and `MORTRISK_HIGH` (high-mortality-risk indicator) covariate canonicals.
