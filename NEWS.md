...
* Add Lommerse 2019 raltegravir ([doi:10.1002/psp4.12443](https://doi.org/10.1002/psp4.12443)) -- integrated maternal-neonatal joint popPK model of oral raltegravir in HIV-1-exposed neonates (with and without in utero exposure), HIV-1-infected infants, and pregnant women; couples mother and fetus via a fast placental intercompartmental clearance in utero that decouples at birth.
