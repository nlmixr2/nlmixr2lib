...
* Add Lee 2013 colistin ([doi:10.1128/AAC.00271-13](https://doi.org/10.1128/AAC.00271-13)) -- adult burn-ICU patients receiving colistimethate sodium (CMS) every 12 h (ratifies new `DIS_EDEMA` covariate canonical for clinically-evident peripheral edema indicator).
