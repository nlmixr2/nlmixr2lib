...
* Add Xia 2024 warfarin ([doi:10.1038/s41598-024-65048-7](https://doi.org/10.1038/s41598-024-65048-7)) -- adult Han Chinese on warfarin anticoagulation (Hamberg-style K-PD model with two parallel coagulation-factor transit chains; PK fixed from Hamberg literature, EC50 re-estimated by VKORC1 -1639 genotype with weight power and amiodarone effects; ratifies new `CYP2C9_S1_COUNT`, `CYP2C9_S2_COUNT`, `CYP2C9_S3_COUNT`, `VKORC1_1639G_COUNT`, `CONMED_AMIO`, and `INR_BASE` covariate canonicals).
