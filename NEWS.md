...
* Add Back 2018 fenofibrate ([doi:10.1186/s40360-018-0194-5](https://doi.org/10.1186/s40360-018-0194-5)) -- healthy Korean adults in a three-way crossover food-effect study (mechanism-based GI absorption model with stomach / duodenum / central drug compartments coupled to a 2-compartment calorie sub-model; time-varying gastric emptying and meal-type-specific Vc/F shifts).
