...
* Add Schipani 2016 rifampicin ([doi:10.1111/bcp.12848](https://doi.org/10.1111/bcp.12848)) -- Malawian adults and children with tuberculosis (one-compartment first-order absorption popPK with allometric WT scaling, age power-effect on CL, and a child-vs-adult relative-bioavailability factor).
