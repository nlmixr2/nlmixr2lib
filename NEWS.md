...
* Add Farrell 2014 eltrombopag ([doi:10.1111/bcp.12244](https://doi.org/10.1111/bcp.12244)) -- healthy male volunteers and adults with chronic liver disease (popPK/PD with two-compartment dual sequential first-order absorption and four-compartment platelet lifespan; ratifies new `RACE_ASIAN_SOUTHCENTRAL` and `HEPIMP_CP_SCORE` covariate canonicals and promotes `RACE_NEAS` to general scope).
