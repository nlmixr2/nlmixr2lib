...
* Add Oualha 2014 epinephrine ([doi:10.1186/cc13707](https://doi.org/10.1186/cc13707)) -- critically ill children post-cardiopulmonary-bypass for repair of congenital heart defects (paediatric PK/PD with hemodynamic Emax and glucose/lactate turnover sub-models; ratifies new `RACHS1` and `CVP` covariate canonicals and new `glucose` / `lactate` compartment names).
