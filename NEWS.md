...
* Add Woillard 2011 tacrolimus ([doi:10.1111/j.1365-2125.2010.03837.x](https://doi.org/10.1111/j.1365-2125.2010.03837.x)) -- adult renal transplant recipients pooled across the twice-daily immediate-release Prograf and once-daily prolonged-release Advagraf formulations (two-compartment popPK with three-transit Erlang absorption; ratifies new `FORM_TAC_IR` covariate canonical for the Prograf-vs-Advagraf formulation contrast).
