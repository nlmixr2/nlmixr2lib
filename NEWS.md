...
* Add Goulooze 2022 finerenone ([doi:10.1007/s40262-021-01083-1](https://doi.org/10.1007/s40262-021-01083-1)) -- adults with chronic kidney disease and type 2 diabetes mellitus (FIDELIO-DKD Phase III serum-potassium PKPD turnover model); ratifies new `UACR` covariate canonical and `serumK` compartment canonical.
