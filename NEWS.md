...
* Add Kleideiter 2017 cebranopadol ([doi:10.1007/s40262-017-0545-1](https://doi.org/10.1007/s40262-017-0545-1)) -- healthy adults and chronic-pain patients (LBP/OA, DPN, post-bunionectomy); ratifies new `CYP2C9_PM_IM`, `DIS_DPN`, and `DIS_BUNIONECTOMY` covariate canonicals and applies the 2018 corrigendum (bioavailability row labels swap).
