...
* Add Goteti 2024 SLE latent-variable MBMA ([doi:10.1002/psp4.13083](https://doi.org/10.1002/psp4.13083)) -- Bayesian model-based meta-analysis of 25 randomized clinical trials in adults with systemic lupus erythematosus (SLE); latent-variable disease-trajectory model with continuous-Emax dose-response for six SLE therapeutics (anifrolumab, belimumab, CC-220 / iberdomide, epratuzumab, lulizumab pegol, sifalimumab) and discrete-effect coverage for 10 additional drugs. Ratifies new `SCORE_SLEDAI` covariate canonical.
