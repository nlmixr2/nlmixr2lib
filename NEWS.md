...
* Add Almquist 2016 ticagrelor + MEDI2452 antidote ([doi:10.1002/psp4.12089](https://doi.org/10.1002/psp4.12089)) -- preclinical mouse (C57Bl/6 male) mechanistic interaction PK model for ticagrelor, its active metabolite TAM, and the ticagrelor-neutralising Fab antibody fragment MEDI2452 (ratifies new `tam` registered metabolite suffix for the ticagrelor active metabolite AR-C124910XX).
