...
* Add Waterhouse 2024 vedolizumab ([doi:10.1002/prp2.1257](https://doi.org/10.1002/prp2.1257)) -- adults undergoing allogeneic hematopoietic stem cell transplantation for graft-versus-host disease prophylaxis; ratifies new `LYMPH_ABS`, `AGVHD_LIVER`, `AGVHD_SKIN`, and `AGVHD_INTESTINE` covariate canonicals.
