...
* Add Hansson 2013 sunitinib adverse-effect and overall-survival sub-models ([doi:10.1038/psp.2013.62](https://doi.org/10.1038/psp.2013.62)) -- adults with imatinib-resistant gastrointestinal stromal tumours (GIST); four new sub-model files alongside the existing `Hansson_2013c_sunitinib` fatigue file: `Hansson_2013_sunitinib_myelosuppression` (Friberg-Karlsson semi-physiological ANC model driven by sVEGFR-3 REL with a Japanese-cohort baseline shift), `Hansson_2013_sunitinib_dbp` (indirect-response diastolic blood pressure with sunitinib-AUC stimulation of Kin), `Hansson_2013_sunitinib_hfs` (hand-foot syndrome Markov + proportional-odds with delayed sVEGFR-3 driver, structurally parallel to the existing fatigue file), and `Hansson_2013_sunitinib_os` (Weibull overall-survival hazard with ANC(t), dBP relative-change(t), and baseline tumour-size predictors).
