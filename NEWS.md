...
* Add Zou 2022 furmonertinib ([doi:10.1038/s41401-021-00798-y](https://doi.org/10.1038/s41401-021-00798-y)) -- adults with EGFR-mutant NSCLC and healthy male volunteers (semi-mechanistic parent + AST5902 metabolite popPK with autoinduction IDR III and food-effect covariates; ratifies new `ast5902` metabolite-suffix canonical).
