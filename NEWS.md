...
* Add Fisher 2008 fosamprenavir (ACOP 2008 poster, <https://metrumrg.com/wp-content/uploads/2018/08/acop_2008_fosamprenavir.pdf>) -- HIV-1-infected pediatric patients aged 4 weeks to 18 years (ratifies new `RACE_NONBLACK_NONWHITE` covariate canonical and promotes the Fisher 2008 fosamprenavir bioavailability use case under the existing `FORM_TABLET` canonical).
