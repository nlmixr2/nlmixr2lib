...
* Add Yang 2023 diclazuril ([doi:10.3390/ani13091512](https://doi.org/10.3390/ani13091512)) -- broiler chickens receiving diclazuril continuously in medicated feed or drinking water (nine-compartment flow-limited whole-body residue-depletion PBPK supporting withdrawal-period estimation against Chinese and European MRLs); ratifies new canonical lumped `skin_fat` PBPK compartment.
