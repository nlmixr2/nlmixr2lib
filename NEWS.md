...
* Add Thakkar 2017 amifampridine ([doi:10.1002/psp4.12218](https://doi.org/10.1002/psp4.12218)) -- adults with Lambert-Eaton myasthenia (DAPPER phase II withdrawal study NCT01511978; parent + 3-Ac DAP metabolite popPK with fractional-inhibitory Emax PD on 3TUG; ratifies new `acdap` metabolite suffix).
