...
* Add Pillai 2004 ibandronate ([doi:10.1111/j.1365-2125.2004.02224.x](https://doi.org/10.1111/j.1365-2125.2004.02224.x)) -- postmenopausal women with osteoporosis (K-PD model for uCTX response to i.v. and oral ibandronate, with and without calcium + vitamin D supplementation; ratifies new `CONMED_CAVITD` covariate canonical).
