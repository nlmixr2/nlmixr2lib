...
* Add Cirincione 2017 ER exenatide ([doi:10.1208/s12248-016-9975-1](https://doi.org/10.1208/s12248-016-9975-1)) -- adults with type 2 diabetes mellitus receiving single or weekly SC extended-release microsphere exenatide (ratifies new `STUDY_MD` covariate canonical for the multi-dose phase II cohort indicator).
