...
* Add Jadhav 2023 bempedoic acid ([doi:10.1007/s10928-023-09864-w](https://doi.org/10.1007/s10928-023-09864-w)) -- healthy subjects and patients with dyslipidemia (popPK plus a joint popPK/PD indirect-response model for LDL-C); ratifies new `DIS_HYPERLIP`, `CONMED_STATIN_LI` / `_MI` / `_HI`, `CONMED_ATORVASTATIN`, `CONMED_SIMVASTATIN`, `PRIOR_STATIN`, and `PRIOR_EZE` covariate canonicals.
