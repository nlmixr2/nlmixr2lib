...
* Add Wu 2014 FEV1 in childhood asthma ([doi:10.1164/rccm.201403-0460OC](https://doi.org/10.1164/rccm.201403-0460OC)) -- 1,041 children with mild to moderate persistent asthma in the Childhood Asthma Management Program (CAMP) study; ratifies new `CONMED_BUDESONIDE` covariate canonical and promotes `HT` to general scope.
