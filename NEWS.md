...
* Add Brekkan 2016 factor IX ([doi:10.1111/jth.13271](https://doi.org/10.1111/jth.13271)) -- adults with moderate or severe haemophilia B on plasma-derived FIX (three-compartment IV popPK with allometric weight scaling and an endogenous baseline FIX activity estimated as a structural parameter, intended for Bayesian dose individualisation).
