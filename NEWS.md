...
* Add Wang 2014 vatalanib ([doi:10.1111/bcp.12427](https://doi.org/10.1111/bcp.12427)) -- adults with myelodysplastic syndrome (CALGB 10105 Alliance phase II; one-compartment oral PK with lagged first-order absorption and first-order auto-induction of clearance).
