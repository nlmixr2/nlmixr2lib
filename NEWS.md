...
* Add Kloprogge 2013 lumefantrine ([doi:10.1038/psp.2013.59](https://doi.org/10.1038/psp.2013.59)) -- pregnant and non-pregnant women with uncomplicated *Plasmodium falciparum* malaria in Uganda receiving standard six-dose oral artemether-lumefantrine (ratifies new `BODYTEMP` covariate canonical for body temperature in degC).
