...
* Add Adams 1998 zalcitabine ([doi:10.1128/aac.42.2.409](https://doi.org/10.1128/aac.42.2.409)) -- HIV-infected adults on chronic oral zalcitabine in routine clinic follow-up (one-compartment apparent-CL/F PK with ka FIXED from Klecker 1988 because the source paper could not estimate it).
