...
* Add Niebecker 2015 edoxaban ([doi:10.1111/bcp.12727](https://doi.org/10.1111/bcp.12727)) -- pooled phase 1 healthy volunteers (13 studies) and Hokusai-VTE phase 3 patients with deep-vein thrombosis or pulmonary embolism (ratifies new `PGP_INH` and `STUDY_HOKVTE` covariate canonicals).
