...
* Add Vorontsova 2022 misoprostol ([doi:10.1111/cts.13306](https://doi.org/10.1111/cts.13306)) -- pregnant women at term (>=37 weeks gestation) undergoing labor induction (IMPROVE trial); ratifies new `ROUTE_VAGINAL` covariate canonical for vaginal-vs-buccal administration route indicator.
