...
* Add Xu 2013 ranibizumab ([doi:10.1167/iovs.12-10260](https://doi.org/10.1167/iovs.12-10260)) -- adults with neovascular age-related macular degeneration receiving intravitreal ranibizumab (ratifies new `CONMED_VERTEPORFIN` covariate canonical for concomitant verteporfin photodynamic therapy).
