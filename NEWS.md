...
* Add Hong 2013 glucose-insulin homeostasis model in T2DM ([doi:10.1208/s12248-013-9512-4](https://doi.org/10.1208/s12248-013-9512-4)) -- adults with type 2 diabetes mellitus undergoing hyperglycemic glucose clamp and meal tolerance tests; ratifies new `insulin` canonical compartment and promotes `INS_BL` to general scope.
