...
* Add Kakara 2014 atorvastatin, pitavastatin, and rosuvastatin ([doi:10.1111/bcp.12405](https://doi.org/10.1111/bcp.12405)) -- adults on chronic statin therapy at a Japanese tertiary centre; LDL-C indirect-response Imax PD model with ezetimibe co-medication effect (promotes `CONMED_EZE` covariate scope from specific to general).
