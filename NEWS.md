...
* Add Li 2014 penicillin G ([doi:10.1128/AAC.02806-14](https://doi.org/10.1128/AAC.02806-14)) -- preclinical cattle and swine (two species-specific 3-compartment popPK models with parallel absorption depots and liver / kidney / muscle tissue residue compartments, fitted to pooled literature + FARAD data).
