...
* Add Jonsson 2011 ethambutol ([doi:10.1128/AAC.00274-11](https://doi.org/10.1128/AAC.00274-11)) -- adults with pulmonary tuberculosis (South African pooled cohort, 189 subjects; paper-Table-2-sourced sibling to the existing `Jonsson_2011_ethambutol_ddmore` DDMORE-bundle replicate).
