...
* Add Perrottet 2009 ganciclovir ([doi:10.1128/AAC.00836-08](https://doi.org/10.1128/AAC.00836-08)) -- adult solid-organ transplant recipients receiving oral valganciclovir (ratifies new `TX_HEART` and `TX_LUNG` covariate canonicals and promotes `TX_LIVER` to general scope).
