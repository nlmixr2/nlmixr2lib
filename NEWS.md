...
* Add Lacy 2018 cabozantinib ([doi:10.1007/s00280-018-3581-0](https://doi.org/10.1007/s00280-018-3581-0)) -- healthy volunteers and adults with renal cell carcinoma, castration-resistant prostate cancer, medullary thyroid carcinoma, glioblastoma, or other advanced malignancies (n = 1534 across nine studies); ratifies new `TUMTP_MTC` and `TUMTP_RCC` covariate canonicals.
