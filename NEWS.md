...
* Add Sherwin 2012 risperidone ([doi:10.1097/FTD.0b013e318261c240](https://doi.org/10.1097/FTD.0b013e318261c240)) -- children and adolescents (3-18.3 years) with neuropsychiatric disorders on stable oral risperidone; ratifies the new `CYP2D6_EM` covariate canonical paired with `CYP2D6_PM` for three-level PM / IM / EM phenotype encoding.
