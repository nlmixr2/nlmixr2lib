...
* Add Koo 2012 propofol ([doi:10.1038/aps.2012.85](https://doi.org/10.1038/aps.2012.85)) -- adults during emergence from propofol-remifentanil TCI anesthesia (sigmoid Emax probability of return of consciousness with age covariate on Ce50 and Hill); ratifies new canonical `CEFFECT` covariate for effect-site PD drivers.
