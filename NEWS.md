...
* Add Jensen 2023 LNG-IUS 52 mg ([doi:10.1016/j.contraception.2023.109954](https://doi.org/10.1016/j.contraception.2023.109954)) -- premenopausal women (18-40 years) using levonorgestrel-releasing intrauterine system 52 mg (Mirena) for contraception over up to 8 years; joint 8-year popPK / SHBG-turnover model with SHBG-dependent LNG free-fraction binding equilibrium. Ratifies new `shbg` canonical compartment (sex hormone-binding globulin biomarker turnover state).
