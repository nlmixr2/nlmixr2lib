...
* Add Krause 2017 selexipag ([doi:10.1002/psp4.12202](https://doi.org/10.1002/psp4.12202)) -- adults with pulmonary arterial hypertension (GRIPHON phase III; ratifies new `act` (ACT-333679) metabolite suffix and `CONMED_ERA` / `CONMED_PDE5I` / `CONMED_ERA_PDE5I` PAH-comedication covariate canonicals).
