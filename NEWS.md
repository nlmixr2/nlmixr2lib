...
* Add Overgaard 2016 liraglutide ([doi:10.1007/s40262-016-0410-7](https://doi.org/10.1007/s40262-016-0410-7)) -- overweight and obese adults with and without type 2 diabetes on 1.8-3.0 mg once-daily SC liraglutide (SCALE Obesity and Prediabetes + SCALE Diabetes pooled analysis); ratifies new `AGE_GE70`, `DIS_PREDIAB`, and `DOSE_1P8MG` covariate canonicals.
