...
* Add Eudy-Byrne 2021 buprenorphine ([doi:10.1111/cts.13074](https://doi.org/10.1111/cts.13074)) -- neonates with neonatal opioid withdrawal syndrome (indirect-response PD model on MOTHER NAS scores; ratifies new canonical `nows` PD-endpoint output state and `nowsmax` / `nowsm` paper-mechanistic parameters).
