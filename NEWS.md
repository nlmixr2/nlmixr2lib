...
* Add Bruno 2005 trastuzumab ([doi:10.1007/s00280-005-1026-z](https://doi.org/10.1007/s00280-005-1026-z)) -- adults with HER2-positive metastatic breast cancer or advanced solid tumors (first published trastuzumab popPK; ratifies new `MET_GE4` covariate canonical for the >= 4 metastatic-sites indicator).
