...
* Add Schmid 2017 nintedanib ([doi:10.1007/s00280-017-3452-0](https://doi.org/10.1007/s00280-017-3452-0)) -- adults with non-small cell lung cancer or idiopathic pulmonary fibrosis (joint parent + BIBF 1202 metabolite popPK; ratifies new `bibf` metabolite suffix and `RACE_IND_CHI_TWN`, `RACE_KOREAN`, `RACE_INDIAN`, `TUMTP_NSCLC_NONADENO`, `STUDY_TOMORROW`, `STUDY_NSCLC_NIN_PH2`, `STUDY_LUMELUNG1`, `STUDY_LUMELUNG2` covariate canonicals).
