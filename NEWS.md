...
* Add Elassaiss-Schaap 2017 pembrolizumab ([doi:10.1002/psp4.12132](https://doi.org/10.1002/psp4.12132)) -- adults with advanced solid tumors (KEYNOTE-001 parts A, A1, A2; two-compartment PK with parallel linear and Michaelis-Menten clearance plus a direct-response Imax PK/PD model on the ex vivo IL-2 stimulation ratio).
