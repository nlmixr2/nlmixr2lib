...
* Add Ait-Oudhia 2016 sunitinib ([doi:10.1002/psp4.12084](https://doi.org/10.1002/psp4.12084)) -- adults with advanced hepatocellular carcinoma receiving 37.5 mg PO QD (joint parent + SU12662 metabolite popPK with sVEGFR2 indirect-response biomarker and tumor-growth-inhibition PD; ratifies new `su12662` metabolite suffix and new `svegfr2` / `tumor` canonical compartments).
