...
* Add Wilson 2015 sunitinib + irinotecan ([doi:10.1002/psp4.12045](https://doi.org/10.1002/psp4.12045)) -- preclinical athymic nude male mice with HT-29 colorectal-cancer xenografts (mechanistic K-PD tumor-growth model combining sunitinib antiangiogenic effect on vasculature carrying capacity with an irinotecan three-stage transit-death chain and an empirical interaction term scaling the irinotecan transit rate by cumulative pre-irinotecan sunitinib exposure).
