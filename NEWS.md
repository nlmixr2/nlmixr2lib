...
* Add Eissing 2024 finerenone ([doi:10.1111/dom.15387](https://doi.org/10.1111/dom.15387)) -- adults with chronic kidney disease and type 2 diabetes (FIGARO-DKD final population PK model; two-compartment linear disposition with 4-transit-compartment delayed first-order absorption).
