...
* Add Williams 2016 rituximab and PF-05280586 biosimilar DAS28cfb + ACR responder rate models ([doi:10.1111/bcp.13094](https://doi.org/10.1111/bcp.13094)) -- adults with active rheumatoid arthritis on background methotrexate with prior inadequate response to TNF-antagonist therapy; ratifies new canonical `TEND_28JOINT` / `TEND_68JOINT` / `SWOL_66JOINT` / `PGA_PT` / `CP_RITUXIMAB_UGML` covariates and `das28cfb` compartment.
