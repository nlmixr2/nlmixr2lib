...
* Add Brochot 2015 darunavir ([doi:10.1002/psp4.44](https://doi.org/10.1002/psp4.44)) -- pooled adult and pediatric (aged 3-66 years) HIV-1-infected patients on ritonavir-boosted darunavir (two-compartment popPK with AAG-dependent apparent clearance and allometric weight scaling; supports the paper's once-daily pediatric dosing recommendations).
