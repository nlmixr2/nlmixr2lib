...
* Add Biliouris 2018 nusinersen ([doi:10.1002/psp4.12323](https://doi.org/10.1002/psp4.12323)) -- semi-mechanistic nine-compartment CNS-distribution PK model fit to cynomolgus monkeys with pediatric-human extrapolation (V_CSF stepwise by age for < 2 y; volumes linear in body weight from 2.8 kg reference; rate constants scaled as (WT/2.8)^(-0.08)).
