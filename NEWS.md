...
* Add Olagunju 2018 efavirenz ([doi:10.1093/jac/dkx334](https://doi.org/10.1093/jac/dkx334)) -- HIV-positive Nigerian pregnant women on combination antiretroviral therapy; promotes `SNP_CYP2B6_RS3745274_T_COUNT` and `SNP_CYP2B6_RS28399499_C_COUNT` covariate canonicals from `Scope: specific` to `Scope: general`.
