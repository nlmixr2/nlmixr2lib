...
* Add Syvanen 2011 (R)-[11C]verapamil ([doi:10.1186/1471-2342-11-1](https://doi.org/10.1186/1471-2342-11-1)) -- preclinical male Sprague-Dawley rats in a PET P-glycoprotein blood-brain-barrier study (kainate-induced post-status-epilepticus vs saline control, with paired tariquidar vs vehicle co-administration); ratifies new `CONMED_TARIQUIDAR` and `DIS_POSTSE_KAINATE` covariate canonicals.
