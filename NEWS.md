...
* Add Nicholas 2009 ponezumab ([doi:10.1016/j.jalz.2009.04.270](https://doi.org/10.1016/j.jalz.2009.04.270)) -- adults with mild-to-moderate Alzheimer's disease (preliminary two-compartment IV popPK for the humanized anti-amyloid mAb PF-04360365 with estimated allometric body-weight exponents on every disposition parameter and a full 4x4 inter-individual omega block).
