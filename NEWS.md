...
* Add Yoshida 2024 fazpilodemab ([doi:10.1002/psp4.13111](https://doi.org/10.1002/psp4.13111)) -- adults with type 2 diabetes mellitus or NAFLD (popPK + longitudinal GIAE DTMM + treatment-discontinuation logistic; promotes `PREV_AE_SCORE` covariate canonical to general scope).
