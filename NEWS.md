...
* Add Selvaggio 2021 mRNA vaccine QSP ([doi:10.1002/psp4.12721](https://doi.org/10.1002/psp4.12721)) -- mRNA-LNP vaccine mechanistic quantitative systems pharmacology framework calibrated to rhesus macaque data (Liang 2017), with a Chen 2014 adaptive-immune backbone (T cells, B cells, antibody) and a new mRNA-specific injection-site + lymph-node innate-cell recruitment / uptake / antigen-presentation layer.
