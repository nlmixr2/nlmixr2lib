...
* Add Ramharter 2019 mefloquine ([doi:10.1128/AAC.01113-18](https://doi.org/10.1128/AAC.01113-18)) -- pregnant African women receiving intermittent preventive treatment for malaria in Gabon (MIPPAD trial; joint (+)- / (-)-mefloquine + carboxymefloquine popPK with two-stage enzyme-pool autoinduction; ratifies new `_cmq` metabolite suffix and `REGIMEN_SPLIT` covariate canonical).
