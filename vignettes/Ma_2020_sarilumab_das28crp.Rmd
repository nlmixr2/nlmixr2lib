...
drug product, ALBR = 0.78, CRCL_BSA = 100 mL/min/1.73 m^2, BLCRP = 14.2 mg/L);
the reference covariate values for the *DAS28-CRP* model, by contrast, are
set from the DAS28-CRP-dataset medians per the Ma 2020 narrative (BLCRP 15.7
...
- **Baseline carries four continuous covariates.** The paper's Table 3 lists
  BLCRP, BLPHYVAS, BLHAQ, and WT as covariates on BASE with power-form
  exponents 0.0564, 0.105, 0.0779, and 0.0522 respectively. Reference
  values are the DAS28-CRP-dataset medians (BLCRP 15.7 mg/L, BLPHYVAS 66,
...
values (BLCRP 15.7 mg/L, BLPHYVAS 66, BLHAQ 1.75, WT 72.8 kg, PRICORT = 0):
...
- **Approach (a): PK backbone embedded at typical covariate values.** Ma
  ...
  (ADA, drug product, sex, ALBR, CRCL_BSA, WT-on-PK, BLCRP-on-Vm) are
...
- **Reference-covariate values for the embedded PK.** Xu 2019 typical
  ...
  are distinct (BLCRP 15.7, BLPHYVAS 66, BLHAQ 1.75, WT 72.8, PRICORT = 0)
