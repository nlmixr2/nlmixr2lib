...
tail incidence. The upstream popPK (Houk 2009) was not available when this
model was built, so its
...
* **Suspected factor-of-1000 scale erratum in Table S2 (three
  ...
  values, and every corrected parameter carries an inline comment in
  the model file's `ini()` block.
