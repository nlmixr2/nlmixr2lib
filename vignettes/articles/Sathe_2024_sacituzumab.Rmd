...
* **Total antibody (tAB)** — output `Cc_tab`. Two-compartment PK with time-dependent
...
| `allo_cl` (Body-wt exponent on SG CL/Q)             | 0.507571            | Sathe 2024 Table 1; supplement Section 6.b TH(6) FIX |
| `allo_v` (Body-wt exponent on SG V1/V2)             | 0.532396            | Sathe 2024 Table 1; supplement Section 6.b TH(7) FIX |
...
| `allo_cl_sn38` (Body-wt exponent on SN-38 CL/Q)     | 0.500               | Sathe 2024 Table 2 |
...
| `allo_cl_tab` (Body-wt exponent on tAB CL/Q)        | 0.372               | Sathe 2024 Table 3 |
| `allo_v_tab` (Body-wt exponent on tAB V1/V2)        | 0.446               | Sathe 2024 Table 3 |
...
* **Compartment names.** Multi-output ADC simulation requires named
  ...
  `peripheral1_tab`) outside the canonical `central`/`peripheral1`
