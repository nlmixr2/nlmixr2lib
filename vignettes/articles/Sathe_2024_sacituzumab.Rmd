---
title: "Sacituzumab (Sathe 2024)"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Sacituzumab (Sathe 2024)}
...
* **Compartment names.** Multi-output ADC simulation requires named
  ...
  set defined in `inst/references/compartment-names.md`. `nlmixr2lib::checkModelConventions`
