...
3. **Covariate effects (age, gender, BMI) not implemented.** Section
   ...
   were not available when this model was built. Reproducing Figure 7 of the
...
* The main-text PDF was used as the sole source. Electronic Supplementary
  Material (ESM) Table I (demographic statistics) and ESM Table II (final
  parameter estimates from study B, plus the full PSG dataset) and Appendix 1
  (the NONMEM control stream for sub-model AW) were referenced in the paper
  but were not available when this model was built.
