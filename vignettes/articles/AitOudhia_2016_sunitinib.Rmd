...
sex, race) are reported in Supplementary Table S1, which was not available;
...
- **Baseline tumor volume.** The paper does not publish per-
  ...
  DCE-MRI subset is described in Supplementary Table S1 (not available
  when this model was built). The vignette uses a representative tumor
  volume of 50,000 mm^3 for the typical-cohort simulation. Users running
