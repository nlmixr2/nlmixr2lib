...
(2013, 28 T2DM, 100 mg/day canagliflozin for 8 days), Mogensen (1971,
9 healthy + 10 diabetic, glucose infusion to over 650 mg/dL), and
Wolf et al. (2009, 22 T2DM, stepped hyperglycemic clamp). The Lu 2014
...
Simulate the DeFronzo et al. (2013) procedure in a T2DM subject:
...
Lu 2014 Figure 2D (T2DM, after-treatment).
...
* **T2DM vs healthy Vmax2.** The typical-value Vmax2 in `ini()` is
  the calibrated healthy value (93.5 mmol/h); the T2DM = 1 cohort
  uses Vmax2_TYP * (1 + 0.176) = 110 mmol/h via the covariate effect
  `e_t2dm_vmax2`. All other SGLT-kinetics parameters (Vmax1, Km1,
  Km2, Ki1, Ki2) are held common between T2DM and healthy per Lu
  2014 Methods.
