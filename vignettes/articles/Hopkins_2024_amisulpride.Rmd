...
about 40% (cohort geometric mean 356 against a published 599 ng/mL) for the
reason recorded in the first Errata bullet below; the CR peak itself lands
within a percent of the published value (314.3 against 314 ng/mL). Nothing was
...
* **The IR peak concentration is under-predicted by about 40%.** The cohort
  geometric mean is 356 ng/mL against a published 599, and the typical-value
  prediction is 381 ng/mL, i.e. about a third low. This is a
