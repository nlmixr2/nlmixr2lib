...
85 kg (adult). The original Wang 2013 PDF was not available when this
model was built, so per-study counts,
...
deferred to the self-consistency check below.
...
- **Adult oral-bioavailability arm.** The `.mod` `$PK` block applies
  ...
  Wang 2013 PDF was not available when this model was built,
  so the rationale for the 0.88 reduction in adults
