...
The solver reproduces the closed form to better than one part in 10^7 over
five orders of magnitude of concentration, confirming the ODE, the volume
scaling and the infusion handling.
