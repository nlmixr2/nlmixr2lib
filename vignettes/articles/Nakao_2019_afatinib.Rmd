...
purely numerical (the ODE is integrated with tight tolerances) and a tight
bound is correct.
...
Day 1 and day 8 AUC0-24 agree with the observed geometric means to within
2%, and Cmax to within 16%. Tmax is flagged because it is a median of a
discrete quantity: the simulated grid has samples at 4 and 5 h, whereas the
observed samples were drawn in the 2-3 h and 4-6 h windows, so a 1-2 h
offset in a median Tmax is sampling-grid granularity rather than a model
discrepancy.
