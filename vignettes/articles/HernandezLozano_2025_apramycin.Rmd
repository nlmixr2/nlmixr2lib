...
* **The two antecedents that might print the `kada` equation could not be
  ...
  *Int J Antimicrob Agents*, doi:10.1016/j.ijantimicag.2022.106616 -- the paper
  ...
  open-access subset, and the maintainers could not obtain either. Neither
  was read, and nothing in this
  ...
  papers that *were* available (Sou 2021, Zhao 2022). In particular, the two
