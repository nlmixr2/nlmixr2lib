...
PK model, which was not available when this model was built (see *Assumptions and deviations*).
...
- **The upstream population PK model is not reproduced.** The vitreous
  ...
  Pharmacometrics, November 2023), which was not available when this model was built. That model
