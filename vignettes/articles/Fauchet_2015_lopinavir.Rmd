---
title: "Lopinavir in pregnancy (Fauchet 2015)"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Lopinavir in pregnancy (Fauchet 2015)}
...
Both submodels share a one-compartment first-order-absorption disposition for maternal LPV. Following the library's convention of replicating the author's structure, the two are packaged as two separate model files (`Fauchet_2015_lopinavir_unbound`, `Fauchet_2015_lopinavir_placental`) under one vignette.
