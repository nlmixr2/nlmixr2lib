...
- **Time-dependent CL `time` semantics**: `time` in `cl2 * exp(-kdes * time)`
...
- **Reference subject** (NHL adult, LBM 52.7 kg, AGE 60 y,
  BLSTABL 0.352, no rituximab): CL1 0.130 L/h, V1 6.49 L,
  CL2 0.569 L/h, kdes 0.0577 1/h, Q 0.0437 L/h, V2 4.74 L.
