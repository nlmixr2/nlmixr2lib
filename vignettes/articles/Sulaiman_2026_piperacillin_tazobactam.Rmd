...
* **Supplementary material was not available when this model was built.**
  Tables S2, S6, S7, S8, S9 and Texts
  S1, S3, S4, S5 are referenced by the paper but were not retrievable
  (Europe PMC holds no supplementary files for PMC13280637 and the publisher
...
* **Simulated regimens.** Three of the paper's 15 regimens are reproduced
  ...
  twelve are enumerated only in Text S5, which was not available.
