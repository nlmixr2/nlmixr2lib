...
The five display equations do not survive automated plain-text extraction of the
PDF, because the fraction bars and parentheses live in a symbol font. The forms
transcribed above were read from the rendered equation images, which resolve the
bracketing unambiguously -- in particular that the
