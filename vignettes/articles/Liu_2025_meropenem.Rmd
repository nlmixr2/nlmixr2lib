...
whole-body ODEs, so the PBPK model cannot be reproduced from the available sources and
is not encoded.
...
- **The PBPK model is not encoded.** Its whole-body structure and physiology
  ...
  the ODEs cannot be reproduced from the available sources.
...
- **ARC thresholds are not available.** The paper defines ARC as an eGFR above
