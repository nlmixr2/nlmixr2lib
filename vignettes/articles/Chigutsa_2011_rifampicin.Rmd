...
- **Body-text +30% MTT effect for female sex.** Chigutsa 2011 Table 2 row
  ...
  effect; per maintainer directive (2026-06-17), the body text is the
  source of truth: +30% (women have a longer absorption delay than men).
  The Table 2 row appears to be a typesetting row-duplication artifact
  of the V/F row.
