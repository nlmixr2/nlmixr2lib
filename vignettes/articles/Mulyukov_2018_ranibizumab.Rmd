...
expected half-life and AUC for a single 0.5 mg intravitreal injection. The
formula includes a treatment grouping variable (`dose_group`) so the result
rolls up one row per regimen.
