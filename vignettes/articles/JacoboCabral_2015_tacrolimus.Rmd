...
intervals live in online supplements (Tables S1 / S2) that are not on disk.
...
- **PKNCA reference NCA values come from the paper's Results-paragraph
  ...
  intervals are reported in online supplements (Tables S1 / S2) that are not
  on disk for this extraction. The dose-normalised CV% comparison in the
