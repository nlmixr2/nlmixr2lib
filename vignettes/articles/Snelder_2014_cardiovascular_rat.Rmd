...
papers that supply the rat baseline values are not on disk". This extraction
closes that gap for the 2014 paper: every value below is transcribed from the
