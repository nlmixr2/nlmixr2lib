...
* **Two covariate exponents are negative, and the minus signs are easy to
  ...
  U+2212 minus in the Elsevier PDF, which some text extractors drop (a
  plain-text extraction of the PDF renders both Table 2 and Table 3 with bare
  positive values). The signs are confirmed three ways in
