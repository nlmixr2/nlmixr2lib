...
- **Allometric exponents 0.75 (CL parameters) and 1 (volume parameters) are fixed.** Per Methods, Population PK model development paragraph (Anderson and Holford 2008 convention). The model wraps both `allo_cl` and `e_wt_vc_vp` in `fixed(...)`.
