...
- **Blood PK is inherited, not re-fitted.** The lead paper states that the blood
  ...
  (doi:10.1038/sj.bjp.0707257), which is open access and was available when
  this model was built, and are wrapped in `fixed()` to record that this paper
  did not estimate them. Only the biophase and pharmacodynamic parameters are
  estimated in the lead paper.
