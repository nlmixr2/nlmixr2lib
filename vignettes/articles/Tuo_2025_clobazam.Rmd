...
* **Equation recovery.** All twelve numbered equations do not survive automated
  text extraction of the PDF; they were recovered from the PDF text layer
  directly and are the basis for the ODE system, the covariate forms and the
  fixed allometric exponents.
