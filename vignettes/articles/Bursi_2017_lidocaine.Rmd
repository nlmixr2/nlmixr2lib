...
observations. The subject-count difference is not explained by any available source;
...
* **The subject count disagrees with the DDMORE sibling** (212 patients here
  ...
  1989 observations. No available source explains the difference; it is recorded as an
  open discrepancy, not resolved.

* **No erratum or corrigendum was located** for this article on the publisher's
  page or in PubMed Central when this model was built.
