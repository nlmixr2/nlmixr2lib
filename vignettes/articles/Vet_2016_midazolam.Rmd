...
recipe from the package's validation checklist: re-simulate the bundle's
...
was not on disk when this model was built, so demographic ranges (age range,
...
- **Vet 2016 publication PDF is not on disk** in the maintainers'
  ...
  extractable from DDMORE bundle".
