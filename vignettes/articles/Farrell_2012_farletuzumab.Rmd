---
title: "Farrell_2012_farletuzumab"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Farrell_2012_farletuzumab}
...
assigned `PHASE2 = 1` (Phase II residual error — the larger study and the one
...
- **Per-study residual error.** The paper reports separate residual-error
  ...
  `PHASE2` indicator (0 = Phase I, 1 = Phase II) selects between them in the
  model, following the same pattern used by `Cirincione_2017_exenatide.R`
  with `STUDY1` / `STUDY5`. The virtual cohort sets `PHASE2 = 1` because the
