...
a `ug/kg` dose cannot be converted to the `nmol` the model consumes from the
published information alone. A class-typical antibody molecular weight was **not**
...
published source and the missing structure was not reconstructed from class
knowledge:
