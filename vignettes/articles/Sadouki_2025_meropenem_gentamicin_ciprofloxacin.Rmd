...
the maintainers ("extract anyway with clear in-vitro metadata, file under
...
* **The supplement (Suppl. Fig. 1 -- 3, Suppl. Tables) was not available**
  when this model was built. Parameter values are taken from Table 1 of the
  main paper, which the paper explicitly designates as the "Final parameter
