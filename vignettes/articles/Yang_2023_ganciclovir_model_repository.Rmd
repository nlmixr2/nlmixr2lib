...
* Yang 2023 supplementary materials (Tables S1-S2, Figures S1-S2, and the
  ...
  available** when this model was built. Nothing in this vignette depends on
  them; see *Assumptions and deviations*.
...
S1-S2 similarity comparisons, and the repository's R source code) were not
available when this model was built. Consequences: (a) the derived covariates in
...
ranking cannot be checked from the available material.
