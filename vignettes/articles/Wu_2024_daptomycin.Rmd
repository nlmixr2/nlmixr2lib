...
* **The renal-clearance coefficient is printed three different ways.** The final
  ...
  leaves equation versus Table 2, which nothing in the available sources
  resolves: the Frontiers supplement is a model-building OFV table with no
  parameter values and no control stream, and Table 3 is too noisy to arbitrate
  (see below). The
