...
The `COADMIN_CHEMO` indicator switches per row (per time point) so
...
- **Combination-therapy effect notation.** The published equation
  ...
  with the form `(1 + theta * COADMIN_CHEMO)`, where COADMIN_CHEMO = 1
  in the combination phase. This is the form used in the model file;
  see the model file's `notes` for `COADMIN_CHEMO`.
