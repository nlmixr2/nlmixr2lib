...
- **Drug encoded as the post-surgery TTE model only.** This package extracts
  ...
  paper's online Supporting Information (Table S1), which was not on disk at
  extraction time; users who need concentration-time profiles (rather than just
  AUCinf-driven hazard) should consult the upstream popPK references
