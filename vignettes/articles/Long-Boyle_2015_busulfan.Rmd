...
* Citation: `r readModelDb("Long-Boyle_2015_busulfan") |> attr("meta") |> (\(m) m$reference)()`
* Description: `r readModelDb("Long-Boyle_2015_busulfan") |> attr("meta") |> (\(m) m$description)()`
...
`ini()` entry in `inst/modeldb/specificDrugs/Long-Boyle_2015_busulfan.R`. The
