...
* **Bile duct.** Appendix eq A5 is written on the transport-*rate* scale,
  ...
  *amount* states `bile_transit_j = Rt * R_j`, which turns eq A5 into an
  ...
  sub-compartment. The flux into the gut lumen is `bile_transit3 / rt_bile`.
  These three states are declared `paper_specific_compartments` because no
  canonical nlmixr2lib compartment family covers a biliary transit chain.
