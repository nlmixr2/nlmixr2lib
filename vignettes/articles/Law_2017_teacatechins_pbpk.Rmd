...
* **Bile duct.** Appendix eq A5 is written on the transport-*rate* scale,
  ...
  *amount* states `bile_transit_j = Rt * R_j`, which turns eq A5 into an
  ...
  canonical nlmixr2lib chain family, ratified with these models by operator
  ruling 2026-09-21 (sidecar `oasweep_PMC5464336` q1); the paired parameter
  `lmtt_bile` was ratified in the same ruling under the existing
  `lmtt_<context>` family, with the caveat recorded in
  `inst/references/parameter-names.md` that it is a **per-sub-compartment**
