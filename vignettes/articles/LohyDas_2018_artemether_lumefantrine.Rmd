...
# so a tight bound is correct here (see CLAUDE.md on when tight bounds apply).
...
# rxode2 builds. See CLAUDE.md, "Vignette assertions over a simulated cohort".
stopifnot(
  abs(med3 / 709 - 1) < 0.30,
