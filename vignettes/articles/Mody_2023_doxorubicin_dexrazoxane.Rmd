...
* **DEX inhibition equation form is subtractive on Kmax.** The PDF's
  ...
  not be recovered as machine-readable text from the PDF. Table 1 gives Imax,DEXi
...
* **Clinical DOX PK values are reproduced by Mody 2023 from Kontny
  ...
  (paper ref [30]); the Kontny 2013 paper itself was not available when
  this model was built. The 6 CL / V parameters (CL, Vc, Q2, Vp, Q3, Vp2) match
