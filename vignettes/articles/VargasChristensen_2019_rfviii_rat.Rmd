...
Table 1 of the paper; the NONMEM control stream lives in Data S1, which was not
...
cohort. The example below simulates 40 rats per dose level. Given the
package's cap on per-arm cohort sizes (200 subjects per arm), 40 rats per arm
is well within budget and reproduces the between-subject variability shown in
the paper's VPC bands qualitatively.
