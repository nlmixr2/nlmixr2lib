...
Per maintainer ruling (2026-09-02) it was **back-solved from the Figure 3 placebo
...
* **`V_glc` is not published.** Back-solved from the Figure 3 placebo median at
  **250 dL**; sensitivity across the unreported meal timings and food-intake
  ...
  circular; Figures 2, 4, 6 and 7 are not. A maintainer ruling on 2026-09-02
  chose the back-solve over author correspondence.
