...
the paper's Supplementary Materials S1 and S2, which were not available
when this model was built; the model's `population` metadata records the
...
* **Source breadth.** This extraction is paper-only. Sahota 2015's
  ...
  control stream) were not available when this model was built; finer
...
* **`target_peripheral` compartment name.** The model carries the SAP
  ...
  canonical `peripheral2`. The package's compartment register
