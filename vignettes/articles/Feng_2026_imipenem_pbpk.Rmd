...
# negative. Thirteen half-lives already leaves < 0.02% of the dose.
...
# No etas are declared, so `omega = NA` / `zeroRe()` would error and is
# unnecessary: the model is already deterministic.
sim <- rxode2::rxSolve(
  mod, events = events,
