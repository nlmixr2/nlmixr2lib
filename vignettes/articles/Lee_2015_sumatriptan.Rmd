...
* **Final published model is M6, not M5.** Lee 2015 selects "Model M6"
  ...
  **not** state the functional form (power vs linear-additive vs
  ...
  not tabulated (Table 1 lists only age, sex, weight, height). Because
  the covariate encoding is ambiguous, and per the maintainers'
  directive, M5 is the faithfully-reproducible structure from the
  available sources; downstream simulation for healthy adults with
  ...
  the maintainers confirmed that the M6 covariate form is
  unrecoverable from the available sources; this is documented for any
