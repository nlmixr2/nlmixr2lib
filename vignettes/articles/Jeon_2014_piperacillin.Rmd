...
- **DAY_AFTER_INJURY is a paper-specific covariate, NOT a registered
  ...
  convention check (`nlmixr2lib::checkModelConventions("Jeon_2014_piperacillin")`)
...
- **DIS_SEPSIS at specific scope.** Sepsis status is added to the
  ...
  `claude/frompeople-508-han_2013_antimicrobial_agents_and_chemo` branch).
  The maintainer will reconcile the scope at PR merge time.
