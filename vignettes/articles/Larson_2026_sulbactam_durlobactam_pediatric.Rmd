...
Rhodin formula in the abstract was for. That formula is not in either source,
so this vignette does not guess at it. See *Assumptions and deviations*.
...
- **The Rhodin fat-free-mass renal-maturation formula is not reproduced.** The
  ...
  using free fat mass", but neither source gives that formula or its
...
- **Age-to-weight mapping is not reproduced.** Poster Table 2 gives the
  ...
  which are not reproduced in either source. Rather than invent a
  weight-for-age table, results are
