...
* **Choice of estimation dataset for the nuisance parameters.** The 15 drugs
  ...
  directed by the maintainers. Only the background-noise, initial-condition and
  residual-error parameters are affected; the drug-specific acylation constants
  and net-influx rate are unambiguous.
* **`CELLS_INTACT` and `CONC_<CODE>_MGL` as covariates.** The assay arm and the
  ...
  intact-versus-lysed contrast is a standard target-site-penetration design
  rather than something specific to this paper.
