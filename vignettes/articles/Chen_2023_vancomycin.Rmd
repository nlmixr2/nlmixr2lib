...
- **Residual error.** Chen 2023 used a combined additive and *exponential*
  ...
  build a log-normal residual combined with an additive one -
  `Cc ~ lnorm(expSd) + add(addSd)` fails with "cannot find additive standard
  deviation for 'Cc'". The exponential arm is therefore encoded as its
