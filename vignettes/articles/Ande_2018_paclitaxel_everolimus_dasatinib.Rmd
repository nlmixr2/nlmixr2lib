...
* **Treatment-arm kill more aggressive than Figure 6B.** With the
  ...
  growth-kill balance), or (c) the modified-Simeoni equation rendered
  in the text extracted from the PDF contains an OCR
  `<!-- formula-not-decoded -->` placeholder for the denominator
  exponent stack; the packaged form follows the original Simeoni 2004
