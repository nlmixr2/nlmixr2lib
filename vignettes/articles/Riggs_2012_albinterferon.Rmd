...
* **Three convention warnings on the SVR files are deliberate**, arising from
  ...
  misleading for a probability. Registering it was offered to the operator and
  **declined**, on the grounds that a PD-output canonical is a separate concept
  that should be raised by a model that actually needs it rather than as a
...
* **The safety exposure-response is not extracted.** Riggs 2012 assessed 84
  ...
  supporting Supplementary Tables II and III are not on disk.

**Virtual cohort**

* Supplementary Table I, the baseline-demographics table, is not on disk. The
  cohort uses the ranges and proportions stated in the main-text Results (n,
