...
nca_summary <- function(res, label) {
  as.data.frame(res$result) |>
    ...
    # Select the analyte columns by NAME, not by pivot_wider's emission order:
    # PKNCA returns auclast before cmax, so relying on positional order would
    # transpose the Cmax / AUC0-24 labels in the kable below.
