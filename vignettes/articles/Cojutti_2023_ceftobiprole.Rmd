...
- **Cohort size.** The paper ran 1000 Monte Carlo simulations per scenario; the
  vignette uses 5000 per arm so that PTA values carry a Monte Carlo standard
  error of at most 0.7 percentage points. The asserted claims are those where
  the simulated PTA is clear of the 90% threshold by more than three standard
  errors.
