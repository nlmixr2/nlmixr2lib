...
predictive check and goodness-of-fit plots) are cited by the paper but were not
available from Europe PMC (PMC12965103) when this model was built. None of them
carries a final-model parameter value: every number this model encodes comes
from Table 5 of the main article, whose
...
- **Supplementary material was not available when this model was built.**
  Supplementary Tables S1-S2 and Figures S1-S2 are cited but are not available
  from Europe PMC (PMC12965103). None holds a final-model parameter value: S1 is the
