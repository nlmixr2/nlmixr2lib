...
mellitus (T2DM) animal model -- and their non-diabetic littermate controls
...
coded T2DM = 1 (ZDF/Gmi fa/fa diabetic) and one coded T2DM = 0
...
the multiplicative log-scale T2DM effects on the five rate constants
