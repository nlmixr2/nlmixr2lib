...
supplementary material, NONMEM control stream, or `.lst` listing was available
for this paper to definitively resolve the contradiction.

By maintainer decision, the packaged model follows the Table 3 definition
(FK = zero-order fraction), based on the following discriminating evidence:
...
tables above quantify this difference. Per the maintainers' instruction, the
NCA evidence is forwarded to them for a final confirmation of the FK
...
* **Inter-arm vs between-subject variability.** Wang 2018 fits PK at the
  ...
  MBMA convention, to distinguish them from between-subject
