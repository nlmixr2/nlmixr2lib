...
```{r invivo-checks}
# This model has NO etas, so it must not be passed omega = NA and needs no
# zeroRe() (pattern 9 of known-vignette-failure-patterns.md).
ev_iv <- data.frame(id = 1L, time = 0:3, evid = 0,
                    CP_RIF_UM = c(0, 0.32, 5, 1e6))
iv <- rxode2::rxSolve(uis[["invivo"]], ev_iv, omega = NA,
                      returnType = "data.frame")
