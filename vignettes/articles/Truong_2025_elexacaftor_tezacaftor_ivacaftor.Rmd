...
be reproduced from the available sources. What *is* reproducible, and is the mechanism
...
- **The adult reference percentiles are not reproducible from the available sources.**
