...
percentiles 0/392 ng/mL). Concomitant statin use (rosuvastatin < 20 mg/day,
...
body weight, 60 years age, no concomitant statin (STATIN = 0), and 72.9 ng/mL
free PCSK9.
...
patient (IIV zeroed) and the paper's STATIN-coadministration prevalence
...
- **Virtual-cohort covariate distributions.** Body weight is drawn from
  ...
  to [18, 90]; STATIN = Bernoulli(0.8) (phase III pooled prevalence);
