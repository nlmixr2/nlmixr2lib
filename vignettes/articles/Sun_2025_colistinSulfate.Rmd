...
the markdown text extraction and `pdftotext` in default mode drop them. They were
...
```{r fig3-digitised}
# Maintainer-digitised from Figure 3 panel A of Sun 2025 (1.0 MU q8h, 1 h
...
# Bounds admit the maintainers' digitisation error of ~+/- 0.05 mg/L on values of
...
- **Figure 3 panel A is maintainer-digitised.** The nine hourly-mean peaks and
