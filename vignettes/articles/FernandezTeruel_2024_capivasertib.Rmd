...
2. **The covariate and random effects on `Imax` are multiplicative on the log
   scale**, not on the fraction. Because `Imax < 0`, a multiplier above 1
   *deepens* the auto-inhibition and a multiplier below 1 shallows it. The
   negative dose slope (`Imax_dose = -0.00183`) therefore makes the inhibition
   grow with dose, which is what produces the more-than-dose-proportional
