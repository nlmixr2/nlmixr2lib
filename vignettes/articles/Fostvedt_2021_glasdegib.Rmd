...
- **Errata search.** No published erratum / corrigendum to Fostvedt 2021 was located via available channels; the published article is treated as the authoritative reference. If a correction is subsequently identified that revises any value in Table 3, this vignette and the two model files should be updated.
