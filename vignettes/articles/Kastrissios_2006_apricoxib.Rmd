...
comment naming its source location. They are collected here for review. None
of the eight equations survives naive plain-text extraction of the PDF; the
equation forms below were recovered verbatim with `pdftotext -layout`.
...
* **`SEXF` value inversion.** The paper's `Gender` indicator is 1 for male; the
  ...
  34.1 L/h the female typical value. Confirmed by the maintainers.
