...
- **Plan 2012 publication not on disk for cross-check.** The linked paper (doi:10.1038/clpt.2011.301) was not present anywhere in the maintainers' literature mirror at extraction time. Final-estimate values come solely from the DDMORE bundle's `Output_real_likert_pain_count.lst` MAXEVAL=0 echo of `Executable_likert_pain_count.mod`. The published Plan 2012 tables could not be inspected to confirm parameter signs and magnitudes; if the maintainers subsequently obtain the PDF, a follow-up audit pass is recommended.
