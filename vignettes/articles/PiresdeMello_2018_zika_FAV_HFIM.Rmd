...
* **Clinical FAV PK is approximated by Cavg, not by reproducing
  ...
  paper is not on disk in this worktree. The Figure 5 reproduction
...
* **PKNCA is not used.** This is an in vitro mechanism-based viral
  ...
  endogenous / mechanistic equivalent per the
  `endogenous-validation.md` reference. The `ncaComparisonTable()`
