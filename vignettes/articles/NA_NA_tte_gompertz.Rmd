---
title: "DDMoRe: tte gompertz"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{DDMoRe: tte gompertz}
...
AUC (ug*h/L), and first-dose Cmax (ug/L) (BAST guiding document
Section  2.2.1, Section  2.2.2). The drug, indication, and patient demographics are
...
(BAST guiding document Section  2.2.1, Table 2-1).
...
The BAST guiding document Section  2.4.1 (Figure 2-1) reports a Kaplan-Meier
...
3. Compare the simulated `sur`, `cumhaz`, `hazard` outputs against
...
* **Distribution mislabeling in the .mod $PROBLEM line.** The .mod
  ...
  document Section  2.4.1 (Figure 2-1) confirms exponential was selected for
  Event 1 by AIC. The packaged model preserves the .mod's structure
  faithfully and uses the maintainer-approved filename
