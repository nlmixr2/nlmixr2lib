...
covariances on the eta scale: (etalcl, etalcl_oc) and (etalvp,
etalvc_oc). Residual error is proportional only for OP (40.5 % CV) and
...
- **Residual-error notation.** Kamal 2013 Table 2 labels the residual
  ...
  encoded as `propSd`, `propSd_oc`, and `addSd_oc` respectively on
