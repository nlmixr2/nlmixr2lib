---
title: "Vedolizumab (Rosario 2015)"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Vedolizumab (Rosario 2015)}
...
40 years old, albumin 4 g/dL, faecal calprotectin 700 mg/kg, SCORE_CDAI 300 (for
...
make_cohort <- function(n,
  ...
  ALB     <- pmax(20, pmin(55, rnorm(n, 40, 4)))             # g/L
...
- **Disease-activity gating.** Partial Mayo score and SCORE_CDAI appear in the
  ...
  `(SCORE_CDAI/300)^(e_cdai_cl * IBD_CD)`. This reduces to 1 for the other
...
- **Virtual covariate distributions.** Exact observed covariate
  ...
  (40 ± 4 g/L, i.e. 4.0 ± 0.4 g/dL), log-normal SCORE_CALPRO (median 700 mg/kg, log-SD 1.1),
