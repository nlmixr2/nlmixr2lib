...
* **Supplement could not be downloaded during extraction.** The PMC-hosted
  ...
  proof-of-work challenge that could not be solved when this model was built, and
...
* **Residual-error mapping.** Hendriksen 2013 fits ARS and DHA plasma
  ...
  0.211` are variances on that log scale. By the package's standing
  convention, NONMEM additive-on-log-scale residual
