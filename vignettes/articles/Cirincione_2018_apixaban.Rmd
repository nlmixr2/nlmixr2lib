...
| `lgamma` (theta8), `logiti50` (theta9) | Table 3 |
...
that `Frel` is exactly 1 at the 2.5 mg dose and `1 - I50` at 50 mg, where
`I50 = expit(theta9)`.
...
i50Expected <- 1 / (1 + exp(0.322)) # expit(theta9), theta9 = -0.322
...
#   Frel(50 mg)   = 1 - expit(theta9) (what makes I50 interpretable as the
#                                      reduction at 50 mg)
stopifnot(
  abs(frelRes$frel[frelRes$dose_mg == 2.5] - 1) < 1e-10,
  abs(frelRes$frel[frelRes$dose_mg == 50] - (1 - i50Expected)) < 1e-8,
