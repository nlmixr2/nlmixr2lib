---
title: "Goel_2016_Sonidegib"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Goel_2016_Sonidegib}
...
no PPI / H2RA, no high-fat meal). Covariate distributions approximate the
...
- The model file uses canonical column names where they exist (`AGE`, `WT`,
  `SEXF`, `CRCL`, `ALB`, `RACE_JAPANESE`, `DIS_HV`, `DOSE`). Five new canonical
  covariate entries were registered alongside this model: `PPI`, `H2RA`,
  `MEAL_HFAT`, `HV_FAST`, and `MULTI_DOSE_PT` (see
