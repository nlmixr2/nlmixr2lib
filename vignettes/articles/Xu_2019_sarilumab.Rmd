---
title: "Sarilumab (Xu 2019)"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Sarilumab (Xu 2019)}
...
- **Vm / CLO/F correlation.** Table 3 reports a -0.566 correlation between the
  ...
  off-diagonal computed as *r* times `sqrt(var_vmax * var_cl)`.
...
- **SEX encoding.** Xu 2019 codes `SEX=1` for female in the final CLO/F
  ...
  was maintainer-confirmed during model extraction (see the `SEXF` entry in
...
- **SEX encoding (maintainer-confirmed).** Xu 2019 reports the SEX covariate
  ...
  the maintainers during extraction and is applied via the canonical `SEXF`
  covariate (1 = female).
