...
collects the per-parameter provenance for review; every one of the 36
parameter values matches a number printed in the paper.
...
- **BSL_EDV literature source**. The Fu 2022 Discussion attributes the 31.13 mL
  BSL_EDV value to reference 29 of the paper (not available when this model
  was built; the value is a reported literature typical for beagle
  end-diastolic volume). Fixed as stated in Table 2.
