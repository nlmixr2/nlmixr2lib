...
* The Schoemaker 2018 publication PDF was **not on disk** in the maintainers' literature mirror at extraction time, so subject counts, study counts, and demographic distributions are not populated in `population`. Update the metadata when the PDF becomes available.
