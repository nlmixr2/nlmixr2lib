...
in `inst/references/covariate-columns.md`, and minting one requires a
maintainer decision.

It is registered here as **`TUM_JAK2_V617F_VAF`** (maintainer-ratified), a
...
* **`SNP_JAK2_RS77375493`.** *JAK2* V617F does have an rsid, so this would be
  mechanically well formed under the accepted `SNP_<GENE>_RS<rsid>` naming
  family.
