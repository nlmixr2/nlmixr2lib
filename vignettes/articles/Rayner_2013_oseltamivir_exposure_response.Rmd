...
the right validation instrument for them (following
`references/endogenous-validation.md`, which replaces the NCA section for model
classes where there is no concentration-time profile to integrate). Instead
this vignette runs four checks:
