...
* **Six files, one paper.** The authors applied a consistent structural growth
  ...
  by isolate. Per the replicate-author-structure policy these are six
  independent fits, hence six files sharing this one vignette.
...
* **Erratum check.** No erratum, corrigendum or author correction is referenced
  in the lead PDF or its supplement. Web search was not available in this
  offline build; any later correction on the AAC journal page should be checked
