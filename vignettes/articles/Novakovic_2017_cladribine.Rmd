---
title: "Novakovic_2017_cladribine"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Novakovic_2017_cladribine}
...
probabilities (the
[`extract-literature-model` skill](../../.claude/skills/extract-literature-model/SKILL.md)
...
- **MINIMIZATION TERMINATED status.** The bundle's
  ...
  operator decision (sidecar response 001) was to use these values as
  the final estimates and document the convergence status here as
  informational rather than skip the task.
...
- **FREM observations as outputs rather than fit-time tricks.** The
  ...
  "observations" in the event dataset. The operator chose this scope
  over the IRT-only variant in the sidecar response.
