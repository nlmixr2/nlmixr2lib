...
- **The lognormal form of the IIV was identified, not assumed.** The paper
  ...
  own virtual patients" section above. This is a derivation from a published
...
- **Upstream development paper.** The 9-CNS model was originally developed and
  ...
  *Clin Pharmacol Ther* 2025;117(3):690-703 (reference 7). That paper was not
  available when this model was built; it is the richer source for the other
  five drugs' parameter sets, but nothing in this extraction depends on it - the
  tutorial and its supplement are self-contained for abemaciclib.
