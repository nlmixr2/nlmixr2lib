...
prediction population differ; that paper was not available on disk, so only the
two Pichardo-Almarza papers were used to characterise the cohort.
...
- **Not encoded: the arterial-wall and plaque-growth module.** The 2015
  ...
  published anywhere on disk is everything needed to close the system:
...
- **Kim et al. (2011), the originating PKPD publication, is not open access**
  and was not available on disk. Every value used here is printed in one of the
  two Pichardo-Almarza papers; nothing was taken from Kim et al. directly.
