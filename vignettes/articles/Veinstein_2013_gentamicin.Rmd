...
while a session runs. Until 2026-09-12 it was not: the model carried the gated
...
- **RRT_HEMODIAL_ACTIVE gating is a simple binary additive arm.** The packaged
  ...
  not a stylistic choice: until 2026-09-12 this model carried the gated sum in
