...
* **Supplementary Figures S1-S12 and Table S1** (Additional File 1) were not on
  disk for this extraction. They hold goodness-of-fit / VPC figures and the
  OFV / AIC / BIC / BICc model-selection statistics -- no parameter values -- so
  no `ini()` entry depends on them.
