...
| Covariate Eq. 1 (V/F)       | n/a           | Areberg 2006 Results: 'V/F = 8.0*10^2 + 12 * (WT - WT_mean)' (decoded from <formula-not-decoded> in the extracted text). |
| Covariate Eq. 2 (CL/F)      | n/a           | Areberg 2006 Results: 'CL/F = 19 - 17 * (CYP2C19 - CYP2C19_mean)' (decoded from <formula-not-decoded> in the extracted text). |
