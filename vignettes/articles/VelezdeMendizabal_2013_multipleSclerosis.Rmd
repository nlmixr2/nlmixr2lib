...
The maximum relative error across the grid is well under the mechanistic-sanity check's 5% threshold (numerical precision only); the packaged model evaluates equation 5 with the steroid switch exactly.
