...
- **PD layer not extracted.** Zandvliet 2008 is primarily a PK-PD combination
  ...
  indisulam + carboplatin combination chemotherapy. Per maintainer decision,
  only the carboplatin 2-compartment PK from Table 2 is packaged here. The
  ...
  of which was available when this model was built; that PK is fixed (not
  re-estimated) in Zandvliet 2008.
