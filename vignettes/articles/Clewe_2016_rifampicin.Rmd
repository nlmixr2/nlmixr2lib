---
title: "Clewe_2016_rifampicin"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Clewe_2016_rifampicin}
...
| `lkfslin`         | `THETA(2)` kFSLIN (/100)  | 0.1657                               | TH 2 = 1.66E-01     | kFSLIN = 1.66e-3 /day² |
...
| Residual error    | .mod `$ERROR` line 22 (`Y = IPRED + EPS(1)`; "additive on log-scale" ≡ proportional in linear space per `naming-conventions.md`) |  |  |  |
...
Initial conditions: `F(0) = F0 · exp(η_F0)`, `S(0) = S0`, `N(0) = 1e-5` (paper-specified small positive offset for numerical stability).
