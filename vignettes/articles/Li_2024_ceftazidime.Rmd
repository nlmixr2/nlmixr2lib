...
Equations 5 and 6 are typeset as stacked fractions in the published PDF and do
not survive naive plain-text extraction. They were recovered with
...
- **Equations 5 and 6 are vector-typeset.** Both are stacked fractions in the
  published PDF and do not survive naive plain-text extraction;
