...
- **Equations 5 and 6 are vector-typeset.** Both are stacked fractions in the
  published PDF and survive neither the PDF-to-markdown conversion nor a plain
  text extraction; `pdftotext -layout` recovers them intact and was the source used.
