...
- **Covariate equations are not printed by the paper.** Xie 2025 reports the
  ...
  equations, and no supplement carrying them was available when this model was
  built. The power form and the 37 IU/L / 62 kg reference values, and the
  fractional (rather than
...
- **Supplementary material not available.** Supplementary Table 1 (genotype
