...
available when this model was built, so a side-by-side comparison against
the paper's parameter table (Table 1) and PK figures (Figure 2) is out of
scope here. What is
in scope:
...
The cohort used for the self-consistency overlay below mirrors the
...
built, the validation here is a self-consistency check: the typical-value
trajectory of this
...
- **The Jonsson 2011 publication was not available when this model was built.**
  ...
  the self-consistency check against the bundle's own
