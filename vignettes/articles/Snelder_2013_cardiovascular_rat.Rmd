...
AUC over. Validation therefore follows `references/endogenous-validation.md`:
steady-state hold, the two published closed-form identities (Equations 3 and 5),
flux balance, perturbation-recovery, and reproduction of the paper's own
Figure 6 simulation.
