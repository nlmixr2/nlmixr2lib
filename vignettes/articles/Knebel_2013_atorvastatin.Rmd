...
- **Ka reparameterisation: the printed equations contradict each other, and
  ...
  absolute axis, so nothing on disk discriminates the two. Equation S2 is
  used per the standing trust-the-printed-equation policy, because it is
  the only equation printed for the run the parameters come from
  (operator ruling, sidecar `manacq_Knebel_2013_jcph_66` request-001 q1,
  option B). A user who prefers the additive reading need only change the
