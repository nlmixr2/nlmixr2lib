...
- **Endogenous lymphocyte concentration.** Methods 2.3.1 of the paper
  ...
  here because the final parameter sheet takes precedence over the Methods
  text. The final case-study simulations use
  Table S1 values.
...
- **Newly registered covariates.** `FCD8TDP` (drug-product CD8 fraction),
  ...
  ratified by the maintainers and added to
