...
* Sibling models: `modellib('Ahamadi_2017_pembrolizumab')` (exposure-response in advanced solid tumors); `modellib('ElassaissSchaap_2017_pembrolizumab')` (KEYNOTE-001 popPK with direct-response IL-2 PD).
