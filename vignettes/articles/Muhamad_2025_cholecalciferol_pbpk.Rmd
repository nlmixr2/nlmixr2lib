...
which is on disk. Baseline is therefore sampled uniformly over the 10-90 nmol/L
...
* **European cohort (Validation 5).** Baseline 25(OH)D drawn uniformly on the
  ...
  are not on disk; weights fixed at approximate WHO medians of 20 kg (6 years)
  and 35 kg (11 years), because the WHO tables are not on disk either. The
