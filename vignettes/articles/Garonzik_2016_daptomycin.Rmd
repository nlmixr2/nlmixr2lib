...
0% HS), the residual CFU_total is dominated by `bact_resistant1` + `bact_resistant2`:
...
activity (>=3.0 log10 CFU/mL reduction from inoculum, i.e., log_cfu <= 3.22)
...
- **Non-canonical compartment names** (`dap`, `bact_susceptible1`,
  ...
  `bact_resistant1`, `bact_resistant2`). The nlmixr2lib canonical compartment register
