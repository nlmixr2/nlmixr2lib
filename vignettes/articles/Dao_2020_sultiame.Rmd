...
The Dao 2020 publication itself was not on disk at the
...
package's approach for DDMORE-sourced models: an F.2 / F.3
...
- **Source publication not on disk.** The Dao 2020 paper
  ...
  doi:10.1002/prp2.558) was not available at extraction
  time; the DDMORE bundle's `Model_Accomodations.txt` describes the
  ...
  therefore out of scope. The validation here is the DDMORE F.2 / F.3
...
- **Population demographics are intentionally narrative.** The DDMORE
  ...
  and the underlying publication PDF is not on disk. The `population`
