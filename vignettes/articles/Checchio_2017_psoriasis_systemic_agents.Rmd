...
is a rasterised image. The markdown preprocessor renders all thirteen of them
as `<!-- formula-not-decoded -->`, and any extraction working from that file
alone would have no structural model at all. All thirteen were recovered with
...
Every display equation is rasterised in the published PDF. The preprocessed
markdown contains thirteen `<!-- formula-not-decoded -->` placeholders and no
mathematics at all. All thirteen equations were recovered with
