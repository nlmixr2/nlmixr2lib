...
Following the package's convention of replicating the authors' model structure, each fit is extracted as its own model file, with this single vignette walking the paper as a unit:
