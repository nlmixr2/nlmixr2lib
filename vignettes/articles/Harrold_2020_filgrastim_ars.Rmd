...
- **Cohort size: 200 per arm**, not the 1000 per arm of the
  original paper. 200 is the package's per-arm cap for validation
  vignettes and is ample to visualise the survival benefit. Monte
...
- **PKNCA validation is structural sanity-checking, not a
  ...
  validation in the separate `Melhem_2018_*` extraction. The PKNCA
  block above confirms the simulated filgrastim PK lies in the
  published 5 ug/kg s.c. exposure range; it is not a primary
  validation target of this vignette.
