...
in this model is taken from outside the available sources.
...
* **Compartment volumes come from the Figure 1 panel.** The Methods delegate
  ...
  paywalled and was not available when this model was built. The Volumes
  legend printed inside the Figure 1 panel reproduces all seven values, so no
  upstream lookup was needed.
