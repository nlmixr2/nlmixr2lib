...
1. **F.2 self-consistency**: a typical-value forward simulation with the
   ...
   observations.
2. **F.3 mechanistic-sanity checks**: T2DM versus healthy stratification
   ...
   production suppression in T2DM); steady-state hold without dosing
...
Expected qualitative pattern (per the source's `IF(T2DM.EQ.1)` switches):
