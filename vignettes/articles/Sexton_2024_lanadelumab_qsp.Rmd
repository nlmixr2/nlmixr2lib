...
gates follow the package's validation pattern for endogenous models: a
steady-state hold, a perturbation-recovery check, and a mass-balance audit. The
lanadelumab arm does have a genuine PK profile, so a PKNCA block is included
and checked against closed-form single-dose expectations.
