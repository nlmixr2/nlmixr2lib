...
(Devarakonda 2014, *Drug Des Devel Ther* 8:1125-1134), which is not on disk
here. In place of a published-NCA comparison the sections below use closed-form
identities that the model must satisfy exactly.
