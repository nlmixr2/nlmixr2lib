...
`references/endogenous-validation.md`. The Bosch 2024 model is calibrated
so the energy intake at baseline (`ei_init = RMR_init * PAL = 1.6 * RMR`)
equals total energy expenditure at PAL = 1.6.
