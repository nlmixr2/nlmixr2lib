...
- **The printed equations were recovered with `pdftotext -layout`.** Both
  display equations of Results 3.2 do not survive an ordinary plain-text
  extraction of the PDF; the layout-preserving text extraction recovers them in
  full.
