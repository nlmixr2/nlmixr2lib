...
* Print-issue year vs DOI year: Br J Clin Pharmacol assigned this
  ...
  The model file uses 2009 to match the DOI year; the full print
  citation including the 2010 issue is preserved in the `reference`
  field for unambiguous bibliographic lookup.
