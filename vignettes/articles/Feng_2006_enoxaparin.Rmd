...
- **Independent (diagonal) IIV between CL and V2.** Feng 2006 Methods
  ...
  original NONMEM control stream (not available).
...
- **Theta_NR fixed from upstream publication.** The non-renal CL
  ...
  (reference [20]); the upstream Green 2003 paper was not available. Feng
...
- **No errata identified.** A search for published corrections to the
  ...
  hits. If a future search uncovers an erratum, the affected parameter
  value(s) should be updated and the in-file source-trace comments
  should point to the erratum.
