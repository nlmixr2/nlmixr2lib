...
* **PK only, downstream PD models out of scope.** The paper develops four
  ...
  popPK/PD format and would each need to be built as a separate model;
  only the upstream FIGARO-DKD PK model is packaged here.
* **FIGARO-DKD only, FIDELIO-DKD upstream not packaged.** The paper
  ...
  not in the supplement, only the FIGARO-DKD code. Packaging the
