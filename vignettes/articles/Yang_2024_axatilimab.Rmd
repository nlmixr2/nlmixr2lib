---
title: "Axatilimab semimechanistic PK/PD model (Yang 2024)"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Axatilimab semimechanistic PK/PD model (Yang 2024)}
...
* Citation: `r readModelDb("Yang_2024_axatilimab")() |> (\(x) x$meta$reference)()`
...
```{r figure-4a-pk, fig.width = 7, fig.height = 3.5}
...
```{r figure-4b-ncmc, fig.width = 7, fig.height = 3.5}
...
```{r figure-4c-csf1, fig.width = 7, fig.height = 3.5}
...
```{r figure-5-sim, fig.width = 6.5, fig.height = 3.6}
