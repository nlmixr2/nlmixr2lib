...
No published erratum was located for Duong 2017 (CrossRef `update-to` / `updated-by` fields empty). The Duong 2017 online supplement was not available when this model was built; if a corrigendum is published in the future the model file's parameter values and the residual-error IIV assumption should be re-verified against the corrected supplement.
