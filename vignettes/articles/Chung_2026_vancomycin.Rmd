...
* Upstream model-development paper: <https://doi.org/10.1002/phar.2865> (subscription-only; not available when this model was built -- see Assumptions and deviations)
...
# rxode2's ODE-to-linCmt() conversion would meet it analytically; the ODE as
...
* **The upstream paper was not available.** Chung E, Seto W, *Pharmacotherapy*
  ...
  returns HTTP 403 to automated retrieval, so it was not available when this
  model was built; when it is, the IIV and residual error should be added to
  this model file.
* **The Chung 2026 supplement was not available.** Supplementary Table S2
