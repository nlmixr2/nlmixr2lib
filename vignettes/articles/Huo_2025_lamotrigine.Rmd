...
#    The profiles are integrated numerically, so the solver runs at tight
#    tolerances here: at the default rtol of 1e-6 the ratio carries ~6e-6 of
#    integration error, which is above the 1e-6 identity bound.
