...
The publisher PDF renders the four model equations as images, so the text
extracted from the PDF shows them only as `formula-not-decoded`. They were
recovered with `pdftotext -layout`:
