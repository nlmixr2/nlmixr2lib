...
dose in **mg**, but never states the molar mass, and no available supplement
...
* **Concentration units.** Sunnaker 2026 reports concentrations in nmol/L and
  doses in mg but never states mitiperstat's molar mass, and no available
  supplement supplies it. The model is encoded in self-consistent mass units (mg dose
