...
* `kel` elimination rate (`cl/v`)
* `k12`, `k21`, `k13`, `k31`: intercompartmental transit rates (`q/v`, `q/vp`,
  `q2/v`, and  `q2/vp2`, respectively)
...
* The first line of the file should be a comment with the word "Description", a
  colon, and a description of the model (for example,
