...
| `cl_time_max` (EMAX_REF, log-fold) | -0.410 | Yang 2021 Table 3, Emax |
| `lcl_t50` (T50_REF, days) | log(28.9) | Yang 2021 Table 3, T50 |
| `cl_time_hill` (HILL, unitless) | 2.79 | Yang 2021 Table 3, HILL |
...
| `etacl_time_max` | 0.228 | Yang 2021 Table 3, IIV_Emax |
| `etalcl_t50` | 0.610 | Yang 2021 Table 3, IIV_T50 |
...
#> ℹ omega/sigma items treated as zero: 'etalcl', 'etalvc', 'etacl_time_max', 'etalcl_t50'
