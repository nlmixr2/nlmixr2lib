...
#>               0          112 SAD_140mg 200         138 [92.2] 9.70 [45.9]
#>               0          112 SAD_420mg 200         734 [84.5] 33.3 [50.4]
#>               0          112  SAD_70mg 200         61.2 [108] 4.61 [50.6]
#>          Tmax (day) Half-life (day)
#>   4.00 [1.00, 10.0]     15.2 [18.1]
#>   5.00 [1.00, 16.0]     20.4 [44.5]
#>  3.00 [0.500, 10.0]     16.3 [20.4]
#> 
...
summary(nca_q4w)
#>  Interval Start Interval End  treatment   N AUClast (day*mg/L) Cmax (mg/L)
#>               0           28 MAD_140Q4W 200         149 [95.7] 11.7 [52.6]
#>         Tmax (day)
#>  4.00 [1.00, 8.00]
#> 
