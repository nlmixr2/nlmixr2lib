...
ambiguities below was resolved by a maintainer-approved best-effort
choice on 2026-07-24, made with caveats after three earlier attempts to
obtain the missing supplement were unsuccessful. All three are listed
here so that a downstream user knows what is well-founded and what is a
coin toss.
