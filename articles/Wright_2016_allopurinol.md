...
Cohort size is kept at the package’s cap of 200 subjects per arm
...
# its Figure 3 simulation; we use the package's 200/arm cohort cap.
N_PER_ARM <- 200L
...
# Assertion: ids disjoint and (id, time, evid) unique.
