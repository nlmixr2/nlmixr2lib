...
so the comparison values below were **digitised by the operator from the
published figures** (page 8 Figure 4 and page 9 Figure 5 of the PDF,
...
- The reference values in `fig4a_obs`, `fig4b_obs` and `fig5_peaks` were
  **digitised by the operator** from Wang 2023 Figures 4 and 5 (page 8
  and page 9 of the PDF, rendered at 300-400 dpi and read against the
