...
- **Supplementary material.** Figure S1 (literature-search flow
  ...
  MDPI and were not available when this model was built. None of them
  contain final parameter values: the complete final model is given by
  Table 3 and Eqs. 8-11 in the main text, both of which were available.
