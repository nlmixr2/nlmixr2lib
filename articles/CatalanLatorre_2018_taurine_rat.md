...
`population` metadata
(`readModelDb("CatalanLatorre_2018_taurine_rat")$population`).

## Source trace

Per-parameter origin is recorded as an in-file comment next to each
`ini()` entry in
`inst/modeldb/specificDrugs/CatalanLatorre_2018_taurine_rat.R`. The
...
mod <- readModelDb("CatalanLatorre_2018_taurine_rat")
...
![](CatalanLatorre_2018_taurine_rat_files/figure-html/figure-1-iv-1.png)
...
![](CatalanLatorre_2018_taurine_rat_files/figure-html/figure-1-po-1.png)
...
![](CatalanLatorre_2018_taurine_rat_files/figure-html/malnutrition-100mg-iv-1.png)
...
![](CatalanLatorre_2018_taurine_rat_files/figure-html/virtual-cohort-1.png)
