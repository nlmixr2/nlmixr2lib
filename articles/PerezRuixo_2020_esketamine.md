...
this finding was the principal reason the maintainers flagged this
discrepancy when the model was built. Three reconciliation attempts were
tried during this extraction; all reproduce the Table 4 AUC0-24 only by
trading off the Cmax match.
