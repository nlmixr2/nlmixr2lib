# Bevacizumab pk (Papachristos 2020)
...
| `lvc` (V1pop, L) | log(3.09) | Papachristos 2020 Table 1, V1pop |
| `lq` (Qpop, L/day) | log(0.35) | Papachristos 2020 Table 1, Qpop |
| `lvp` (V2pop, L) | log(2.39) | Papachristos 2020 Table 1, V2pop |
| `e_wt_cl` (allometric exponent) | 1.04 | Papachristos 2020 Table 1, “log(weight/70) on CL” |
...
| `etalvc` variance | 0.03028 | Papachristos 2020 Table 1, ω_V1 = 0.174 |
| `etalvp` variance | 0.45698 | Papachristos 2020 Table 1, ω_V2 = 0.676 |
...
#> ℹ omega/sigma items treated as zero: 'etalcl', 'etalq', 'etalvc', 'etalvp'
