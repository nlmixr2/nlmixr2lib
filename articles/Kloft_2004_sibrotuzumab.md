...
re-fitted set of final estimates. The original Kloft 2004 publication
...
the shape of the per-subject DV cloud shipped in the bundle’s
...
- **The Kloft 2004 publication was not available when this model was
  ...
  published parameter table or NCA summary is not part of this vignette.
  The validation here is restricted to the self-consistency check
