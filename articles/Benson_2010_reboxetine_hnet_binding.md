...
# Keep 1 - B/Beq >= 1e-6 of its maximum (1 at t = 0): below that the ODE integrator has no relative accuracy left.
fitdat  <- dplyr::filter(sim_assoc, time > 0, time < 0.4, 1 - complex / eq_val >= 1e-6)
