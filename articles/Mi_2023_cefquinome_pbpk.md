...
#> [lsoda -- internal t + h = t (h too small for machine precision)]: 999818 warning(s) for subject(s): 197
#> Warning: 'ii' requires non zero additional doses ('addl') or steady state
#> dosing ('ii': 24.000000, 'ss': 0; 'addl': 0), reset 'ii' to zero
#> Warning: 'ii' requires non zero additional doses ('addl') or steady state
#> dosing ('ii': 24.000000, 'ss': 0; 'addl': 0), reset 'ii' to zero
...
| 3 mg/kg twice daily        | Kidney | 0.2 | 1.298 \* | 0.386 \* | 0.116 | 0.035 |
| 3 mg/kg twice daily        | Liver  | 0.1 | 0.620 \* | 0.181 \* | 0.055 | 0.016 |
| 5 mg/kg twice daily        | Kidney | 0.2 | 1.717 \* | 0.514 \* | 0.155 | 0.047 |
| 5 mg/kg twice daily        | Liver  | 0.1 | 0.965 \* | 0.285 \* | 0.086 | 0.026 |
...
| 4 mg/kg q24h | PELF, MIC 0.25 | 28.1 / 37.5 / 50.0 | 22.0 / 27.3 / 34.1 | 1.37 |
| 4 mg/kg q24h | PELF, MIC 1 | 16.7 / 21.9 / 29.4 | 14.2 / 18.5 / 23.7 | 1.18 |
