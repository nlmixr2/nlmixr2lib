...
#>       for precision of machine..  See TOLSF (=R2) 
#> IDID=-2, excess accuracy requested (tolerances too small).
#> [lsoda -- internal t + h = t (h too small for machine precision)]: 1999857 warning(s) for subject(s): 169, 176
#> Warning: 'ii' requires non zero additional doses ('addl') or steady state
#> dosing ('ii': 24.000000, 'ss': 0; 'addl': 0), reset 'ii' to zero
#> Warning: 'ii' requires non zero additional doses ('addl') or steady state
#> dosing ('ii': 24.000000, 'ss': 0; 'addl': 0), reset 'ii' to zero
...
#> [lsoda -- internal t + h = t (h too small for machine precision)]: 1993317 warning(s) for subject(s): 71, 169
#> IDID=-2, larger nmax is needed
#> [exit of dop853 at x = 1.0000000000000000e+00, more than nmax = 0 are needed]: 1 warning(s) for subject(s): 15
#> DINTDY-  T (=R1) illegal      
#>       T not in interval TCUR - HU (= R1) to TCUR (=R2)      
#> DINTDY-  T (=R1) illegal      
#>       T not in interval TCUR - HU (= R1) to TCUR (=R2)      
...
| 2 mg/kg q12h | PELF, MIC 1 | 20.8 / 31.2 / 41.7 | 18.6 / 27.1 / 35.7 | 1.15 |
...
| 4 mg/kg q12h | PELF, MIC 1 | 31.2 / 44.8 / 62.7 | 28.4 / 37.6 / 47.8 | 1.19 |
| 4 mg/kg q12h | Plasma, MIC 0.25 | 47.9 / 72.9 / 96.0 | 39.1 / 49.9 / 63.1 | 1.46 |
| 4 mg/kg q12h | Plasma, MIC 1 | 27.1 / 39.6 / 52.1 | 23.2 / 29.7 / 37.3 | 1.33 |
...
| 3 mg/kg q24h | PELF, MIC 0.25 | 22.9 / 33.3 / 43.9 | 20.2 / 25.2 / 32.0 | 1.32 |
| 3 mg/kg q24h | PELF, MIC 1 | 12.5 / 19.3 / 25.1 | 12.5 / 16.6 / 21.6 | 1.16 |
| 3 mg/kg q24h | Plasma, MIC 0.25 | 20.8 / 29.2 / 39.6 | 17.5 / 22.3 / 28.3 | 1.31 |
| 3 mg/kg q24h | Plasma, MIC 1 | 11.5 / 15.6 / 21.9 | 10.1 / 12.8 / 16.2 | 1.22 |
| 4 mg/kg q24h | PELF, MIC 0.25 | 26.0 / 37.5 / 51.1 | 22.0 / 27.3 / 34.1 | 1.37 |
| 4 mg/kg q24h | PELF, MIC 1 | 15.6 / 21.9 / 30.2 | 14.2 / 18.5 / 23.7 | 1.18 |
| 4 mg/kg q24h | Plasma, MIC 0.25 | 24.9 / 33.3 / 45.9 | 19.3 / 24.4 / 31.2 | 1.37 |
| 4 mg/kg q24h | Plasma, MIC 1 | 14.6 / 18.8 / 25.1 | 11.5 / 14.5 / 18.2 | 1.29 |
