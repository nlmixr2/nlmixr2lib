...
#> DLSODA-  Trouble in DINTDY.  ITASK = I1, TOUT = R1
#> IDID=-3, illegal input detected (see printed message).
#> [lsoda -- internal t + h = t (h too small for machine precision)]: 1995873 warning(s) for subject(s): 176, 190
#> Warning: 'ii' requires non zero additional doses ('addl') or steady state
#> dosing ('ii': 24.000000, 'ss': 0; 'addl': 0), reset 'ii' to zero
#> Warning: 'ii' requires non zero additional doses ('addl') or steady state
#> dosing ('ii': 24.000000, 'ss': 0; 'addl': 0), reset 'ii' to zero
...
#>       for precision of machine..  See TOLSF (=R2) 
#> IDID=-2, excess accuracy requested (tolerances too small).
#> [lsoda -- internal t + h = t (h too small for machine precision)]: 996150 warning(s) for subject(s): 148
...
| 3 mg/kg q24h | PELF, MIC 1 | 12.5 / 19.8 / 26.0 | 12.5 / 16.6 / 21.6 | 1.19 |
...
| 4 mg/kg q24h | PELF, MIC 0.25 | 26.0 / 37.5 / 50.0 | 22.0 / 27.3 / 34.1 | 1.37 |
| 4 mg/kg q24h | PELF, MIC 1 | 16.6 / 21.9 / 29.3 | 14.2 / 18.5 / 23.7 | 1.18 |
| 4 mg/kg q24h | Plasma, MIC 0.25 | 24.0 / 33.3 / 44.9 | 19.3 / 24.4 / 31.2 | 1.37 |
