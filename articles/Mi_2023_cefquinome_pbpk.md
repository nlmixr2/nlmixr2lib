...
#>       or with ABS(H) = HMIN   
#> IDID=-5, repeated convergence failures (perhaps bad jacobian supplied or wrong choice of jt or tolerances).
#> [lsoda -- internal t + h = t (h too small for machine precision)]: 999834 warning(s) for subject(s): 190
#> Warning: 'ii' requires non zero additional doses ('addl') or steady state
#> dosing ('ii': 24.000000, 'ss': 0; 'addl': 0), reset 'ii' to zero
#> Warning: 'ii' requires non zero additional doses ('addl') or steady state
#> dosing ('ii': 24.000000, 'ss': 0; 'addl': 0), reset 'ii' to zero
...
#>       for precision of machine..  See TOLSF (=R2) 
#> IDID=-2, excess accuracy requested (tolerances too small).
#> [lsoda -- internal t + h = t (h too small for machine precision)]: 1999777 warning(s) for subject(s): 36, 64
...
#>       for precision of machine..  See TOLSF (=R2) 
#> IDID=-2, excess accuracy requested (tolerances too small).
#> [lsoda -- internal t + h = t (h too small for machine precision)]: 996952 warning(s) for subject(s): 29
```
...
| 4 mg/kg q12h | PELF, MIC 1 | 32.7 / 43.8 / 62.5 | 28.4 / 37.6 / 47.8 | 1.16 |
| 4 mg/kg q12h | Plasma, MIC 0.25 | 47.9 / 72.9 / 95.8 | 39.1 / 49.9 / 63.1 | 1.46 |
| 4 mg/kg q12h | Plasma, MIC 1 | 27.1 / 39.6 / 50.6 | 23.2 / 29.7 / 37.3 | 1.33 |
