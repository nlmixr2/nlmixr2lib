...
#>       for precision of machine..  See TOLSF (=R2) 
#> IDID=-2, excess accuracy requested (tolerances too small).
#> [lsoda -- internal t + h = t (h too small for machine precision)]: 999892 warning(s) for subject(s): 190
...
#>       for precision of machine..  See TOLSF (=R2) 
#> IDID=-2, excess accuracy requested (tolerances too small).
#> [lsoda -- internal t + h = t (h too small for machine precision)]: 999548 warning(s) for subject(s): 92
#> IDID=-3, step size becomes too small
#> IDID=-3, step size becomes too small
#> IDID=-3, step size becomes too small
#> IDID=-3, step size becomes too small
...
#>       for precision of machine..  See TOLSF (=R2) 
#> IDID=-2, excess accuracy requested (tolerances too small).
#> [lsoda -- internal t + h = t (h too small for machine precision)]: 999895 warning(s) for subject(s): 57
```
...
| 3 mg/kg q12h | PELF, MIC 0.25 | 47.9 / 67.7 / 95.8 | 40.6 / 51.2 / 64.6 | 1.32 |
| 3 mg/kg q12h | PELF, MIC 1 | 27.1 / 38.5 / 54.2 | 24.8 / 33.6 / 43.3 | 1.15 |
