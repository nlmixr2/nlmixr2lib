...
- **Drug identity.** The source PDF is unambiguously the Feng 2008
  risperidone popPK paper; filenames, function name, and vignette
  basename use the drug `risperidone`.
