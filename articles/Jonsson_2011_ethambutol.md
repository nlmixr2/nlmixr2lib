...
- Description: Two-compartment population PK model for oral ethambutol
  ...
  allometric scaling on clearance and volume terms (theory-based
  exponents on a 50 kg reference), an HIV-status effect on
  bioavailability, and 4-occasion inter-occasion variability on apparent
  oral clearance.
...
`Executable_run32150.mod` (lines 1-3, citing Jönsson et al., AAC 2011,
...
`ini()` entry of `inst/modeldb/ddmore/Jonsson_2011_ethambutol.R`):
...
![](Jonsson_2011_ethambutol_files/figure-html/bundle-overlay-1.png)
