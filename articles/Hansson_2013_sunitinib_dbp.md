# Sunitinib diastolic blood pressure (Hansson 2013)
...
- Indirect-response form adapted from Keizer RJ et al. *J Pharmacokinet
  Pharmacodyn* 2010;37(4):347-363,
  [doi:10.1007/s10928-010-9163-3](https://doi.org/10.1007/s10928-010-9163-3).

This vignette extracts the **diastolic blood pressure (dBP)** sub-model
from the Hansson 2013 e85 framework.
...
note that the actual time of day for blood-pressure measurements was not
available; all observations were assumed to occur in the morning.

`readModelDb("Hansson_2013_sunitinib_dbp")$population` returns the same
...
treated with 50 mg sunitinib receiving a 4/2 schedule.’ The
...
![](Hansson_2013_sunitinib_dbp_files/figure-html/f3-typical-1.png)
...
![](Hansson_2013_sunitinib_dbp_files/figure-html/placebo-1.png)
