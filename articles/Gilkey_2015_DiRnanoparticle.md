...
- Supplement (Table S1, paper-reported simulated-vs-experimental Cmax
  ...
  website and was not available when this model was built. The main
  paper text reports the same Cmax / Tmax values in narrative form.
...
- **Numerical-divergence sensitivity at `ro + 20%`.** The paper reports
  ...
  window accordingly.
- **Supplementary Table S1 not available.** The paper references
