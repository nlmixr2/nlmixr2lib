...
`readModelDb("BuilBruna_2015_lanreotide")$population`.

### Source trace

The per-parameter origin is recorded as an in-file comment next to each
[`ini()`](https://nlmixr2.github.io/rxode2/reference/ini.html) entry in
`inst/modeldb/specificDrugs/BuilBruna_2015_lanreotide.R`. The table
...
mod_typical <- rxode2::zeroRe(readModelDb("BuilBruna_2015_lanreotide"))
...
mod <- readModelDb("BuilBruna_2015_lanreotide")
...
![](BuilBruna_2015_lanreotide_files/figure-html/figure-4-1.png)
...
![](BuilBruna_2015_lanreotide_files/figure-html/typical-zoom-1.png)
