...
- **Supporting Information acquisition.** The Supporting Information was
  not supplied with the source metadata and was retrieved from the
  Europe PMC supplementary files endpoint for PMC12909276. It comprises
  `Supinfo1` (the NONMEM analysis dataset), `Supinfo2` (the control
  stream discussed above) and `Supinfo3` (Tables S1 to S8 and Figures S1
  to S3).
