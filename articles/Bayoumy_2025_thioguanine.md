...
- **Table 2’s `BSV` column disagrees with ESM 1 about which parameter
  ...
  own solved `cl` and `vc`. This reading was **reviewed and ratified by
  the maintainers**: the control stream is the executable artefact the
  fit actually ran, whereas the printed Table 2 is a transcription of
  it, and transcription is where row-swaps occur.
