...
#> ℹ omega/sigma items treated as zero: 'etalcl', 'etalvc', 'etalq', 'etalvp', 'etalq2', 'etalvp2', 'etalcl_mmae', 'etalvc_mmae', 'etalbeta', 'etalfm'
```
...
paper’s ~13% steady-state derivation. {.table}
...
#> Requesting an AUC range starting (0) before the first measurement (0.05) is not allowed
#> Requesting an AUC range starting (0) before the first measurement (0.05) is not allowed
#> Warning: Requesting an AUC range starting (0) before the first measurement (0.145477) is not allowed
#> Requesting an AUC range starting (0) before the first measurement (0.145477) is not allowed
#> Requesting an AUC range starting (0) before the first measurement (0.145477) is not allowed
#> Requesting an AUC range starting (0) before the first measurement (0.145477) is not allowed
#> Requesting an AUC range starting (0) before the first measurement (0.145477) is not allowed
#> Requesting an AUC range starting (0) before the first measurement (0.145477) is not allowed
...
#> Requesting an AUC range starting (0) before the first measurement (0.145477) is not allowed
#> Requesting an AUC range starting (0) before the first measurement (0.145477) is not allowed
#> Warning: Requesting an AUC range starting (0) before the first measurement (0.240955) is not allowed
#> Requesting an AUC range starting (0) before the first measurement (0.240955) is not allowed
#> Requesting an AUC range starting (0) before the first measurement (0.240955) is not allowed
#> Requesting an AUC range starting (0) before the first measurement (0.240955) is not allowed
#> Requesting an AUC range starting (0) before the first measurement (0.240955) is not allowed
#> Requesting an AUC range starting (0) before the first measurement (0.240955) is not allowed
...
#> Requesting an AUC range starting (0) before the first measurement (0.240955) is not allowed
#> Requesting an AUC range starting (0) before the first measurement (0.240955) is not allowed
#> Warning: Requesting an AUC range starting (0) before the first measurement (0.336432) is not allowed
#> Requesting an AUC range starting (0) before the first measurement (0.336432) is not allowed
#> Requesting an AUC range starting (0) before the first measurement (0.336432) is not allowed
#> Requesting an AUC range starting (0) before the first measurement (0.336432) is not allowed
#> Requesting an AUC range starting (0) before the first measurement (0.336432) is not allowed
#> Requesting an AUC range starting (0) before the first measurement (0.336432) is not allowed
...
#> Requesting an AUC range starting (0) before the first measurement (0.336432) is not allowed
#> Requesting an AUC range starting (0) before the first measurement (0.336432) is not allowed
#> Warning: Requesting an AUC range starting (0) before the first measurement (0.43191) is not allowed
#> Requesting an AUC range starting (0) before the first measurement (0.43191) is not allowed
#> Requesting an AUC range starting (0) before the first measurement (0.43191) is not allowed
#> Requesting an AUC range starting (0) before the first measurement (0.43191) is not allowed
#> Requesting an AUC range starting (0) before the first measurement (0.43191) is not allowed
#> Requesting an AUC range starting (0) before the first measurement (0.43191) is not allowed
...
#>      0  21     1 100      NC 31.4 [17.9] 0.0500 [0.0500, 0.0500]
#>      0  21     2 100      NC 28.6 [17.0]    0.145 [0.145, 0.145]
#>      0  21     3 100      NC 25.9 [16.8]    0.241 [0.241, 0.241]
#>      0  21     4 100      NC 23.4 [17.1]    0.336 [0.336, 0.336]
#>      0  21     5 100      NC 21.3 [17.9]    0.432 [0.432, 0.432]
#> 
...
mmae_nca_summary
#>  start end cycle   N auclast        cmax               tmax
#>      0  21     1 100      NC 5.15 [57.7] 1.63 [0.577, 4.27]
#>      0  21     2 100      NC 4.75 [57.3] 1.20 [0.673, 3.84]
#>      0  21     3 100      NC 4.32 [60.7] 1.30 [0.768, 3.93]
#>      0  21     4 100      NC 4.05 [64.1] 1.39 [0.336, 4.03]
#>      0  21     5 100      NC 3.85 [67.2] 1.49 [0.432, 4.12]
#> 
#> Caption: auclast, cmax: geometric mean and geometric coefficient of variation; tmax: median and range; N: number of subjects
```
...
proteolytic MMAE formation in successive cycles. {.table}
...
- **Molar units throughout the ODE.** Modeling is in nmol amounts, L
  ...
  the ODE.
- **Compartment naming.** The seven ODE states are `central`,
  `peripheral1`, `peripheral2`, `central_mmae`, `peripheral1_mmae`,
  `pathway_proteolytic`, and `pathway_deconjugation`. Parent (ADC)
  compartments use the canonical names; MMAE compartments use the
  canonical metabolite-suffix convention (`central_mmae`,
  `peripheral1_mmae`). The two `pathway_*` integrators are bookkeeping
  compartments retained for the supplement’s “~13% deconjugation at
  steady state” derivation;
  [`checkModelConventions()`](https://nlmixr2.github.io/nlmixr2lib/reference/checkModelConventions.md)
  flags those because they are not in the canonical compartment list.
...
- **Deconjugation-flux sign convention.** Supplement M1 writes the MMAE
  ...
  into `central_mmae` is always into the compartment (never out). The
