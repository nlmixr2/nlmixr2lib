...
`readModelDb("LlanosPaez_2017_gentamicin")()$population`.

## Source trace

The per-parameter origin is recorded inline next to each `ini()` entry
in `inst/modeldb/specificDrugs/LlanosPaez_2017_gentamicin.R`. The table
...
mod <- readModelDb("LlanosPaez_2017_gentamicin")()
...
![](LlanosPaez_2017_gentamicin_files/figure-html/figure-5d-1.png)
...
![](LlanosPaez_2017_gentamicin_files/figure-html/figure-5a-1.png)
