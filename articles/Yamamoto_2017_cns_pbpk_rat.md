...
- **Equations 1 and 2 are not re-derived.** The molecular-weight and
  ...
  references 16 and 17, which were not available when this model was
  built. The tabulated per-drug values of Table 4 are encoded directly
  instead. (They are self-consistent: evaluating
