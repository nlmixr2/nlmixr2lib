...
| `lcl_t50` | `log(23.8 * 28)` = `log(666.4)` days | Gupta 2006 Table 3 (theta_T50 in 28-day units) |
...
| `etalcl_t50` IIV | `0.7833` (CV 109%) | Gupta 2006 Table 3 (omega(CV) T50) -\> `omega^2 = log(1.09^2 + 1)` |
...
typical_cl <- function(t_days, cl0 = 44.1, cl_t50 = 666.4) cl0 / (1 + t_days / cl_t50)
