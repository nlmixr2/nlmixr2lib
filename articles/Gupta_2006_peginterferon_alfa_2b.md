...
| `lcl_hill_t50` | `log(23.8 * 28)` = `log(666.4)` days | Gupta 2006 Table 3 (theta_T50 in 28-day units) |
...
| `etalcl_hill_t50` IIV | `0.7833` (CV 109%) | Gupta 2006 Table 3 (omega(CV) T50) -\> `omega^2 = log(1.09^2 + 1)` |
...
typical_cl <- function(t_days, cl0 = 44.1, cl_hill_t50 = 666.4) cl0 / (1 + t_days / cl_hill_t50)
