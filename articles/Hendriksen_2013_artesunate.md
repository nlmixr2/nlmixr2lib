...
| `lcl_dha` -\> CL/F DHA = 22.4 L/h | 22.4 | Table 2 (%RSE 8.40) |
| `lvc_dha` -\> V/F DHA = 13.5 L | 13.5 | Table 2 (%RSE 9.69) |
...
| `e_hgb_cl_dha` -\> -10.2% on DHA CL per g/dL increase in HGB | -0.102 | Table 2 (“Negative effect of hemoglobin on CL/F DHA (%) 10.2”, %RSE 14.9); Results p.445 (“DHA clearance increased 10.2% per unit (g/dl) of decrease of hemoglobin”) |
...
| IIV `var(etalcl_dha)` | 0.306 | Table 2 (eta CL/F DHA, %RSE 37.9) |
...
| Residual `propSd_dha` | sqrt(0.211) = 0.459 | Table 2 (sigma DHA = 0.211 variance on log scale, %RSE 12.5) |
...
#> ℹ omega/sigma items treated as zero: 'etalcl', 'etalvc', 'etalcl_dha'
...
#> Warning in assert_conc(conc, any_missing_conc = any_missing_conc): Negative
#> concentrations found
#> Warning in assert_conc(conc, any_missing_conc = any_missing_conc): Requesting
#> an AUC range starting (0) before the first measurement (0.001) is not allowed
#> Warning in assert_conc(conc = conc): Negative concentrations found
#> Warning in assert_conc(conc, any_missing_conc = any_missing_conc): Negative
#> concentrations found
#> Warning in assert_conc(conc, any_missing_conc = any_missing_conc): Negative
...
|---:|---:|:---|:---|:---|:---|:---|:---|
| 0 | 12 | 6-7 | 60 | NC | 960 \[90.2\] | 0.0210 \[0.0160, 0.0210\] | 0.498 \[0.436\], n=59 |
| 0 | 12 | 8-9 | 60 | NC | 777 \[92.6\] | 0.0210 \[0.0210, 0.0210\] | 0.599 \[0.622\] |
| 0 | 12 | 10-11 | 60 | NC | 841 \[79.7\] | 0.0210 \[0.0210, 0.0210\] | 0.554 \[0.423\] |
| 0 | 12 | 12-13 | 60 | NC | 793 \[99.4\] | 0.0210 \[0.0210, 0.0210\] | 0.640 \[0.558\] |
| 0 | 12 | 14-16 | 60 | NC | 992 \[97.1\] | 0.0210 \[0.0210, 0.0210\] | 0.593 \[0.548\] |
| 0 | 12 | 17-20 | 60 | NC | 822 \[121\] | 0.0210 \[0.0210, 0.0210\] | 0.639 \[0.477\] |
| 0 | 12 | 21-25 | 60 | NC | 943 \[103\] | 0.0210 \[0.0210, 0.0210\] | 0.680 \[0.477\] |
...
sim_nca_dha <- sim |>
  ...
  dplyr::select(id, time, Cc_dha = Cc_dha_ng_per_mL, band)
...
| Interval Start | Interval End | band | N | AUClast (h\*ng/mL) | Cmax (ng/mL) | Tmax (h) | Half-life (h) |
|---:|---:|:---|:---|:---|:---|:---|:---|
| 0 | 12 | 6-7 | 60 | NC | 519 \[62.7\] | 0.525 \[0.160, 1.45\] | 0.695 \[0.431\] |
| 0 | 12 | 8-9 | 60 | NC | 492 \[52.8\] | 0.550 \[0.260, 1.95\] | 0.778 \[0.616\] |
| 0 | 12 | 10-11 | 60 | NC | 484 \[51.6\] | 0.550 \[0.220, 1.65\] | 0.723 \[0.427\] |
| 0 | 12 | 12-13 | 60 | NC | 472 \[52.6\] | 0.650 \[0.180, 1.95\] | 0.811 \[0.534\] |
| 0 | 12 | 14-16 | 60 | NC | 507 \[56.6\] | 0.600 \[0.240, 1.65\] | 0.827 \[0.516\] |
| 0 | 12 | 17-20 | 60 | NC | 501 \[52.7\] | 0.650 \[0.280, 2.15\] | 0.896 \[0.516\] |
| 0 | 12 | 21-25 | 60 | NC | 481 \[49.8\] | 0.750 \[0.220, 1.55\] | 0.911 \[0.521\] |
...
- **Unit choice.** The packaged model carries dose in mg, volume in L,
  ...
  (`mw_dha / mw_ars = 284.35 / 384.42 = 0.7397`) at the
  metabolite-formation step. Multiplying `Cc` and `Cc_dha` by 1000 gives
  ng/mL, which is what Hendriksen 2013 Table 2 reports for Cmax and AUC.
