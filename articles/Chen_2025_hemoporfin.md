...
**Observation-variable naming.** The five ER models use
`prob_<endpoint>` as the observation variable rather than `Cc`. `Cc` is
...
itself a canonical observation form (operator ruling 2026-09-11,
