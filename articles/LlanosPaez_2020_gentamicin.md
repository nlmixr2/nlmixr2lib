...
mod_meta <- nlmixr2est::nlmixr(readModelDb("LlanosPaez_2020_gentamicin"))$meta
...
This vignette validates the packaged `LlanosPaez_2020_gentamicin` model
...
mod         <- readModelDb("LlanosPaez_2020_gentamicin")
...
![](LlanosPaez_2020_gentamicin_files/figure-html/figure-2-1.png)
