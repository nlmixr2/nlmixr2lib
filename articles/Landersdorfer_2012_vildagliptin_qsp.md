...
Per operator ruling (2026-09-02) it was **back-solved from the Figure 3
placebo panel**: the published median curve was digitised and `V_glc`
...
- **`V_glc` is not published.** Back-solved from the Figure 3 placebo
  ...
  is therefore partly circular; Figures 2, 4, 6 and 7 are not. Operator
  ruling 2026-09-02 chose the back-solve over author correspondence.
