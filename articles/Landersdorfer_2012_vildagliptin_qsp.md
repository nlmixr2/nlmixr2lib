...
By maintainer decision it was **back-solved from the Figure 3 placebo
panel**: the published median curve was digitised and `V_glc` fitted to
it, giving **250 dL (25.0 L)**. Ninety-six combinations of the
...
- **`V_glc` is not published.** Back-solved from the Figure 3 placebo
  ...
  is therefore partly circular; Figures 2, 4, 6 and 7 are not. The
  maintainers chose the back-solve over author correspondence.
