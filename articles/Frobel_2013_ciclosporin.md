...
### Check 1 - typical-value hazard transitions match Table 3 exactly

Shown above in the Figure 1 cross-check.

### Check 2 - cumulative hazard is the time-integral of the piecewise hazard
...
### Check 3 - survival is monotonically non-increasing
...
### Check 4 - long-time-horizon survival saturates at the late hazard
