...
- **Three convention warnings on the SVR files are deliberate**, arising
  ...
  it was offered to the maintainers and **declined**, on the grounds
  that a PD-output canonical is a separate concept that should be raised
  by a model that actually needs it rather than as a side effect of this
  extraction.
