...
- **The printed Kp scaling factor of 350 is not usable.** Methods 2.5
  ...
  validation target is not permitted) optimises near 20. Ratified by the
  maintainers on 2026-08-05. **Consequence:** at a = 9.15 the model’s
...
- **Table 6 cannot be produced by the printed heart-transplant
  ...
  constants give E = 0.065. Per the maintainers’ ruling of 2026-08-05,
  Table 3 is encoded **verbatim** and no constant was back-solved;
  validation is against what is reproducible (Table S5 and the Table 4
  observed values).
