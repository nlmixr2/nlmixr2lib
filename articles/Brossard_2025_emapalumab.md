...
- **The upstream main paper was checked against the publisher’s copy.**
  An early draft of this model was prepared without access to Brossard &
  Laveille 2024 (PMC11111609), so the four-point clearance key, the
  four-point half-life key and the 24.0-day MAS median could not be
  verified against it at first. The publisher’s copy of the paper was
  then obtained and all of those values were confirmed verbatim before
  being relied on here. Its supplement (the run log) was available
  throughout.
