...
- **Vt and CL_D point estimates from Table 4.** The text extracted from
  ...
  initially mislabelled CL_D = 4.43 vs V1 = 8.92. The packaged values
  were re-extracted from the higher-fidelity PDF rendering of Table 4
  and cross-checked against Table 5 V_SS = 20.6 L (= V1 + V_t = 8.92 +
  11.4 = 20.32 L) to confirm the ordering.
