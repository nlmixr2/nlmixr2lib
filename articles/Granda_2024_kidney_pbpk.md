...
mechanistic checks below are used instead: a mass-balance / flux check,
a physiological-constraint check, and two exact reproductions of the
paper’s own tables.
...
- **`pka_acid` is model-identified, not transcribed.** Granda 2024 Table
  ...
  pKa was taken from an external database or assumed.
