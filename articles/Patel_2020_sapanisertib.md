...
digitised or curve-fitted values – but they are invisible to `pdftotext`
and to docling because Figures 4 and S2 are raster images. They were
recovered with `pdftoppm -r 400 -f 10` on the article PDF (Figures 4A
and 4C, journal page 885) and by unzipping
