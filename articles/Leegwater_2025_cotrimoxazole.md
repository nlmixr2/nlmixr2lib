...
| sulfamethoxazole | `clrat_nasmx` | 0.4 (fixed) | Table 3 “Conversion parent metabolite 0.4 x CL”; control stream `K23 = 0.4*CL/V2` |
...
2.  **“40% of the total clearance” is 40% of one clearance arm, not of
    ...
    It is why the model file names the parameter `clrat_nasmx`
