...
- **Supplement not used.** “Supplementary Material 1” is the
  goodness-of-fit figure panel; it contains no parameter values and was
  not available when this model was built. Every value in the model
  comes from Table 3 and its footnote.
