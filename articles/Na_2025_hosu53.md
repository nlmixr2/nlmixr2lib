...
units from the available sources. Simulated doses below are given in
model amount units and anchored to a published observation (see *Dog
dose anchoring*).
...
| dog | lka | 0.4253 | FALSE | First-order absorption rate constant (1/h) |
| dog | lcl | 5.0106 | TRUE | Clearance (mL/h) |
| dog | lvc | 6.8876 | TRUE | Central volume of distribution (mL) |
| dog | lq | 5.9915 | TRUE | Intercompartmental clearance (mL/h) |
| dog | lvp | 6.1944 | TRUE | Peripheral volume of distribution (mL) |
| dog | lrbase | -2.8134 | FALSE | Baseline (steady-state) plasma DHO concentration (umol/L) |
| dog | lkout | 3.9512 | FALSE | First-order DHO degradation rate constant (1/h) |
| dog | lic50 | -2.3026 | FALSE | HOSU-53 concentration giving half-maximal inhibition of DHO degradation (umol/L) |
| dog | lhill | 0.6419 | FALSE | Sigmoidicity (Hill) exponent of the inhibitory function (unitless) |
| dog | limax | 0.0000 | TRUE | Maximum fractional inhibition of DHO degradation (unitless) |
...
| mouse | lka | 0.0000 | FALSE | First-order absorption rate constant (1/h) |
| mouse | lcl | -2.6593 | FALSE | Clearance (mL/h) |
| mouse | lvc | 0.1823 | FALSE | Central volume of distribution (mL) |
| mouse | lq | 0.4700 | FALSE | Intercompartmental clearance (mL/h) |
| mouse | lvp | 0.1823 | FALSE | Peripheral volume of distribution (mL) |
| mouse | lrbase | -4.6052 | FALSE | Baseline (steady-state) plasma DHO concentration (umol/L) |
| mouse | lkout | 5.0434 | FALSE | First-order DHO degradation rate constant (1/h) |
| mouse | lic50 | 0.4383 | FALSE | HOSU-53 concentration giving half-maximal inhibition of DHO degradation (umol/L) |
| mouse | lhill | 0.5365 | FALSE | Sigmoidicity (Hill) exponent of the inhibitory function (unitless) |
| mouse | limax | 0.0000 | TRUE | Maximum fractional inhibition of DHO degradation (unitless) |
...
- **The PK-Sim PBPK models are not extracted.** Na 2025 built whole-body
  ...
  platform and are not written out in any available source, so the PBPK
