...
#>               0           14   80 mg Q2W 100          110 [33.7]  23.0 [25.1]
#>               0           14  240 mg Q2W 100          345 [28.9]  64.4 [22.7]
#>               0           14  400 mg Q2W 100          622 [23.7]   112 [20.3]
#>               0           28  800 mg Q4W 100         1940 [31.9]   221 [23.6]
#>               0           14 1200 mg Q2W 100         1920 [24.6]   334 [24.0]
#>  Cmin (ug/mL)           Tmax (day)
#>    3.15 [388] 0.000 [0.000, 0.000]
#>   16.6 [95.2] 0.000 [0.000, 0.000]
#>   33.8 [40.7] 0.000 [0.000, 0.000]
#>    30.6 [131] 0.000 [0.000, 0.000]
#>    110 [35.4] 0.000 [0.000, 0.000]
#> 
...
- **Full-covariate-model retained.** Per Xu 2023’s pre-specified
  ...
  DIS_CMML, CONMED_SPART – are retained even though only DIS_MDS reaches
  conventional significance (p = 0.0213). The paper’s sensitivity
  analysis (reduced model with non-significant covariates dropped)
  reports the largest parameter shift was beta_CL,MDS from -0.149 to
  -0.164 (~10% relative), so the full and reduced models are practically
  equivalent for typical-value predictions.
