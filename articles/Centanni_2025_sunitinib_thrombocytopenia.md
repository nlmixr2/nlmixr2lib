...
Encoded per the maintainers’ ruling (2026-08-14).
...
- **Suspected factor-of-1000 scale erratum in Table S2 (three
  ...
  maintainers’ ruling. This is the only deviation from the printed
  values, and every corrected parameter carries an inline comment in the
  model file’s `ini()` block.
