...
| CRCL | 5th | 48.87 | 1.1289 | 1.1285 | 1.0788 | 1.1984 | -0.0372 |
| CRCL | 95th | 141.70 | 0.8932 | 0.8933 | 0.9353 | 0.8388 | 0.0168 |
...
- **Equations recovered from the PDF layout.** The seven display
  ...
  and do not survive ordinary plain-text extraction of the PDF. They
  were recovered with `pdftotext -layout`, which is the source for every
  centring constant in the model file.
