...
|---:|---:|:---|:---|:---|:---|:---|:---|:---|:---|
| 0 | Inf | 100 mg PO | 200 | 1.35 \[57.1\] | 1.00 \[1.00, 8.00\] | 0.138 \[151\] | 30.6 \[20.1\] | 0.0272 \[66.3\] | 51.6 \[38.4\] |
...
- **Supplement S1**: Supplementary Table S1 (model selection AIC / BIC
  ...
  in the paper but was not available when this model was built. The
  1-compartment selection is reported in the Results text and is encoded
  as such; the supplement would only inform the model-comparison
  narrative, not the parameter values.
