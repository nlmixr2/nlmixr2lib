...
- **`Y_ij = F_ij + epsilon * W` formula lost by plain-text extraction.**
  The equation does not survive plain-text extraction of the PDF. It was
  read directly from the layout-preserving PDF text dump
