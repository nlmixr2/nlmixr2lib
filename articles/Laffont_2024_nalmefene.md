...
Supplementary Table 1 of Laffont 2024, which was not available when this
model was built.
...
- **Detailed baseline demographics deferred to Supplementary Table 1.**
  ...
  are in Supplementary Table 1, which was not available when this model
  was built; the `population` metadata carries TODO markers for those
  fields.
