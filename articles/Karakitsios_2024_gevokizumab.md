...
- **All parameter values come from the paper or its own supplement.** No
  value was taken from a generic default or from another publication:
  the structural equations and physiologic constants are read from this
  paper’s Supplementary Material equations (S1)-(S8), and every estimate
  from Table 3 or Table 4.
