...
`attr(readModelDb("LongBoyle_2015_busulfan"), "meta")$population`.

## Source trace

The per-parameter origin is also recorded as an in-file comment next to
each `ini()` entry in
`inst/modeldb/specificDrugs/LongBoyle_2015_busulfan.R`. The table below
consolidates them.
...
mod <- readModelDb("LongBoyle_2015_busulfan")
...
![](LongBoyle_2015_busulfan_files/figure-html/figure-1B-typical-profile-1.png)
...
![](LongBoyle_2015_busulfan_files/figure-html/figure-2B-1.png)
