...
- **The functional form of the healthy-adult CL/F factor is inferred,
  ...
  with SMA. Ratified by the maintainers. No parameter was tuned to any
  target.
...
- **The Mech-PPK model of Table 3 is deferred, not dropped.** It
  ...
  coefficients and an unpublished blood-to-plasma ratio; neither was
  available when this model was built. The ontogeny functions and the
  ESM Eq. S1-S11 physiology chain have been decoded and verified here so
  the follow-up extraction can proceed directly once the upstream paper
  is available.
