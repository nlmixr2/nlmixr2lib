...
- **No errata identified.** A search for published corrections to the Br
  ...
  “\<Feng 2006 enoxaparin\> erratum” queries returned no hits. If a
  future search uncovers an erratum, the affected parameter value(s)
  should be updated and the in-file source-trace comments should point
  to the erratum.
