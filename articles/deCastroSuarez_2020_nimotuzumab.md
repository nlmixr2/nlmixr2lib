...
Programmatically: `readModelDb("deCastroSuarez_2020_nimotuzumab")`
carries the same metadata in the `meta$population` field of the returned
...
`inst/modeldb/specificDrugs/deCastroSuarez_2020_nimotuzumab.R` comes
from the following locations in de Castro-Suárez N, Trame MN,
Mangas-Sanjuan V, et al., *Pharmaceutics* 2020;12(12):1147
...
`inst/modeldb/specificDrugs/deCastroSuarez_2020_nimotuzumab.R` is
...
mod <- readModelDb("deCastroSuarez_2020_nimotuzumab")
...
![](deCastroSuarez_2020_nimotuzumab_files/figure-html/fig4a-1.png)
...
![](deCastroSuarez_2020_nimotuzumab_files/figure-html/fig4b-1.png)
...
![](deCastroSuarez_2020_nimotuzumab_files/figure-html/fig4c-1.png)
...
![](deCastroSuarez_2020_nimotuzumab_files/figure-html/vpc-1.png)
