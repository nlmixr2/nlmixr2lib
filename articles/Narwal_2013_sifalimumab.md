...
`ini()` entry in `inst/modeldb/specificDrugs/Narwal_2013_sifalimumab.R`.
...
`CONMED_STEROID = 0` (no baseline conmed_steroid use), and stratified
into the four dose cohorts that matched the phase Ib design.
...
|---:|---:|:---|:---|:---|:---|:---|:---|
| 0 | 14 | 0.3 mg/kg Q14D | 50 | 56.5 \[26.5\] | 7.40 \[29.2\] | 0.0833 \[0.0833, 0.0833\] | 13.9 \[4.77\] |
| 0 | 14 | 1 mg/kg Q14D | 50 | 206 \[26.8\] | 28.2 \[31.5\] | 0.0833 \[0.0833, 0.0833\] | 13.0 \[4.35\] |
| 0 | 14 | 10 mg/kg Q14D | 50 | 1880 \[28.1\] | 255 \[31.2\] | 0.0833 \[0.0833, 0.0833\] | 11.5 \[3.30\] |
| 0 | 14 | 3 mg/kg Q14D | 50 | 535 \[27.2\] | 73.2 \[31.6\] | 0.0833 \[0.0833, 0.0833\] | 13.2 \[4.56\] |
...
- **`CONMED_STEROID` default.** The phase IIb simulations in the paper
  ...
  The virtual cohort above does the same; set `CONMED_STEROID = 1` per
  subject to simulate the +19.5% CL effect for
  concomitant-conmed_steroid users.
