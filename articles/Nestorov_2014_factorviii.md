...
``` math
\mathrm{CL} \;=\; \mathrm{TVCL}\,\bigl(\mathrm{VWF}/118\bigr)^{Q_{10}}, \qquad
V_1 \;=\; \mathrm{TVV}_1\,\bigl(\mathrm{WT}/73\bigr)^{Q_8}\bigl(\mathrm{HCT}/45\bigr)^{Q_9}
```
