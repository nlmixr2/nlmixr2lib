...
subjects (the package’s per-arm ceiling of 200 for validation cohorts).
...
NCA validation does not apply. We spot-check the rxode2 output against
closed-form algebra at four canonical ages.
