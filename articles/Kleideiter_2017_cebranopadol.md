...
Cebranopadol NCA: typical-value simulated (no IIV) vs. Kleideiter 2017
Table 4 (paper mean +/- SD; Tmax shown as the paper median; auclast ==
AUC0-72). \* differs from reference by \>20%. Note: AUC0-72 is the
integral over the dosing window; half-life sensitivity to the late-time
regression window may exceed 20% as an artefact of the dense vs sparse
NCA terminal fits. {.table}
