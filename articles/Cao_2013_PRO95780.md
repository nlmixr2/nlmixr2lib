...
- Source data digitised from Camidge DR et al. *Clin Cancer Res.*
  2010;16(4):1256-1263 (PMID 20145186).

This is the **PRO95780** entry from the 12-fit Cao 2013 mAb cohort. The
...
Cao et al. fit the mPBPK model to PRO95780 plasma concentration profiles
digitised from Camidge 2010, death receptor 5 (DR5) agonistic human IgG1
(drozitumab) in advanced malignancies. Doses: 4, 10, 15, 20 mg/kg IV.
Cao 2013 does not reproduce the underlying Camidge 2010 demographics;
...
The packaged metadata (`readModelDb("Cao_2013_PRO95780")$population`)
...
![](Cao_2013_PRO95780_files/figure-html/figure-5-1.png)
...
|------:|----:|---------------:|:----|:-----|:------|:----------|:-----------|
|     0 | Inf |              4 | 1   | 108  | 0.000 | 13.8      | 941        |
|     0 | Inf |             10 | 1   | 269  | 0.000 | 13.8      | 2350       |
|     0 | Inf |             20 | 1   | 538  | 0.000 | 13.8      | 4710       |

Simulated NCA parameters by dose group (Cao 2013 PRO95780 Model A
typical-value fit). {.table}

The terminal half-life predicted by the typical-value mPBPK fit
corresponds to PRO95780’s reported half-life of approximately 2-3 weeks
in the underlying Camidge 2010 study; Cmax and AUC scale linearly with
...
- **Model A (clearance from plasma) used by default.** Cao 2013 also
  ...
  for PRO95780); Model A is used here for consistency across the 12
  ...
  sigma2.- **Drug-specific note.** PRO95780 is also known as drozitumab
  in the literature.
