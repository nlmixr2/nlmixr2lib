...
upstream `Zhu_2014_rilotumumab` extraction will carry the full covariate
model and residual error specification.
...
The Zhu_2014_rilotumumab extraction is the canonical source for the full
popPK model including covariates and residual error.
