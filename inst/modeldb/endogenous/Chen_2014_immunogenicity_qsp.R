Chen_2014_immunogenicity_qsp <- function() {
  ...
  ini({
    ...
    rhoABN   <- fixed(0.3333);     label("Maximum activated-B proliferation rate (1/day)")# Table S2 (Tangye 2003 / Fecteau 2009 refs 22-23)
    rhoABM   <- fixed(0.7273);     label("Maximum activated-B proliferation rate (1/day)")# Table S2 (Tangye 2003 / Fecteau 2009 refs 22-23)
