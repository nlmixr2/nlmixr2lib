Yoshida_2018_coproporphyrin_I_rifampin <- function() {
  ...
  reference <- paste(
    ...
    "function; that Simcyp output is not reproducible from the available",
