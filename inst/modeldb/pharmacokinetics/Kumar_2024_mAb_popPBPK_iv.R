Kumar_2024_mAb_popPBPK_iv <- function() {
  description <- paste(
    ...
    "INTRAVENOUS administration. The structure and the human (71 kg male)",
    "physiology are inherited unchanged from the Shah and Betts 2012 platform",
    "PBPK model (see Shah_2012_mAb_PBPK.R): 15 tissues x 6 sub-compartments",
    "(vascular plasma, vascular blood cells, endosomal unbound mAb, endosomal",
    "FcRn-bound mAb, endosomal free FcRn, interstitial) plus central plasma,",
    "central blood cells and a lymph node, totalling 93 ODE states, with",
    "FcRn-mediated recycling in every tissue endosomal space. Kumar 2024",
    "re-estimated two of the four Shah and Betts system parameters -",
    "pinocytic uptake per unit endosomal space (CLup) and endosomal",
    "degradation of FcRn-unbound mAb (kdeg) - by fitting the model to",
    "multiple-dose-level IV profiles of 43-44 mAbs in Monolix 2021R1,",
    "treating EACH ANTIBODY as an individual. The random effects on CLup and",
    "kdeg are therefore INTER-ANTIBODY variability, not between-subject",
    "variability: sampling them draws a new hypothetical antibody, not a new",
    "patient. Kumar 2024 also reduced the central plasma and blood-cell",
    "volumes to 1412 and 1155 mL (total blood volume minus the vascular",
    "volume held in the tissues), which is the one physiological difference",
    "from the Shah and Betts parameterization. All remaining system",
    "parameters (FcRn concentration, FcRn on/off rates, recycled fraction FR,",
    "reflection coefficients, organ volumes and flows) are FIXED at the Shah",
    "and Betts 2012 human values."
  )
  reference <- paste(
  ...
  compartmentData <- list(
    ...
    vp_small_intestine = list(analyte = "mAb", units = "nmol", specimen = "administration site", verified = FALSE),
    vp_large_intestine = list(analyte = "mAb", units = "nmol", specimen = "administration site", verified = FALSE),
    vp_pancreas        = list(analyte = "mAb", units = "nmol", specimen = "administration site", verified = FALSE),
    vp_thymus          = list(analyte = "mAb", units = "nmol", specimen = "administration site", verified = FALSE),
    vp_spleen          = list(analyte = "mAb", units = "nmol", specimen = "tissue", verified = FALSE),
    vp_other           = list(analyte = "mAb", units = "nmol", specimen = "administration site", verified = FALSE),
    ...
    bc_small_intestine = list(analyte = "mAb", units = "nmol", specimen = "blood cell", verified = FALSE),
    bc_large_intestine = list(analyte = "mAb", units = "nmol", specimen = "blood cell", verified = FALSE),
    bc_pancreas        = list(analyte = "mAb", units = "nmol", specimen = "blood cell", verified = FALSE),
    bc_thymus          = list(analyte = "mAb", units = "nmol", specimen = "blood cell", verified = FALSE),
    bc_spleen          = list(analyte = "mAb", units = "nmol", specimen = "tissue", verified = FALSE),
    bc_other           = list(analyte = "mAb", units = "nmol", specimen = "blood cell", verified = FALSE),
    ...
    eu_small_intestine = list(analyte = "mAb", units = "nmol", specimen = "endosome", verified = FALSE),
    eb_small_intestine = list(analyte = "mAb", units = "nmol", specimen = "endosome", verified = FALSE),
    fr_small_intestine = list(analyte = "mAb", units = "nmol", specimen = "endosome", verified = FALSE),
    eu_large_intestine = list(analyte = "mAb", units = "nmol", specimen = "endosome", verified = FALSE),
    eb_large_intestine = list(analyte = "mAb", units = "nmol", specimen = "endosome", verified = FALSE),
    fr_large_intestine = list(analyte = "mAb", units = "nmol", specimen = "endosome", verified = FALSE),
    eu_pancreas        = list(analyte = "mAb", units = "nmol", specimen = "endosome", verified = FALSE),
    eb_pancreas        = list(analyte = "mAb", units = "nmol", specimen = "endosome", verified = FALSE),
    fr_pancreas        = list(analyte = "mAb", units = "nmol", specimen = "endosome", verified = FALSE),
    eu_thymus          = list(analyte = "mAb", units = "nmol", specimen = "endosome", verified = FALSE),
    eb_thymus          = list(analyte = "mAb", units = "nmol", specimen = "endosome", verified = FALSE),
    fr_thymus          = list(analyte = "mAb", units = "nmol", specimen = "endosome", verified = FALSE),
    ...
    eu_other           = list(analyte = "mAb", units = "nmol", specimen = "endosome", verified = FALSE),
    eb_other           = list(analyte = "mAb", units = "nmol", specimen = "endosome", verified = FALSE),
    fr_other           = list(analyte = "mAb", units = "nmol", specimen = "endosome", verified = FALSE),
    ...
    is_small_intestine = list(analyte = "mAb", units = "nmol", specimen = "administration site", verified = FALSE),
    is_large_intestine = list(analyte = "mAb", units = "nmol", specimen = "administration site", verified = FALSE),
    is_pancreas        = list(analyte = "mAb", units = "nmol", specimen = "administration site", verified = FALSE),
    is_thymus          = list(analyte = "mAb", units = "nmol", specimen = "administration site", verified = FALSE),
    is_spleen          = list(analyte = "mAb", units = "nmol", specimen = "tissue", verified = FALSE),
    is_other           = list(analyte = "mAb", units = "nmol", specimen = "administration site", verified = FALSE),
    plasma             = list(analyte = "mAb", units = "nmol", specimen = "plasma", verified = FALSE),
    bcc                = list(analyte = "mAb", units = "nmol", specimen = "not applicable", verified = FALSE),
    lnode              = list(analyte = "mAb", units = "nmol", specimen = "not applicable", verified = FALSE)
  )
  ...
  population <- list(
    ...
    disease_state  = paste(
      ...
      "volunteers, with some patient cohorts (oncology, rheumatoid",
      "arthritis, asthma, psoriasis, infectious disease). See Kumar 2024",
      "Supplementary Table S3 for the per-antibody study list."
    ),
    dose_range     = "multiple IV dose levels per antibody (digitized phase 1 dose-escalation profiles)",
    ...
    notes          = paste(
      ...
      "subjects. Mean (digitized) plasma concentration-time profiles were",
      "collected for 143 mAbs; 55 showed linear PK; panobacumab (IgM) and",
      "suvratoxumab (Fc-modified) were excluded for atypical FcRn affinity;",
      "44 mAbs with IV data were used to build the IV model (Table 3 lists",
      "43 with median %PE, all below 30%). Antibodies with dose-dependent",
      "(target-mediated) disposition were excluded by design, so this model",
      "describes LINEAR mAb disposition only and contains no TMDD terms."
    ),
    scope_note     = paste(
  ...
  model({
    ...
    # Skin (full skin compartment; the SC model bifurcates this - see
    # Kumar_2024_mAb_popPBPK_sc.R)
    ...
    # === Initial conditions ===
    # All mAb states start at zero (the IV dose enters `plasma` from the
    # event table). Free FcRn starts at 4.98e-5 M in every tissue endosome.
