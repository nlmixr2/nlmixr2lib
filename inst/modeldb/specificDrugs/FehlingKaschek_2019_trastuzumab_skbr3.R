FehlingKaschek_2019_trastuzumab_skbr3 <- function() {
  ...
  compartmentData <- list(
    nm_r = list(
      analyte = "HER2 (ruffled membrane)",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    ),
    nmt_r = list(
      analyte = "Trastuzumab (ruffled membrane)",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    ),
    nma_r = list(
      analyte = "HER2-Trastuzumab complex (ruffled membrane)",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    ),
    nmta_r = list(
      analyte = "Trastuzumab-bound HER2 (ruffled membrane)",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    ),
    nm_f = list(
      analyte = "HER2 (flat membrane)",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    ),
    nmt_f = list(
      analyte = "Trastuzumab (flat membrane)",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    ),
    nma_f = list(
      analyte = "HER2-Trastuzumab complex (flat membrane)",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    ),
    nmta_f = list(
      analyte = "Trastuzumab-bound HER2 (flat membrane)",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    ),
    ni_r = list(
      analyte = "Internalized HER2 (ruffled membrane)",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    ),
    nit_r = list(
      analyte = "Internalized Trastuzumab (ruffled membrane)",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    ),
    nia_r = list(
      analyte = "HER2-Trastuzumab complex internalized (ruffled membrane)",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    ),
    nita_r = list(
      analyte = "Trastuzumab-bound HER2 internalized (ruffled membrane)",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    ),
    ni_f = list(
      analyte = "Internalized HER2 (flat membrane)",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    ),
    nit_f = list(
      analyte = "Internalized Trastuzumab (flat membrane)",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    ),
    nia_f = list(
      analyte = "HER2-Trastuzumab complex internalized (flat membrane)",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    ),
    nita_f = list(
      analyte = "Trastuzumab-bound HER2 internalized (flat membrane)",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    )
  ...
  ini({
    ...
    kdiss     <- 0.05;         label("Trastuzumab dissociation rate (1/min)")              # Table 3 Model B (5.0e-2 /min)
    ...
    koff      <- 6.8e-4;       label("Affibody dissociation rate (1/min)")                  # Table 3 Model B (6.8e-4 /min)
    ...
    kint_F_T  <- 0.0126;       label("Internalization rate of trastuzumab-bound HER2 on flat membrane (1/min)") # Table 3 Model B
