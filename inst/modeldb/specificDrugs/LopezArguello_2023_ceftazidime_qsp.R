LopezArguello_2023_ceftazidime_qsp <- function() {
  ...
  compartmentData <- list(
    npbp1a = list(
      analyte = "covalently-bound ceftazidime to PBP1a",
      units = NA_character_,
      specimen = "bile",
      verified = FALSE
    ),
    npbp1b = list(
      analyte = "covalently-bound ceftazidime to PBP1b",
      units = NA_character_,
      specimen = "bile",
      verified = FALSE
    ),
    npbp2 = list(
      analyte = "covalently-bound ceftazidime to PBP2",
      units = NA_character_,
      specimen = "bile",
      verified = FALSE
    ),
    npbp3 = list(
      analyte = "covalently-bound ceftazidime to PBP3",
      units = NA_character_,
      specimen = "bile",
      verified = FALSE
    ),
    npbp4 = list(
      analyte = "covalently-bound ceftazidime to PBP4",
      units = NA_character_,
      specimen = "bile",
      verified = FALSE
    ),
    npbp56 = list(
      analyte = "covalently-bound ceftazidime to PBPs 5/6",
      units = NA_character_,
      specimen = "bile",
      verified = FALSE
    ),
    nperi = list(
      analyte = "free ceftazidime in periplasm",
      units = NA_character_,
