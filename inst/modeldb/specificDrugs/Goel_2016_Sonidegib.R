Goel_2016_Sonidegib <- function() {
  ...
  compartmentData <- list(
    depot       = list(analyte = "Sonidegib", units = "mg", specimen = "administration site", verified = FALSE),
    central     = list(analyte = "Sonidegib", units = "mg", specimen = "plasma", verified = FALSE),
    peripheral1 = list(analyte = "Sonidegib", units = "mg", specimen = "plasma", verified = FALSE)
  )
