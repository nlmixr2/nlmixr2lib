Beredaki_2024_amphotericinB_liposomal_cauris48h <- function() {
  ...
  ini({
    ...
    # form alone gives E = 0 at zero exposure whereas Figure 5 starts near
    # +4 log10 CFU/mL.
    #
    ...
    # below were recovered by digitising the 48 h curve of Figure 5 from
    # the 600 dpi page render (1824 traced points spanning Cmax/MIC
    # 0.011-136) and least-squares fitting the four-parameter
    # log-logistic form; residual RMSE was 0.011 log10 CFU/mL, i.e. the
    ...
    # is the fitted asymptote, which lies to the left of the observed
    # drug-free controls and so exceeds the mean measured control growth
    # of 3.48 log10 CFU/mL (4.04 -> 7.52).
    e0 <- 3.963
    label("48 h change in log10 CFU/mL at zero exposure (fitted top asymptote)")  # digitised from Beredaki 2024 Figure 5, 48 h curve; cross-checks against the reported drug-free control growth 4.04 -> 7.52 log10 CFU/mL at 48 h
    lemax <- log(6.956)
