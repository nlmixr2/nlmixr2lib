Bajaj_2017_nivolumab <- function() {
  ...
  ini({
    ...
    cl_time_max <- -0.295;           label("Maximal fractional change in CL_EMAX (unitless)")                               # Bajaj 2017 Table 1: CL_EMAX = -0.295
    cl_t50     <-  1.41e3 / 24;     label("Time at which the change in CL is 50%% of CL_EMAX (days)")                      # Bajaj 2017 Table 1: CL_T50  = 1.41e3 h
    cl_time_hill <-  3.15;            label("Hill / sigmoidicity exponent of time on CL (unitless)")                         # Bajaj 2017 Table 1: CL_HILL = 3.15
    ...
    # (Emax_i = cl_time_max + etacl_time_max per Bajaj 2017 Eq. 3).
    ...
    etacl_time_max ~ 0.0719                                                                                                 # Bajaj 2017 Table 1: omega^2_EMAX = 0.0719
