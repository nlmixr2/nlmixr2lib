Liang_2024_rituximab_pla2r <- function() {
  ...
  ini({
    ...
    lkel  <- log(0.029336); label("Anti-PLA2R elimination rate constant (PLA2R, 1/day)")   # Liang 2024 Section 3.6: mean ke,PLA2R = 0.033 +/- 0.017 /day; log-normal median = 0.033 / sqrt(1 + (0.017/0.033)^2) = 0.029336
