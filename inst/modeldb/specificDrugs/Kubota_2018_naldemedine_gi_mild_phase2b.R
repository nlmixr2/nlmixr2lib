Kubota_2018_naldemedine_gi_mild_phase2b <- function() {
  ...
  population <- list(
    ...
    n_subjects = 89L,
    n_studies = 1L,
    n_observations = "89 binary gastrointestinal disorder of mild or greater severity records, one per subject",
  ...
  ini({
    ...
    logit_ref <- -1.76; label("Logit of the gastrointestinal disorder of mild or greater severity probability at zero naldemedine exposure, i.e. the placebo arm (unitless logit)")  # Table V(b), rows '1107V9221 (Phase 2b)' / 'Mild, Moderate, Severe', parameter a = -1.76 (95% CI -2.46 to -1.16)
