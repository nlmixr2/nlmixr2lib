Liu_2018_micafungin_mouse_qsp <- function() {
  ...
  population <- list(
    ...
    n_subjects = "PK module built on published murine plasma-concentration profiles digitised from Andes 2010 (construction and validation); PD and drug-effect layers constrained by the Pneumocystis burdens of Cushion 2010 and by the authors' own 6-week-old male C3H/HeN mice",
    n_studies = 2L,
    ...
    dose_range = "0.1, 0.5, 1, 2.5, 5 and 10 mg/kg intraperitoneally, giving initial administration-compartment concentrations of 1, 3, 5, 10, 15 and 25 ug/mL (Liu 2018 Table 3); the Figure 4a treatment arms are 0.1, 0.5 and 1 mg/kg three times a week for three weeks",
  ...
  ini({
    # ==================================================================
    # PK module -- Liu 2018 Table 1, micafungin column. All rate
    ...
    # parameter set was SSE = 202.14 (Table 2).
    # ==================================================================
    lka <- fixed(log(0.75))
    ...
    # ==================================================================
    # Micafungin effect on the asci -- Liu 2018 Table 5, echinocandin
    ...
    # ==================================================================
    ec50 <- fixed(0.04)
    label("Plasma micafungin concentration giving half the maximal asci effects Ec50 (ug/mL)")  # Table 5
    emax <- fixed(0.1)
    label("Maximal micafungin-induced increment in the asci death rate ME (1/day)")  # Table 5
    hill <- fixed(1)
    label("Hill coefficient of the micafungin asci effects n (dimensionless)")  # Table 5
