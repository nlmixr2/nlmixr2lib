Gupta_2006_peginterferon_alfa_2b <- function() {
  ...
  ini({
    ...
    lcl_t50 <- log(23.8 * 28)         # Gupta 2006 Table 3: theta_T50 = 23.8 reported in units of 28 days -> 666.4 days
    ...
    etalcl_t50 ~ 0.7833               # Gupta 2006 Table 3: omega(CV) T50 = 109% -> omega^2 = log(1.09^2 + 1) = 0.7833
