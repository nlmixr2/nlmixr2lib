Zhu_2023_omalizumab_pediatric <- function() {
  ...
  ini({
    ...
    lrbase    <- log(0.879)      ; label("Maximum FEV1pp at free IgE = 0 (fraction predicted)")                 # Zhu 2023 Table II: FEV1max = 0.879 (95% CI 0.844, 0.915; %RSE 2.08; fraction predicted -- multiply by 100 for the 0-100 percent scale)
    ...
    lec50     <- log(39.4)       ; label("Free IgE concentration causing 50% maximum inhibition (ng/mL)")           # Zhu 2023 Table II: IC50 = 39.4 ng/mL (95% CI 24.3, 63.9; %RSE 25.0)
