Lahu_2010_roflumilast <- function() {
  ...
  population <- list(
    ...
    regions = "Multinational; specific country composition not reported in the available sources.",
