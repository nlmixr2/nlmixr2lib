Lu_2019_polatuzumab <- function() {
  ...
  ini({
    ...
    e_asian_vc      <-  0.929;     label("Multiplicative effect of Asian race on Vc (unitless; 7.1% lower V1 in Asian patients; re-quoted in Shi 2020 PMID 32770353)") # Lu 2019 Table 2, theta25
  ...
  model({
    ...
    # Exponential decay of CL_TIME (Lu 2019 supplement Notations: CLT = CLT0 * exp(-cl_exp_kdes*t)).
