Papachristos_2020_bevacizumab_pk <- function() {
  ...
  ini({
    ...
    etalvc ~ 0.03028  # Table 1 omega_V1 = 0.174
    etalvp ~ 0.45698  # Table 1 omega_V2 = 0.676
  ...
  model({
    ...
    # log(CL_i) = lcl + e_wt_cl * log(WT/70) + e_icam * SNP_ICAM1_RS1799969 + etalcl  (Papachristos 2020 sec. 2.2 equation)
