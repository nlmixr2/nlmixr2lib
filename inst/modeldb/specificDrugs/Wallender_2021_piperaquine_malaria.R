Wallender_2021_piperaquine_malaria <- function() {
  ...
  ini({
    ...
    lec50 <- log(6.00) ; label("Piperaquine concentration producing a half-maximal reduction of the incident-malaria hazard (ng/mL)")  # Table 2 theta PPQ EC50 = 6.00 ng/mL (14.4% RSE, 95% CI 4.25-7.58)
