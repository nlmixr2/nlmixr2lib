Nath_2010_melphalan_unbound <- function() {
  ...
  compartmentData <- list(
    central     = list(analyte = "melphalan unbound", units = "mg", specimen = "plasma", verified = FALSE),
    peripheral1 = list(analyte = "melphalan unbound", units = "mg", specimen = "plasma", verified = FALSE)
  )
