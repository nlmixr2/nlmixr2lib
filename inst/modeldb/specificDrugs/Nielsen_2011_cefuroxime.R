Nielsen_2011_cefuroxime <- function() {
  ...
  compartmentData <- list(
    central        = list(analyte = "cefuroxime", units = NA_character_, specimen = "plasma", verified = FALSE),
    effect         = list(analyte = "cefuroxime", units = NA_character_, specimen = "not applicable", verified = FALSE),
