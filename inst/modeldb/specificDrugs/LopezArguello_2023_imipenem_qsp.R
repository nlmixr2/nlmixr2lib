LopezArguello_2023_imipenem_qsp <- function() {
  ...
  ini({
    ...
    k2_2 <- fixed(500); label("Second-order acylation rate constant, PBP2 (1e-3 /min; FIXED)") # Table S1, imipenem PBP2: 500, footnote a (fixed after sensitivity analyses of the highest-affinity target)
