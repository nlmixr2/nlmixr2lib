Sloan_2017_rifampicin <- function() {
  ...
  ini({
    ...
    lnn     <- fixed(log(1.5));   label("Number of absorption transit compartments NN, estimated on a continuous scale (dimensionless)")                       # Sloan 2017 Table 3: NN = 1.5 (FIX); stage 1 estimate RSE 41%, 95% CI 0.09-3.9
