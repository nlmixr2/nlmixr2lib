LopezArguello_2023_aztreonam_qsp <- function() {
  ...
  compartmentData <- list(
    npbp1a = list(
      analyte = "aztreonam-PBP1a complex",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    ),
    npbp1b = list(
      analyte = "aztreonam-PBP1b complex",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    ),
    npbp2 = list(
      analyte = "aztreonam-PBP2 complex",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    ),
    npbp3 = list(
      analyte = "aztreonam-PBP3 complex",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    ),
    npbp4 = list(
      analyte = "aztreonam-PBP4 complex",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    ),
    npbp56 = list(
      analyte = "aztreonam-PBP5/6 complex",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    ),
    nperi = list(
      analyte = "aztreonam in periplasm",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    )
