  ...
  covariateData <- list(
    ...
    CONMED_RTV = list(
      ...
      notes = paste(
        ...
        "compound model of Shebley 2017, which was not available when this model",
        "was built and is a platform database artefact, so no time-varying",
        "interaction term can be encoded.",
