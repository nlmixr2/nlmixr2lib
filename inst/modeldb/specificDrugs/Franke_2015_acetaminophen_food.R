Franke_2015_acetaminophen_food <- function() {
  ...
  ini({
    ...
    # solved without them. On operator instruction (sidecar oasweep_PMC4541541
    # request-001, answered 2026-09-21 option A) both are carried in from the
    # SAME paper's pooled fasted acetaminophen fit, Table 4, and held fixed:
