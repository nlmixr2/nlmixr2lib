Apgar_2018_ALXN1540_rat_qsp <- function() {
  ...
  reference <- "Apgar JF, Tang JP, Singh P, Balasubramanian N, Burke J, Hodges MR, Lasaro MA, Lin L, Miliard BL, Moore K, Jun LS, Sobolov S, Wilkins AK, Gao X. Quantitative Systems Pharmacology Model of hUGT1A1-modRNA Encoding for the UGT1A1 Enzyme to Treat Crigler-Najjar Syndrome Type 1. CPT Pharmacometrics Syst Pharmacol. 2018;7(6):404-412. doi:10.1002/psp4.12301. Rate constants and plasma volume from Table 1 (Gunn rat column); reaction network from Supplementary Model S1 (Gunn Rat KroneckerBio Model File)."
