Jacobs_2016_colistin <- function() {
  ...
  model({
    ...
    # Total clearances. The HD contribution is gated by RRT_HEMODIAL_ACTIVE (1 during
    ...
    # become colistin.
    cl_tot      <- cl     + RRT_HEMODIAL_ACTIVE * cl_hd_cms
    cl_col_tot  <- cl_col + RRT_HEMODIAL_ACTIVE * cl_hd_col
