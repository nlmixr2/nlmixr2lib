Beredaki_2023_micafungin_clsi <- function() {
  ...
  ini({
    ...
    mic <- fixed(0.008)
    label("Micafungin CLSI M27 MIC of the simulated isolate (mg/L; FIXED, measured)")  # Beredaki 2023 Table 1: C. albicans CA 580 (fks1 wild-type) CLSI median MIC 0.008 mg/L (range 0.008-0.015)
    ...
    label("Additive residual SD on log10 CFU/mL (FIXED 0; not reported in Beredaki 2023)")  # Beredaki 2023 reported R^2 = 0.92 only, no residual SD
  })
