Valenzuela_2011_oxaliplatin <- function() {
  ...
  reference <- paste(
    ...
    "available when this model was built, and a public-web search",
    "for its full content was inconclusive -- confirmation against the",
    "published erratum is recommended; see vignette Errata).",
