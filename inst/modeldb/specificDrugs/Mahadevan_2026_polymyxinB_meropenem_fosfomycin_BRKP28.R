Mahadevan_2026_polymyxinB_meropenem_fosfomycin_BRKP28 <- function() {
  ...
  compartmentData <- list(
    ...
    bact_resistant_resistant_intermediate1 = list(
      analyte = "Klebsiella pneumoniae BRKP28, polymyxin B-resistant / meropenem-resistant / fosfomycin-intermediate subpopulation, vegetative state 1",
      units = "CFU/mL",
      specimen = "not applicable",
      verified = TRUE
    ),
    bact_resistant_resistant_intermediate2 = list(
      analyte = "Klebsiella pneumoniae BRKP28, polymyxin B-resistant / meropenem-resistant / fosfomycin-intermediate subpopulation, replicating state 2",
      units = "CFU/mL",
      specimen = "not applicable",
      verified = TRUE
    ),
    bact_resistant_resistant_resistant1 = list(
      analyte = "Klebsiella pneumoniae BRKP28, subpopulation resistant to all three drugs, vegetative state 1",
      units = "CFU/mL",
      specimen = "not applicable",
      verified = TRUE
    ),
    bact_resistant_resistant_resistant2 = list(
      analyte = "Klebsiella pneumoniae BRKP28, subpopulation resistant to all three drugs, replicating state 2",
      units = "CFU/mL",
      specimen = "not applicable",
      verified = TRUE
    )
