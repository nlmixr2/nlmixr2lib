Derippe_2024_venetoclax_apoptosis_qsp <- function() {
  ...
  compartmentData <- list(
    ...
    Bcl2_BAXma = list(
      analyte = "BCL2:activated-membrane-BAX complex",
      units = "nM",
      specimen = "tumor",
      verified = TRUE
    ),
    ...
    Bclxl_BAXma = list(
      analyte = "BCL-XL:activated-membrane-BAX complex",
      units = "nM",
      specimen = "tumor",
      verified = TRUE
    ),
    ...
    Mcl1_BAXma = list(
      analyte = "MCL-1:activated-membrane-BAX complex",
      units = "nM",
      specimen = "tumor",
      verified = TRUE
    ),
    BIM_BAXc = list(
      analyte = "BIM:cytosolic-BAX activation complex",
      units = "nM",
      specimen = "tumor",
      verified = TRUE
    ),
    ...
    tBID_BAXc = list(
      analyte = "tBID:cytosolic-BAX activation complex",
      units = "nM",
      specimen = "tumor",
      verified = TRUE
    ),
    PUMA_BAXc = list(
      analyte = "PUMA:cytosolic-BAX activation complex",
      units = "nM",
      specimen = "tumor",
      verified = TRUE
    ),
    ...
    TimeAbove = list(
      analyte = "cumulative time with Pore above threshold",
      units = "h",
