Proctor_2026_durvalumab_pbpk <- function() {
  ...
  compartmentData <- list(
    ...
    fr_lung_igg = list(
      analyte = "unoccupied FcRn (IgG binding site)",
      units = "nmol",
      specimen = "endosome",
      verified = TRUE
    ),
    ...
    fr_small_intestine_igg = list(
      analyte = "unoccupied FcRn (IgG binding site)",
      units = "nmol",
      specimen = "endosome",
      verified = TRUE
    ),
    fr_large_intestine_igg = list(
      analyte = "unoccupied FcRn (IgG binding site)",
      units = "nmol",
      specimen = "endosome",
      verified = TRUE
    ),
    fr_pancreas_igg = list(
      analyte = "unoccupied FcRn (IgG binding site)",
      units = "nmol",
      specimen = "endosome",
      verified = TRUE
    ...
    fr_lung_alb = list(
      analyte = "unoccupied FcRn (albumin binding site)",
      units = "nmol",
      specimen = "endosome",
      verified = TRUE
    ),
    ...
    fr_small_intestine_alb = list(
      analyte = "unoccupied FcRn (albumin binding site)",
      units = "nmol",
      specimen = "endosome",
      verified = TRUE
    ),
    fr_large_intestine_alb = list(
      analyte = "unoccupied FcRn (albumin binding site)",
      units = "nmol",
      specimen = "endosome",
      verified = TRUE
    ),
    fr_pancreas_alb = list(
      analyte = "unoccupied FcRn (albumin binding site)",
      units = "nmol",
      specimen = "endosome",
      verified = TRUE
