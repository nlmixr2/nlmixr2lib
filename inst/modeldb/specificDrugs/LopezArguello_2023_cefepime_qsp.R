LopezArguello_2023_cefepime_qsp <- function() {
  ...
  ini({
    ...
    k2_3 <- fixed(1000); label("Second-order acylation rate constant, PBP3 (1e-3 /min; FIXED)") # Table S1, cefepime PBP3: 1000, footnote a (fixed after sensitivity analyses of the highest-affinity target)
