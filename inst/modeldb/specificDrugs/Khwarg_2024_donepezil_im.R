Khwarg_2024_donepezil_im <- function() {
  ...
  ini({
    ...
    lka <- log(0.00402); label("Absorption rate constant from the first IM depot (1/h)") # Table 2 IM: KA4 = 0.00402 1/h (RSE 6.7%; bootstrap 0.004, 95% CI 0.004-0.005)
    lka2 <- log(0.0134); label("Absorption rate constant from the second IM depot (1/h)") # Table 2 IM: KA5 = 0.0134 1/h (RSE 17.2%; bootstrap 0.015, 95% CI 0.011-0.034)
    lfdepot <- log(0.748); label("Fraction of the IM dose entering the first depot (fraction)") # Table 2 IM: F4 = 0.748 (RSE 1.9%; bootstrap 0.748, 95% CI 0.719-0.778)
    lfdepot2 <- log(0.145); label("Fraction of the IM dose entering the second depot (fraction)") # Table 2 IM: F5 = 0.145 (RSE 11.2%; bootstrap 0.144, 95% CI 0.106-0.172)
    ltlag <- log(235); label("Absorption lag time of the first IM depot (h)") # Table 2 IM: ALAG4 = 235 h (RSE 0.5%; bootstrap 234.934, 95% CI 231.951-236.813)
    ltlag2 <- log(645); label("Absorption lag time of the second IM depot (h)") # Table 2 IM: ALAG5 = 645 h (RSE 0.2%; bootstrap 644.194, 95% CI 637.819-709.858)
    ld1 <- log(648); label("Duration of the zero-order absorption input into central (h)") # Table 2 IM: D2 = 648 h (RSE 0.2%; bootstrap 647.833, 95% CI 574.904-820.454)
    ...
    lcl <- log(10.3); label("Clearance (L/h)") # Table 2 IM: CL = 10.3 L/h (RSE 6.1%; bootstrap 10.295, 95% CI 9.112-11.595)
    lvc <- log(503); label("Central volume of distribution (L)") # Table 2 IM: V2 = 503 L (RSE 29%; bootstrap 511.553, 95% CI 259.082-834.504)
    lq <- log(185); label("Inter-compartmental clearance (L/h)") # Table 2 IM: Q = 185 L/h (RSE 18.1%; bootstrap 183.88, 95% CI 128.741-250.004)
    lvp <- log(1160); label("Peripheral volume of distribution (L)") # Table 2 IM: V3 = 1160 L (RSE 8.3%; bootstrap 1176.22, 95% CI 1026.616-1357.204)
