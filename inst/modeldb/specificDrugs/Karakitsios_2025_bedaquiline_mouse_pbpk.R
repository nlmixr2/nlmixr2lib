Karakitsios_2025_bedaquiline_mouse_pbpk <- function() {
  ...
  # Information, "PBPK models for the infected lung"; Walter 2023 laser-capture
  # ring dissection). There is no canonical chain prefix for this role; declared
  # here pending operator ratification of a `caseum<n>` canonical.
