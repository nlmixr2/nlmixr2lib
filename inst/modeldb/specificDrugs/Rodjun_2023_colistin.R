Rodjun_2023_colistin <- function() {
  ...
  population <- list(
    ...
    n_simulated = 10000L,
    n_studies = 1L,
    age_range = "Not reported in the available sources. Rodjun 2023 reproduces only the parameter table of Nation 2017 and does not restate that study's baseline demographics.",
    weight_range = "Not reported in the available sources. The colistin model carries no body-weight covariate, so weight does not enter the simulation.",
    sex_female_pct = NA_real_,
    race_ethnicity = "Not reported in the available sources.",
