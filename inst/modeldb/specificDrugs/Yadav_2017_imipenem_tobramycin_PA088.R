Yadav_2017_imipenem_tobramycin_PA088 <- function() {
  ...
  model({
    ...
    #    (Methods cites ref 61 for the formulation; supplement Text S1 was not available when this model was built).
