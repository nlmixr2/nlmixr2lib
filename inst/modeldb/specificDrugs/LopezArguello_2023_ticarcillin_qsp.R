LopezArguello_2023_ticarcillin_qsp <- function() {
  ...
  compartmentData <- list(
    npbp1a = list(
      analyte = "ticarcillin-PBP 1a complex",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    ),
    npbp1b = list(
      analyte = "ticarcillin-PBP 1b complex",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    ),
    npbp2 = list(
      analyte = "ticarcillin-PBP 2 complex",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    ),
    npbp3 = list(
      analyte = "ticarcillin-PBP 3 complex",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    ),
    npbp4 = list(
      analyte = "ticarcillin-PBP 4 complex",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    ),
    npbp56 = list(
      analyte = "ticarcillin-PBPs 5/6 complex",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    ),
    nperi = list(
      analyte = "ticarcillin in periplasm",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    )
  ...
  covariateData <- list(
    ...
    CONC_TIC_MGL = list(
      description = "Static extracellular ticarcillin concentration applied in the PBP-binding assay. Scales the rate of net influx and PBP access (Eq 1: Rate_Influx/access = Rate_Influx/access,scaled x C_drug).",
      units = "mg/L",
      type = "continuous",
      reference_category = "n/a -- studied at 48 mg/L (2x the MIC of 24 mg/L)",
  ...
  population <- list(
    ...
    n_subjects = 1L,
    n_studies = 1L,
    disease_state = "Wild-type P. aeruginosa PAO1; ticarcillin MIC 24 mg/L (CLSI broth microdilution)",
    ...
    dose_range = "ticarcillin at a static extracellular concentration of 48 mg/L (2x the MIC of 24 mg/L); no dosing events",
    notes = paste(
  ...
  ini({
    ...
    rate_influx_scaled <- 0.126; label("Scaled rate of net influx and PBP access (drug molecules/min per mg/L)") # Table 1, ticarcillin: 0.126 (SE 19.5%)
    # The studied extracellular concentration enters as the CONC_TIC_MGL covariate
    # (Table 1: ticarcillin studied at 48 mg/L = 2x the MIC of 24 mg/L).
  ...
  model({
    ...
    rate_influx <- CELLS_INTACT * rate_influx_scaled * CONC_TIC_MGL
