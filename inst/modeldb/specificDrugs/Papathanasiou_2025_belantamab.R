Papathanasiou_2025_belantamab <- function() {
  ...
  ini({
    ...
    lcl_t50 <- log(66.4);  label("Log of time at which time-varying CL change is half-maximal (log days)")    # Papathanasiou 2025 Table 2: TI50 = 66.4 days
    cl_time_hill <- 2.87;       label("Hill / sigmoidicity exponent of time on CL (unitless)")                    # Papathanasiou 2025 Table 2: Gamma
    ...
    etacl_time_max  ~ 0.01366                                    # Papathanasiou 2025 Table 2: Imax CV 29.0% (normal-distribution form, theta = -0.403)
    etalcl_t50 ~ 0.39236                                    # Papathanasiou 2025 Table 2: TI50 CV 69.3%
