Liu_2018_caspofungin_mouse_qsp <- function() {
  ...
  reference <- paste(
    ...
    "PK construction and validation data (Liu 2018 Table 2 / reference 40) from",
    "Andes D, Diekema DJ, Pfaller MA, Bohrmuller J, Marchillo K, Lepak A.",
    "(2010). In vivo comparison of the pharmacodynamic targets for echinocandin",
    "drugs against Candida species.",
    "Antimicrob Agents Chemother 54(6):2497-2506. doi:10.1128/AAC.01584-09.",
    "Additional PK validation data (Liu 2018 Table 2 / reference 43) from",
    "Hajdu R, Thompson R, Sundelof JG, Pelak BA, Bouffard FA, Dropinski JF,",
    "Kropp H. (1997). Preliminary animal pharmacokinetics of the parenteral",
    "antifungal agent MK-0991 (L-743,872).",
    "Antimicrob Agents Chemother 41(11):2339-2344. doi:10.1128/aac.41.11.2339.",
  ...
  population <- list(
    ...
    n_subjects = "PK module built on published murine plasma-concentration profiles digitised from Andes 2010 (construction and validation) and Hajdu 1997 (validation); PD and drug-effect layers constrained by the Pneumocystis burdens of Cushion 2010 and by the authors' own 6-week-old male C3H/HeN mice",
    n_studies = 3L,
    ...
    dose_range = "0.1, 0.5, 1, 2.5, 5 and 10 mg/kg intraperitoneally, giving initial administration-compartment concentrations of 0.8, 1.5, 2.5, 8, 10 and 12 ug/mL (Liu 2018 Table 3); the Figure 4a treatment arms are 0.1, 0.5 and 1 mg/kg three times a week for three weeks",
  ...
  ini({
    # ==================================================================
    # PK module -- Liu 2018 Table 1, caspofungin column. All rate
    ...
    # parameter set was SSE = 2602.56 (Table 2).
    # ==================================================================
    lka <- fixed(log(5))
    ...
    # ==================================================================
    # Caspofungin effect on the asci -- Liu 2018 Table 5, echinocandin
    ...
    # ==================================================================
    ec50 <- fixed(0.0007)
    label("Plasma caspofungin concentration giving half the maximal asci effects Ec50 (ug/mL)")  # Table 5
    emax <- fixed(0.45)
    label("Maximal caspofungin-induced increment in the asci death rate ME (1/day)")  # Table 5
    hill <- fixed(1)
    label("Hill coefficient of the caspofungin asci effects n (dimensionless)")  # Table 5
