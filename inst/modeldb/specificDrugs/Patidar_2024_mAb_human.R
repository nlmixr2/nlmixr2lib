Patidar_2024_mAb_human <- function() {
  ...
  population <- list(
    ...
    upstream_model = paste0(
      ...
      "(doi:10.1007/s10928-019-09639-2) Supplementary Material Eqs. 13-30."
    )
  )
