LopezArguello_2023_carbenicillin_qsp <- function() {
  ...
  ini({
    ...
    k2_3 <- fixed(10000); label("Second-order acylation rate constant, PBP3 (1e-3 /min; FIXED)") # Table S1, carbenicillin PBP3: 10000, footnote a (fixed after sensitivity analyses of the highest-affinity target)
