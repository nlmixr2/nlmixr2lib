LopezArguello_2023_carbenicillin_qsp <- function() {
  ...
  compartmentData <- list(
    npbp1a = list(
      analyte = "carbenicillin-PBP 1a complex",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    ),
    npbp1b = list(
      analyte = "carbenicillin-PBP 1b complex",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    ),
    npbp2 = list(
      analyte = "carbenicillin-PBP 2 complex",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    ),
    npbp3 = list(
      analyte = "carbenicillin-PBP 3 complex",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    ),
    npbp4 = list(
      analyte = "carbenicillin-PBP 4 complex",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    ),
    npbp56 = list(
      analyte = "carbenicillin-PBP 5/6 complex",
      units = NA_character_,
      specimen = "administration site",
      verified = FALSE
    ),
