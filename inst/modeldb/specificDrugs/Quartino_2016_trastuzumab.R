Quartino_2016_trastuzumab <- function() {
  ...
  population <- list(
    ...
    age_range = "Not reported in the main publication; baseline demographics in Online Resource 3 (not available when this model was built).",
