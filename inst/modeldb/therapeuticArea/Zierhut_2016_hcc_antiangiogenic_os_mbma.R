  ...
  covariateData <- list(
    ...
    SORAFENIB = list(
      ...
      notes              = paste0(
        ...
        "exact case (bare INN), because the conflict is already before the ",
        "operator on an earlier sidecar and re-asking it would not add ",
        "information. If that sidecar resolves in favour of TRT_<INN>, rename ",
