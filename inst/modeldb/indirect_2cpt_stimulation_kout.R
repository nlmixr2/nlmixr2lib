indirect_2cpt_stimulation_kout <- function() {
  description <- "Two compartment indirect response model with stimulation of kout. Parameterized using rate constants"
  ini({
