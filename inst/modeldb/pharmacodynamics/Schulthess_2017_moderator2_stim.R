Schulthess_2017_moderator2_stim <- function() {
  description <- paste(
    "Theoretical (illustrative; no data fitted). DOUBLE moderator-mediated",
    "feedback (tolerance) model with a STIMULATORY drug effect on the",
    "production of the response, driven by a one-compartment i.v. bolus PK",
    "model. Model flavor 1 of Figure 6a in Schulthess et al. (2017), used to",
