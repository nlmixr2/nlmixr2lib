Schulthess_2017_autoreg_inhi_posfb <- function() {
  description <- paste(
    "Theoretical (illustrative; no data fitted). Autoregulation model with",
    "POSITIVE (auto-stimulatory) FEEDBACK on production and an INHIBITORY",
    "drug effect on the loss, driven by a one-compartment i.v. bolus PK",
    "model. Model flavor 2 of Figure 3a in Schulthess et al. (2017), one of",
