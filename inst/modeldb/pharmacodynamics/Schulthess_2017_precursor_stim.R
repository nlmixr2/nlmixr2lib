Schulthess_2017_precursor_stim <- function() {
  description <- paste(
    "Theoretical (illustrative; no data fitted). Precursor-pool (tolerance",
    "and rebound) model with a STIMULATORY drug effect on the loss of the",
    "precursor, driven by a one-compartment i.v. bolus PK model. Model",
    "flavor 1 of Figure 4a in Schulthess et al. (2017), used to demonstrate",
