Schulthess_2017_indirect_inhi_kout <- function() {
  description <- paste(
    "Theoretical (illustrative; no data fitted). Indirect response (turnover)",
    "model with INHIBITION OF LOSS, driven by a one-compartment i.v.",
    "bolus PK model. Model flavor 4 of Figure 2a in Schulthess et al. (2017),",
