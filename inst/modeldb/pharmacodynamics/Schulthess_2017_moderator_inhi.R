Schulthess_2017_moderator_inhi <- function() {
  description <- paste(
    "Theoretical (illustrative; no data fitted). Moderator-mediated feedback",
    "(tolerance) model with an INHIBITORY drug effect on the production of",
    "the response, driven by a one-compartment i.v. bolus PK model. Model",
    "flavor 2 of Figure 5a in Schulthess et al. (2017), used to demonstrate",
