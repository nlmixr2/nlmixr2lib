Schulthess_2017_indirect_stim_kin <- function() {
  description <- paste(
    "Theoretical (illustrative; no data fitted). Indirect response (turnover)",
    "model with STIMULATION OF PRODUCTION, driven by a one-compartment i.v.",
    "bolus PK model. Model flavor 1 of Figure 2a in Schulthess et al. (2017),",
  ...
  model({
    ...
    # Eq. 2 exactly: dx/dt = kin * (1 + Emax*c/(EC50+c)) - kout*x.
