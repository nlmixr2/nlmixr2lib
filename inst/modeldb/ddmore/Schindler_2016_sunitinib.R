Schindler_2016_sunitinib <- function() {
  ...
  model({
    ...
    # and feeds it to the effect compartment. With DOSE in mg/day
    # and CLI in L/h the product has units mg*h/L, which is the
