...
- **Source aliases:**
  ...
  - `kr` -- the spelling used in the `gut_lumen` entry of `compartment-names.md` and hard-coded as a `model()` constant in the `Ramachandran_2023_*_pbpk.R` family.
