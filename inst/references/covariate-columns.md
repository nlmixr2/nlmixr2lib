...
- **Description:** 1 = capsule formulation, 0 = the per-paper comparator non-capsule formulation. The complement formulation is paper-defined: solution for Hennig 2006 / 2007 itraconazole, tablet for Gupta 2016 lenvatinib, oral suspension or solution (pooled as 'liquid') for Salem 2014 efavirenz. Document the comparator and the reference-category bioavailability per-model in `covariateData[[FORM_CAPSULE]]$notes`.
- **Units:** (binary)
- **Type:** binary
- **Scope:** specific
