...
- **Source aliases:**
  ...
  - `FORM` (two-level formulation column {oral solution, solid-dispersion}) -- used in `Othman_2013_ABT_102.R`; the oral-solution level maps to `FORM_SOLUTION = 1` with the solid-dispersion comparator at FORM_SOLUTION = 0.
